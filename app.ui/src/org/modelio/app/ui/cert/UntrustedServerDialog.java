...
public class UntrustedServerDialog extends ModelioDialog {
    ...
    public Control createContentArea(Composite parent) {
        ...
        //parent.setBackground(tk.getColors().getBackground());
        ...
        msgArea.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB));
        
        // Technical error details
        Section techArea = tk.createSection(area, ExpandableComposite.TITLE_BAR | ExpandableComposite.TWISTIE);
        techArea.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB));
        ...
        excArea.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB));
        ...
        certArea.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB));
    ...
    private void createUnderstandSection(final FormToolkit tk, Composite area, String serverName) {
        ...
        understandArea.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB));
        ...
        text = AppUi.I18N.getMessage("UntrustedServerDialog.understandarea.message", serverName);
        
        ft = tk.createFormText(compo, false);
        ft.setText(text, true, true);
        ft.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB));
        //understandArea.setExpanded(true);
        understandArea.setClient(compo);
        
        Composite toolbar = tk.createComposite(compo, SWT.WRAP);
        toolbar.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB, TableWrapData.TOP));
        ...
        createButton(toolbar, TRUST_ONCE_ID, AppUi.I18N.getMessage("UntrustedServerDialog.button.TrustOnce"), false);
        createButton(toolbar, TRUST_ALWAYS_ID, AppUi.I18N.getMessage("UntrustedServerDialog.button.TrustAlways"), false);
        
        
        compo.setLayout(new TableWrapLayout());
        //GridLayoutFactory.swtDefaults().numColumns(1).equalWidth(false).generateLayout(compo);
    }
    ...
    public void addButtonsInButtonBar(Composite parent) {
        //createButton(parent, TRUST_ONCE_ID, AppUi.I18N.getMessage("UntrustedServerDialog.button.TrustOnce"), false);
        //createButton(parent, TRUST_ALWAYS_ID, AppUi.I18N.getMessage("UntrustedServerDialog.button.TrustAlways"), false);
