...
/**
 * Command handler to show a clicked view from the view menu
 * To not show a view by default, unselect the checkbox 'To Be Rendered' in e4xmi of the view part
 * @author xzhang
 */
...
public class ShowViewHandler {
    ...
    @Execute
    public void execute(EPartService partService, MMenuItem item, @Optional
