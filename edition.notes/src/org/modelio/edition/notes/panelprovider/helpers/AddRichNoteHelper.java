...
public class AddRichNoteHelper extends AbstractHelper {
    ...
    private ExternDocument createRichNote(final ModelElement modelElement, final RichNoteDescriptor model, final IModelFactory factory, final Shell parentShell) throws IOException, UnknownServiceException {
