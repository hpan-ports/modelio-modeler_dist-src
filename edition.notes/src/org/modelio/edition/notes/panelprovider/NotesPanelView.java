 ...
 * <ul>
 * <li>a toolbar providing commands like add/remove notes and constraints or switch layout</li>
...
public class NotesPanelView {
    ...
    @objid ("54364bc6-da8c-45d8-afb4-45a509326a33")
    ...
    public Composite createContents(Composite parent) {
        ...
        this.tree.addDragSupport(DND.DROP_MOVE | DND.DROP_COPY, new Transfer[] { ModelElementTransfer.getInstance() }, this.dragListener);
        return this.top;
    }
    ...
    /**
     * Automatically choose horizontal or vertical layout depending on parent composite size.
     */
    ...
    private IPanelProvider createNoteEditArea(Composite parent) {
        final NoteViewContentPanel panel = new NoteViewContentPanel(this.controller.getActivationService(), this.controller.getContextService());
    ...
    private TreeViewer createNotesTree(Composite parent) {
        ...
        viewer.setLabelProvider(new NoteViewTreeLabelProvider());
        ...
        viewer.addDoubleClickListener(new IDoubleClickListener() {
            ...
            public void doubleClick(final DoubleClickEvent event) {
                NotesPanelView.this.controller.onItemDoubleClick(event.getSelection());
            }
        });
        ...
        viewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (!event.getSelection().isEmpty()) {
                    NotesPanelView.this.controller.onItemSelectionChange(event.getSelection());
                }
            }
        });
        return viewer;
    ...
    /**
     * This method tries to guess the smartest possible item selection for the current element.
     * @return the annotation to select.
     */
    @objid ("7667946d-9895-4a54-8074-2fa80a8365f9")
    private ModelElement getSelectHint() {
        final Object[] items = ((ITreeContentProvider) this.tree.getContentProvider()).getElements(this.tree.getInput());
        
        for (int i = 0; i < items.length; i++) {
            final ModelElement me = (ModelElement) items[i];
    ...
    private String getItemName(ModelElement item) {
        ...
        } else if (item instanceof ExternDocument) {
            return mc + ":" + ((ExternDocument) item).getType().getName();
        } else {
            return mc;
        }
    }
    ...
    @objid ("dcaddd57-641e-4b1f-bd20-57cd77b06b91")
    private EContextService getContextService() {
        return this.controller.getContextService();
    }
