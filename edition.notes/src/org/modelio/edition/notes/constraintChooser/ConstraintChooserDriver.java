...
import org.modelio.core.ui.elementChooser.ElementChooserSorter;
import org.modelio.core.ui.elementChooser.IElementChooserDriver;
...
public class ConstraintChooserDriver implements IElementChooserDriver {
    ...
    public void init(Element elementToAddConstraint) {
        if (elementToAddConstraint instanceof ModelElement) {
            this.element = (ModelElement) elementToAddConstraint;
    ...
    public void performFinish(StructuredViewer viewer, List<Object> selection) {
        try (ITransaction transaction = this.session.getTransactionSupport().createTransaction(
            ...
            for (Object obj : selection) {
                this.createdConstraint = this.modelServices.getModelFactory().createConstraint();
