    ...
    public void exportXmiFile(final XmiExportConfiguration configuration, final IProgressMonitor monitor) throws XmiException {
        ...
        try {
            if (entryPoint instanceof Profile) {
                this.xmiservice.exportXMIProfile(exportConf, monitor, this.modelServices, this.metamodel);
            } else {
                this.xmiservice.exportXMIFile(exportConf, monitor, this.modelServices, this.metamodel);
            }
        } catch (Exception e) {
