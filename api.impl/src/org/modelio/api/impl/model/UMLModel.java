 ...
 * 
 * <p>
 * To navigate the UML model use the {@linkplain #getModelRoots()} method. this
 * method give access to the root Package of the model. The whole model can be
 * navigate through the associations that links the model elements to each
 * other.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Any model modification must be done in a transaction. It is the MDAC
 * developer responsibility to ensure that the newly created metaclass is valid
 * before commiting a transaction.
 * </p>
 * 
 * <p>
 * New UML model elements can easily be created using <i>createXxxxx()</i>
 * methods where Xxxxx is the name of the metaclass for which an instance has to
 * be created. At least one method <i>createXxxxx()</i> exists for UML model
 * Element. i.e.: {@linkplain #createClass()}. This method only create an
 * instance of the metaclass. The instance will have to be attached to the model
 * and eventually named to be valid for the current transaction.
 * </p>
 * 
 * <p>
 * The factory provide some convenience methods that allow to directly create a
 * valid instance for the most frequently used metaclasses. i.e.:
 * {@linkplain #createClass(String name, NameSpace owner)},
 * {@linkplain #createClass(String name, NameSpace owner, Stereotype stereotype)}
...
public class UMLModel implements IUmlModel {
     ...
     * 
     * The created Abstraction has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IAbstraction representing the Abstraction in the Model.
     ...
     * 
     * The created AcceptCallEventAction has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IAcceptCallEventAction representing the
     * AcceptCallEventAction in the Model.
     * @return An IAcceptCallEventAction representing the AcceptCallEventAction
     * in the Model.
     */
     ...
     * 
     * The created AcceptChangeEventAction has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IAcceptChangeEventAction representing the
     * AcceptChangeEventAction in the Model.
     * @return An IAcceptChangeEventAction representing the
     * AcceptChangeEventAction in the Model.
     */
     ...
     * 
     * The created AcceptSignalAction has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IAcceptSignalAction representing the AcceptSignalAction in
     * the Model.
     * @return An IAcceptSignalAction representing the AcceptSignalAction in the
     * Model.
     */
     ...
     * 
     * The created AcceptTimeEventAction has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IAcceptTimeEventAction representing the
     * AcceptTimeEventAction in the Model.
     * @return An IAcceptTimeEventAction representing the AcceptTimeEventAction
     * in the Model.
     */
     ...
     * Create an Activity.
     * 
     * The created Activity has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IActivity representing the Abstraction in the Model.
     ...
     * 
     * The returned object is an IActivityDiagram owned by 'owner' and named by
     * 'name'
     ...
     * 
     * The created ActivityFinalNode has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IActivityFinalNode representing the ActivityFinalNode in the Model.
     * @return An IActivityFinalNode representing the ActivityFinalNode in the
     * Model.
     */
     ...
     * 
     * The created ActivityParameterNode has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IActivityParameterNode representing the
     * ActivityParameterNode in the Model.
     * @return An IActivityParameterNode representing the ActivityParameterNode
     * in the Model.
     */
     ...
     * 
     * The created ActivityPartition has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IActivityPartition representing the ActivityPartition in the Model.
     * @return An IActivityPartition representing the ActivityPartition in the
     * Model.
     */
     ...
     * Create an Actor.
     * 
     * The created Actor has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IActor representing the Abstraction in the Model.
     ...
     * Create an Actor.
     * 
     * The created Actor is valid for the current transaction. (It as a name and
     * an owner.)
     ...
     * <p>
     * <p>
     * The created Actor is stereotyped by the <code>stereotype</code> argument.
     * The <code>ExtensionNotFoundException</code> is thrown if the stereotype
     * is not found.
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the metaclass
     * @param name The name of the Actor to be created.
     * @param owner The NameSpace that will contain the Actor.
     ...
     * Create an Artifact.
     * 
     * The created Artifact has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IArtifact representing the Abstraction in the Model.
     ...
     * Create an Artifact.
     * 
     * The created Artifact is valid for the current transaction. (It as a name
     * and an owner.)
     ...
     * IArtifact representing the Abstraction in the Model.
     * 
     * The created Artifact is stereotyped by the <code>stereotype</code>
     * argument. The <code>ExtensionNotFoundException</code> is thrown if the
     * stereotype is not found.
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the metaclass
     ...
     * 
     * This method create a binary association between two classifiers and give
     * a name to the destination role. The created association has a navigable
     * role.
     ...
     * 
     * The created AssociationEnd has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an AssociationEnd representing the Abstraction in the Model.
     ...
     * Create an Attribute.
     * 
     * The created Attribute has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IAttribute representing the Abstraction in the Model.
     ...
     * 
     * The Attribute is created on owner and has a name, a type and a
     * stereotype.
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the metaclass
     * @param name the name of the Attribute to be created.
     * @param type the GeneralClass that will type the Atrribute.
     * @param owner the Classifier that will contain the Attribute.
     * @param stereotype the name of the Stereotype that will be refered by the
     * Attribute.
     * @return An IAttribute representing the Attribute in the Model.
     */
     ...
     * 
     * The created AttributeLink has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IAttributeLink representing the Abstraction in the Model.
     ...
     * 
     * The created BehaviorParameter has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IBehaviorParameter representing the BehaviorParameter in the Model.
     * @return An IBehaviorParameter representing the BehaviorParameter in the
     * Model.
     */
     ...
     * 
     * The created BindableInstance has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an BindableInstance representing the Abstraction in the Model.
     * @return An BindableInstance representing the BindableInstance in the
     * Model.
     */
     ...
     * Create a Binding.
     * 
     * The created Binding has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IBinding representing the Abstraction in the Model.
     ...
     * 
     * The created CallBehaviorAction has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an ICallBehaviorAction representing the CallBehaviorAction in
     * the Model.
     * @return An ICallBehaviorAction representing the CallBehaviorAction in the
     * Model.
     */
     ...
     * 
     * The created CallOperationAction has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an ICallOperationAction representing the CallOperationAction in
     * the Model.
     * @return An ICallOperationAction representing the CallOperationAction in
     * the Model.
     */
     ...
     * 
     * The created CentralBufferNode has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an ICentralBufferNode representing the CentralBufferNode in the Model.
     * @return An ICentralBufferNode representing the CentralBufferNode in the
     * Model.
     */
     ...
     * 
     * The created ChoicePseudoState has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IChoicePseudoState representing the ChoicePseudoState in the Model.
     * @return An IChoicePseudoState representing the ChoicePseudoState in the
     * Model.
     */
     ...
     * Create a Class.
     * 
     * The created Class has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IClass representing the Abstraction in the Model.
     ...
     * 
     * The created ClassAssociation has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IClassAssociation representing the Abstraction in the Model.
     * @return An IClassAssociation representing the ClassAssociation in the
     * Model.
     */
     ...
     * 
     * The returned object is an IClassDiagram owned by <code>owner</code> named
     * by <code>name</code> and sterotyped by <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the metaclass
     * @param name the name of the Class Diagram to create.
     * @param owner the element on which the Class Diagram will be created.
     * @param stereotype the name of the stereotype that will be used to type the Class
     * Diagram
     ...
     * Create a Clause.
     * 
     * The created Clause has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IClause representing the Clause in the Model.
     ...
     * 
     * The created Collaboration has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an ICollaboration representing the Collaboration in the Model.
     ...
     * 
     * The created CollaborationUse has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an ICollaborationUse representing the Abstraction in the Model.
     * @return An ICollaborationUse representing the CollaborationUse in the
     * Model.
     */
     ...
     * 
     * The created CombinedFragment has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an ICombinedFragment representing the CombinedFragment in the Model.
     * @return An ICombinedFragment representing the CombinedFragment in the
     * Model.
     */
     ...
     * Create a CombinedFragment.
     * 
     * Create a CombinedFragment with an InteractionOperator. In order to build
     * a valid model, the CombinedFragment must be inserted in the model.
     ...
     * 
     * The returned object is an ICommunicationDiagram owned by
     * <code>owner</code> named by <code>name</code> and sterotyped by
     * <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the
     * metaCommunication
     * @param name the name of the Communication Diagram to create.
     * @param owner the element on which the Communication Diagram will be
     * created.
     * @param stereotype the name of the stereotype that will be used to type the
     ...
     * Create a Component.
     * 
     * The created Component has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IComponent representing the Abstraction in the Model.
     ...
     * 
     * The created ConditionalNode has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IConditionalNode representing the ConditionalNode in the Model.
     * @return An IConditionalNode representing the ConditionalNode in the
     * Model.
     */
     ...
     * 
     * The created ConnectionPointReference has no composition owner. In order
     * to build a valid model, a composition owner must be defined. The returned
     * object is an IConnectionPointReference representing the
     * ConnectionPointReference in the Model.
     * @return An IConnectionPointReference representing the
     * ConnectionPointReference in the Model.
     */
     ...
     * 
     * The created ConnectorEnd has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IConnectorEnd representing the ConnectorEnd in the Model.
     ...
     * Create a Constraint.
     * 
     * The created Constraint has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IConstraint representing the Constraint in the Model.
     ...
     * 
     * The created ControlFlow has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IControlFlow representing the ControlFlow in the Model.
     ...
     * Create a DataFlow.
     * 
     * The created DataFlow has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IDataFlow representing the DataFlow in the Model.
     ...
     * 
     * The created DataStoreNode has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IDataStoreNode representing the DataStoreNode in the Model.
     ...
     * Create a DataType.
     * 
     * The created DataType has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IDataType representing the Abstraction in the Model.
     ...
     * Create a DataType.
     * 
     * The created DataType has a composition owner, a name and refers a
     * Stereotype.
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the metaclass
     * @param name the name of the DataType to create.
     ...
     * 
     * The created DecisionMergeNode has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IDecisionMergeNode representing the DecisionMergeNode in the Model.
     * @return An IDecisionMergeNode representing the DecisionMergeNode in the
     * Model.
     */
     ...
     * 
     * The created DeepHistoryPseudoState has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IDeepHistoryPseudoState representing the
     * DeepHistoryPseudoState in the Model.
     * @return An IDeepHistoryPseudoState representing the
     * DeepHistoryPseudoState in the Model.
     */
     ...
     * Create a Dependency.
     * 
     * The created Dependency has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IDependency representing the Abstraction in the Model.
     ...
     * 
     * The returned object is an IDeploymentDiagram owned by <code>owner</code>
     * named by <code>name</code> and sterotyped by <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the
     * metaDeployment
     ...
     * 
     * The created DurationConstraint has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IDurationConstraint representing the DurationConstraint in
     * the Model.
     * @return An IDurationConstraint representing the DurationConstraint in the
     * Model.
     */
     ...
     * 
     * The created ElementImport has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an ElementImport representing the Abstraction in the Model.
     ...
     * 
     * The created ElementRealization has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an ElementRealization representing the Abstraction in the
     * Model.
     * @return An ElementRealization representing the ElementRealization in the
     * Model.
     */
     ...
     * 
     * The created EntryPointPseudoState has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IEntryPointPseudoState representing the
     * EntryPointPseudoState in the Model.
     * @return An IEntryPointPseudoState representing the EntryPointPseudoState
     * in the Model.
     */
     ...
     * 
     * The created Enumeration has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an Enumeration representing the Abstraction in the Model.
     ...
     * 
     * The created EnumerationLiteral has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an EnumerationLiteral representing the Abstraction in the
     * Model.
     * @return An EnumerationLiteral representing the EnumerationLiteral in the
     * Model.
     */
     ...
     * Create an Event.
     * 
     * The created Event has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IEvent representing the Abstraction in the Model.
     ...
     * 
     * The created ExecutionOccurenceSpecification has no composition owner. In
     * order to build a valid model, a composition owner must be defined. The
     * returned object is an IExecutionOccurenceSpecification representing the
     * ExecutionOccurenceSpecification in the Model.
     * @return An IExecutionOccurenceSpecification representing the
     * ExecutionOccurenceSpecification in the Model.
     */
     ...
     * The created ExecutionOccurenceSpecification has no composition owner. In
     * order to build a valid model, a composition owner must be defined. The
     * returned object is an IExecutionSpecification representing the
     ...
     * 
     * The created ExitPointPseudoState has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IExitPointPseudoState representing the ExitPointPseudoState
     * in the Model.
     * @return An ObExitpointPseudoState representing the ExitpointPseudoState
     * in the Model.
     */
     ...
     * @throws org.modelio.api.model.ElementNotUniqueException
     * if there is no stereotype matching the name and the metaclass
     * @param source the origin of the UseCaseDependency
     * @param destination the destination of the UseCaseDependency
     * @return An UseCaseDependency representing the UseCaseDependency in the
     * Model.
     */
     ...
     * 
     * The created ExtensionPoint has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IExtensionPoint representing the ExtensionPoint in the Model.
     ...
     * Create a FinalState.
     * 
     * The created FinalState has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IFinalState representing the FinalState in the Model.
     ...
     * 
     * The created FlowFinalNode has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IFlowFinalNode representing the FlowFinalNode in the Model.
     ...
     * 
     * The created ForkJoinNode has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IForkJoinNode representing the ForkJoinNode in the Model.
     ...
     * 
     * The created ForkPseudoState has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IForkPseudoState representing the ForkPseudoState in the Model.
     * @return An IForkPseudoState representing the ForkPseudoState in the
     * Model.
     */
     ...
     * Create a Gate.
     * 
     * The created Gate has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IGate representing the Gate in the Model.
     ...
     * Create a Gate.
     * 
     * The Gate is created with a name. In order to build a valid model, the
     * Gate must be inserted in the model. must be defined.
     ...
     * 
     * The created GeneralOrdering has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IGeneralOrdering representing the GeneralOrdering in the Model.
     * @return An IGeneralOrdering representing the GeneralOrdering in the
     * Model.
     */
     ...
     * 
     * The created Generalization has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IGeneralization representing the Abstraction in the Model.
     ...
     * 
     * The created InformationFlow has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IInformationFlow representing the InformationFlow in the Model.
     * @return An IInformationFlow representing the InformationFlow in the
     * Model.
     */
     ...
     * 
     * The created InformationItem has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IInformationItem representing the InformationItem in the Model.
     * @return An IInformationItem representing the InformationItem in the
     * Model.
     */
     ...
     * 
     * The created InitialNode has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IInitialNode representing the InitialNode in the Model.
     ...
     * 
     * The created InitialPseudoState has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IInitialPseudoState representing the InitialPseudoState in
     * the Model.
     * @return An IInitialPseudoState representing the InitialPseudoState in the
     * Model.
     */
     ...
     * Create a InputPin.
     * 
     * The created InputPin has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IInputPin representing the InputPin in the Model.
     ...
     * Create an Instance.
     * 
     * The created Instance has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * Instance representing the Instance in the Model.
     ...
     * 
     * The created InstanceNode has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an InstanceNode representing the InstanceNode in the Model.
     ...
     * 
     * The created Interaction has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an Interaction representing the Abstraction in the Model.
     ...
     * 
     * The created InteractionOperand has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an InteractionOperand representing the InteractionOperand in
     * the Model.
     * @return An InteractionOperand representing the InteractionOperand in the
     * Model.
     */
     ...
     * Create an InteractionOperand.
     * 
     * The created InteractionOperand has a guard condition. In order to build a
     * valid model, the InteractionOperand must be inserted in the model.
     ...
     * 
     * The created InteractionUse has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an InteractionUse representing the InteractionUse in the Model.
     ...
     * Create an InteractionUse.
     * 
     * The created InteractionUse refer an Interaction. In order to build a
     * valid model, the InteractionUse must be inserted in the model.
     ...
     * Create an Interface.
     * 
     * The created Interface has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * Interface representing the Abstraction in the Model.
     ...
     * 
     * The created InterfaceRealization has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an InterfaceRealization representing the Abstraction in the
     * Model.
     * @return An InterfaceRealization representing the InterfaceRealization in
     * the Model.
     */
     ...
     * 
     * The created InternalTransition has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IInternalTransition representing the Abstraction in the
     * Model.
     * @return An IInternalTransition representing the InternalTransition in the
     * Model.
     */
     ...
     * 
     * The created InterruptibleActivityRegion has no composition owner. In
     * order to build a valid model, a composition owner must be defined. The
     * returned object is an IInterruptibleActivityRegion representing the
     * InterruptibleActivityRegion in the Model.
     * @return An IInterruptibleActivityRegion representing the
     * InterruptibleActivityRegion in the Model.
     */
     ...
     * 
     * The created JoinPseudoState has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IJoinPseudoState representing the JoinPseudoState in the Model.
     * @return An IJoinPseudoState representing the JoinPseudoState in the
     * Model.
     */
     ...
     * 
     * The created JunctionPseudoState has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IJunctionPseudoState representing the JunctionPseudoState in
     * the Model.
     * @return An IJunctionPseudoState representing the JunctionPseudoState in
     * the Model.
     */
     ...
     * Create a Lifeline.
     * 
     * The created Lifeline has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * ILifeline representing the Lifeline in the Model.
     ...
     * Create a Lifeline.
     * 
     * The Lifeline is created with a <code>name</code> in the
     * <code>owner</code> Interaction.
     ...
     * 
     * The Lifeline is created with a <code>name</code> in the
     * <code>owner</code> Interaction. The <code>represented</code> instance is
     * set on the Lifeline.
     * @param name the name of the Lifeline to create.
     * @param owner the owner Interaction of the Lifeline to create.
     ...
     * Create a LinkEnd.
     * 
     * The created LinkEnd has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * ILinkEnd representing the Abstraction in the Model.
     ...
     * Create a LoopNode.
     * 
     * The created LoopNode has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * ILoopNode representing the LoopNode in the Model.
     ...
     * 
     * The created Manifestation has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IManifestation representing the Manifestation in the Model.
     ...
     * Create a Message.
     * 
     * The created Message has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IMessage representing the Message in the Model.
     ...
     * Create a Message.
     * 
     * The Message is created with a type. In order to build a valid model, the
     * Message must be inserted in the model.
     ...
     * Create a Message.
     * 
     * The Message is created with a type and invoke an operation. In order to
     * build a valid model, the Message must be inserted in the model.
     * @param sort the type of message to create.
     ...
     * Create a Message.
     * 
     * The Message is created with a <code>name</code> and a type. In order to
     * build a valid model, the Message must be inserted in the model.
     ...
     * 
     * The created MessageFlow has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IMessageFlow representing the MessageFlow in the Model.
     ...
     * Create a Node.
     * 
     * The created Node has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * INode representing the Abstraction in the Model.
     ...
     * Create a Note.
     * 
     * The created Note has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * INote representing the Abstraction in the Model.
     ...
     * Create a Note.
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if no note type matching the given name and the element
     * metaclass is found
     ...
     * 
     * The returned object is an IObjectDiagram owned by <code>owner</code>
     * named by <code>name</code> and sterotyped by <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the
     * metaObject
     ...
     * Create a ObjectFlow.
     * 
     * The created ObjectFlow has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IObjectFlow representing the ObjectFlow in the Model.
     ...
     * 
     * The created OpaqueAction has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IOpaqueAction representing the OpaqueAction in the Model.
     ...
     * 
     * The created OpaqueBehavior has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IOpaqueBehavior representing the OpaqueBehavior in the Model.
     ...
     * Create an Operation.
     * 
     * The created Operation has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * Operation representing the Abstraction in the Model.
     ...
     * Create a OutputPin.
     * 
     * The created OutputPin has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IOutputPin representing the OutputPin in the Model.
     ...
     * Create a Package.
     * 
     * The created Package has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * Package representing the Abstraction in the Model.
     ...
     * 
     * The created PackageImport has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an PackageImport representing the Abstraction in the Model.
     ...
     * 
     * The created PackageMerge has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an PackageMerge representing the Abstraction in the Model.
     ...
     * Create a Parameter.
     * 
     * The created Parameter has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IParameter representing the Abstraction in the Model.
     * @return An IParameter representing the Parameter in the Model.
     */
     ...
     * 
     * The created PartDecomposition has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IPartDecomposition representing the PartDecomposition in the Model.
     * @return An IPartDecomposition representing the PartDecomposition in the
     * Model.
     */
     ...
     * 
     * The created PartDecomposition refer an Interaction. In order to build a
     * valid model, the PartDecomposition must be inserted in the model.
     * @param refered the refered Interaction.
     * @return An IPartDecomposition representing the PartDecomposition in the
     * Model.
     */
     ...
     * Create a Port.
     * 
     * The created Port has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * Port representing the Abstraction in the Model.
     ...
     * 
     * The created ProvidedInterface has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IProvidedInterface representing the Abstraction in the Model.
     * @return An IProvidedInterface representing the ProvidedInterface in the
     * Model.
     */
     ...
     * 
     * The created RaisedException has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IRaisedException representing the Abstraction in the Model.
     * @return An IRaisedException representing the RaisedException in the
     * Model.
     */
     ...
     * Create a Region.
     * 
     * The created Region has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IRegion representing the Abstraction in the Model.
     * @return An IRequiredInterface representing the RequiredInterface in the
     * Model.
     */
     ...
     * 
     * The created RequiredInterface has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an IRequiredInterface representing the Abstraction in the Model.
     * @return An IRequiredInterface representing the RequiredInterface in the
     * Model.
     */
     ...
     * 
     * The created SendSignalAction has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an ISendSignalAction representing the SendSignalAction in the Model.
     * @return An ISendSignalAction representing the SendSignalAction in the
     * Model.
     */
     ...
     * 
     * The created SequenceDiagram has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an ISequenceDiagram representing the SequenceDiagram in the Model.
     * @return An ISequenceDiagram representing the SequenceDiagram in the
     * Model.
     */
     ...
     * 
     * The created ShallowHistoryPseudoState has no composition owner. In order
     * to build a valid model, a composition owner must be defined. The returned
     * object is an IShallowHistoryPseudoState representing the
     * ShallowHistoryPseudoState in the Model.
     * @return An IShallowHistoryPseudoState representing the
     * ShallowHistoryPseudoState in the Model.
     */
     ...
     * Create a Signal.
     * 
     * The created Signal has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * ISignal representing the Abstraction in the Model.
     ...
     * Create a State.
     * 
     * The created State has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IState representing the Abstraction in the Model.
     ...
     * 
     * The created StateInvariant has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IStateInvariant representing the StateInvariant in the Model.
     ...
     * Create a StateInvariant.
     * 
     * Create a StateInvariant with a body. In order to build a valid model, the
     * StateInvariant must be inserted in the model.
     ...
     * 
     * The created StateMachine has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an IStateMachine representing the Abstraction in the Model.
     ...
     * 
     * The returned object is an IStateMachineDiagram owned by
     * <code>owner</code> named by <code>name</code> and sterotyped by
     * <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the
     ...
     * 
     * The returned object is an IStaticDiagram owned by <code>owner</code>
     * named by <code>name</code> and sterotyped by <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the metaclass
     ...
     * 
     * The created StructuredActivityNode has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an IStructuredActivityNode representing the
     * StructuredActivityNode in the Model.
     * @return An IStructuredActivityNode representing the
     * StructuredActivityNode in the Model.
     */
     ...
     * 
     * The created Substitution has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an ISubstitution representing the Abstraction in the Model.
     ...
     * 
     * The created TagParameter has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an TagParameter representing the Abstraction in the Model.
     ...
     * 
     * The created TaggedValue has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an TaggedValue representing the Abstraction in the Model.
     ...
     * 
     * The created TemplateBinding has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an ITemplateBinding representing the Abstraction in the Model.
     * @return An ITemplateBinding representing the TemplateBinding in the
     * Model.
     */
     ...
     * 
     * The created TemplateParameter has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an ITemplateParameter representing the Abstraction in the Model.
     * @return An ITemplateParameter representing the TemplateParameter in the
     * Model.
     */
     ...
     * 
     * The created TemplateParameterSubstitution has no composition owner. In
     * order to build a valid model, a composition owner must be defined. The
     * returned object is an ITemplateParameterSubstitution representing the
     * Abstraction in the Model.
     * @return An ITemplateParameterSubstitution representing the
     * TemplateParameterSubstitution in the Model.
     */
     ...
     * 
     * The created TerminatePseudoState has no composition owner. In order to
     * build a valid model, a composition owner must be defined. The returned
     * object is an ITerminatePseudoState representing the TerminatePseudoState
     * in the Model.
     * @return An ITerminatePseudoState representing the TerminatePseudoState in
     * the Model.
     */
     ...
     * Create a Transition.
     * 
     * The created Transition has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an ITransition representing the Abstraction in the Model.
     ...
     * Create a Usage.
     * 
     * The created Usage has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * IUsage representing the Abstraction in the Model.
     ...
     * Create a UseCase.
     * 
     * The created UseCase has no composition owner. In order to build a valid
     * model, a composition owner must be defined. The returned object is an
     * UseCase representing the Abstraction in the Model.
     * @return An UseCase representing the UseCase in the Model.
     */
     ...
     * 
     * The created UseCaseDependency has no composition owner. In order to build
     * a valid model, a composition owner must be defined. The returned object
     * is an UseCaseDependency representing the Abstraction in the Model.
     * @return An UseCaseDependency representing the UseCaseDependency in the
     * Model.
     */
     ...
     * 
     * The returned object is an UseCaseDiagram owned by <code>owner</code>
     * named by <code>name</code> and sterotyped by <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the
     * metaUseCase
    ...
    /**
     * Get all the roots of the editable model. They are mostly instances of
     * {@link Project}.
     ...
     * 
     * The returned object is an ICompositeStructureDiagram owned by
     * <code>owner</code> named by <code>name</code> and sterotyped by
     * <code>stereotype</code>
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if there is no stereotype matching the name and the metaclass
     ...
     * @param stereotype the name of the stereotype that will be used to type the Class
     * Diagram
     * @return An ICompositeStructureDiagram representing the diagram in the
     * Model.
     */
    ...
    /**
     * Get all the roots of the libraries. They are mostly instances of
     * {@link Component} or {@link Project}.
     ...
     * 
     * The created Association has no composition owner. In order to build a
     * valid model, a composition owner must be defined. The returned object is
     * an Association representing the Association in the Model.
     ...
     * Create a TaggedValue.
     * @throws org.modelio.api.model.ExtensionNotFoundException
     * if no tag type matching the given name and the element
     * metaclass is found
    ...
    @Override
    public MObject getRoot(MObject context) {
        ...
        for (MObject root : this.getModelRoots()) {
            if (root.equals(contextElement)) {
                return root;
            }
        }
        
        for (MObject root : this.getLibraryRoots()) {
            if (root.equals(contextElement)) {
                return root;
            }
        }
