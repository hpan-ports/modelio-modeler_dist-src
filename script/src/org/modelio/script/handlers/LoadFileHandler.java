    ...
    public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell shell, @Named(IServiceConstants.ACTIVE_PART) MPart part) {
        ...
        if (s != null) {
            ...
            try {
                ...
                e.printStackTrace();
                MessageDialog
                .openError(shell, Script.I18N.getMessage("Error"), Script.I18N.getMessage("FileNotFound", f.getPath()));
            } catch (IOException e) {
                e.printStackTrace();
                MessageDialog.openError(shell, Script.I18N.getMessage("Error"),
                        Script.I18N.getMessage("CannotLoadFile", f.getPath(), e.getLocalizedMessage()));
            }
        }
    }
