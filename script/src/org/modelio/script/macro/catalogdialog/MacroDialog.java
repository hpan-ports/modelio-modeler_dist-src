...
/*
    ...
    public Control createContentArea(Composite parent) {
        ...
        this.metaclassList = new org.eclipse.swt.widgets.Table(scriptPanel, SWT.BORDER);
    ...
    @Override
    public void init() {
        getShell().setText(Script.I18N.getString("MacroDialog.title"));
        setTitle(Script.I18N.getString("MacroDialog.title"));
        this.setMessage(Script.I18N.getString("MacroDialog.description"));
     ...
     * @throws com.modeliosoft.modelio.script.catalogdialog2.MacroDialog.IllegalPathException
    ...
    class ApplicableOnListener implements MouseListener {
