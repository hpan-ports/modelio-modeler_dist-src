...
public class DefaultLabelProvider extends AbstractModelioElementLabelProvider {
    ...
    @objid ("28592507-4ab5-11e2-a4d3-002564c97630")
    private static final Image EXML_FRAGMENT = DiagramBrowser.getImageDescriptor("icons/exmlfragment.png").createImage();

    @objid ("28592509-4ab5-11e2-a4d3-002564c97630")
    private static final Image RAMC_FRAGMENT = DiagramBrowser.getImageDescriptor("icons/ramcfragment.png").createImage();

    @objid ("2859250b-4ab5-11e2-a4d3-002564c97630")
    private static final Image MODULE_FRAGMENT = DiagramBrowser.getImageDescriptor("icons/modulefragment.png").createImage();

    @objid ("2859250d-4ab5-11e2-a4d3-002564c97630")
    private static final Image HTTP_FRAGMENT = DiagramBrowser.getImageDescriptor("icons/httpfragment.png").createImage();

    @objid ("2859250f-4ab5-11e2-a4d3-002564c97630")
    private static final Image SVN_FRAGMENT = DiagramBrowser.getImageDescriptor("icons/svnfragment.png").createImage();
    ...
    private DefaultLabelProvider() {
        ...
        URL bitmapUrl = FileLocator.find(imageBundle, new Path("icons/opened_folder_16.png"), null);
        this.images.put("OPENEDFOLDER", ImageDescriptor.createFromURL(bitmapUrl).createImage());
        
        bitmapUrl = FileLocator.find(imageBundle, new Path("icons/closed_folder_16.png"), null);
        this.images.put("CLOSEDFOLDER", ImageDescriptor.createFromURL(bitmapUrl).createImage());
        
        bitmapUrl = FileLocator.find(imageBundle, new Path("icons/opened_set_16.png"), null);
        this.images.put("OPENEDSET", ImageDescriptor.createFromURL(bitmapUrl).createImage());
        
        bitmapUrl = FileLocator.find(imageBundle, new Path("icons/closed_set_16.png"), null);
    ...
    public Image getImage(Object object) {
        if (object instanceof VirtualFolder) {
            ...
            case EXML:
                return EXML_FRAGMENT;
            case RAMC:
                return RAMC_FRAGMENT;
            case MDA:
                return MODULE_FRAGMENT;
            case EXML_URL:
                return HTTP_FRAGMENT;
            case EXML_SVN:
                return SVN_FRAGMENT;
            default:
                DiagramBrowser.LOG.warning("No image found for fragment type: " + fragment.getType());
                break;
            }
        }
        return null;
    ...
    /**
     * Helping class to compute an element label text . Note: DefaultMetamodelVisitor propagates missing visitXXXX methods up in the
     * inheritance tree
     */
    @objid ("0039d7e4-0d4f-10c6-842f-001ec947cd2a")
    static class LabelTextProvider extends DefaultModelVisitor {
        ...
        public static StyledString getLabel(MObject element) {
            return (StyledString) element.accept(INSTANCE);
        }
