...
/**
 * The 'BySet' model displays the DiagramSet hierarchy along with a unique VirtualFolder 'all diagrams' that itself displays all the
 * diagrams as a flat list.
 */
@objid ("002bc776-0d4f-10c6-842f-001ec947cd2a")
public class ByCtxContentProvider implements ITreeContentProvider, IModelChangeListener {
    ...
    public void modelChanged(IModelChangeEvent event) {
        // we are interested in deletion as we need to clean up the elementFolders map
    ...
    /**
     * Helping class to compute the children of an Element. This class implement the 'children' concept for this particular kind of
     * browser content provider (ie 'children' notion might differ from metamodel's one)
     */
    @objid ("002e7246-0d4f-10c6-842f-001ec947cd2a")
    static class ChildrenProvider extends AbstractModelVisitor {
    ...
    /**
     * Helping class to compute the parent of an Element. This class implement the 'parent' concept for this kind of browser content
     * provider (ie 'parent' notion might differ from metamodel's) For example this 'flat' model does not support DiagramSet which
     * therefore return not parent Note: DefaultMetamodelVisitor propagates missing visitXXXX methods up in the inheritance tree
     */
    @objid ("002f5684-0d4f-10c6-842f-001ec947cd2a")
    static class ParentProvider extends DefaultModelVisitor {
