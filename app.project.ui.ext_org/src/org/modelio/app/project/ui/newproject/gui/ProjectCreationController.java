...
public class ProjectCreationController implements Listener, ISelectionChangedListener {
     ...
     * @param projectComposite
     * The project tab.
     * @param dialog The project creation dialog
     * @param dataModel The data model
     */
    @objid ("0046d53e-cc35-1ff2-a7f4-001ec947cd2a")
    public ProjectCreationController(final ProjectCreationDialog dialog, final ProjectCreationDataModel dataModel, final IModuleCatalog moduleCatalog) {
