...
public abstract class DiagramAbstractLink extends DiagramGraphic implements IDiagramLink {
    ...
    public ILinkPath getPath() {
        ...
        final Object pathData = getModelPath().getPathData();
        final IConnectionHelper helper = ConnectionHelperFactory.createFromSerializedData(getModelPath()
                                                                                          .getRouterKind(),
                                                                                          pathData,
                                                                                          cnx);
    ...
    public void setRouterKind(LinkRouterKind routerKind) {
        ...
        if (styleKey != null) {
            ...
            getModel().getStyle().setProperty(styleKey, routerId);
        }
    }
    ...
    public String getProperty(final String property) {
        ...
        if (key != null) {
            return StyleKeyTypeConverter.convertToString(key, getModel().getStyle().getProperty(key));
        }
        return null;
    }
    ...
    public String getFont() {
        ...
        final Font currentFont = getModel().getStyle().getProperty(styleKey);
    ...
    public String getLineColor() {
        ...
        final Color color = getModel().getStyle().getProperty(styleKey);
    ...
    public int getLinePattern() {
        ...
        final LinePattern pattern = getModel().getStyle().getProperty(styleKey);
    ...
    public int getLineRadius() {
        ...
        return getModel().getStyle().getProperty(styleKey);
    }
    ...
    public void setDrawLineBridges(final boolean value) {
        ...
        getModel().getStyle().setProperty(styleKey, value);
    }
    ...
    public void setLinePattern(final int value) {
        ...
        getModel().getStyle().setProperty(styleKey, pattern);
    }
    ...
    public IStyleHandle getStyle() {
        final NamedStyle style = ((NamedStyle) getModel().getStyle().getCascadedStyle());
    ...
    public void setStyle(final IStyleHandle style) {
        ...
        getModel().getStyle().setCascadedStyle(namedStyle);
    }
    ...
    public List<String> getLocalPropertyNames() {
        ...
        for (final StyleKey key : getModel().getStyle().getLocalKeys()) {
            ret.add(key.getId());
        }
        return ret;
    }
