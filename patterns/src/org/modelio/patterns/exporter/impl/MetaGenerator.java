...
class MetaGenerator {
    ...
    private void generateElementCode(FileWriterUtil filewriter, MObject element) {
        if (!IdGenerator.getInstance().exists(element)) {
            ...
            String metaclass = element.getMClass().getName();
        
            // Element Creation
        
            filewriter.countWrite("elements.add(model.create(\"" + metaclass + "\",root));");
    ...
    private void generateAttribute(FileWriterUtil filewriter, MObject element, MAttribute attribute, int elementsIndex) {
        ...
        if (attType == UUID.class) {
            ...
            filewriter.countWrite("elements.get(" + elementsIndex + ").mSet(elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\"),\"" + this.paramManager.parameterFormater(attValue.toString(), element) + "\");");
        } else if (attType == Integer.class) {
            filewriter.countWrite("elements.get(" + elementsIndex + ").mSet(elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\"),Integer.valueOf(\"" + attValue.toString() + "\"));");
        } else if (attType == Long.class) {
            filewriter.countWrite("elements.get(" + elementsIndex + ").mSet(elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\"),Long.valueOf(\"" + attValue.toString() + "\"));");
        } else if (attType == Float.class) {
            filewriter.countWrite("elements.get(" + elementsIndex + ").mSet(elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\"),Float.valueOf(\"" + attValue.toString() + "\"));");
        } else if (attType == Double.class) {
            filewriter.countWrite("elements.get(" + elementsIndex + ").mSet(elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\"),Double.valueOf(\"" + attValue.toString() + "\"));");
        } else if (attType == Boolean.class) {
            filewriter.countWrite("elements.get(" + elementsIndex + ").mSet(elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\"),Boolean.valueOf(\"" + attValue.toString() + "\"));");
        } else if (attType.isEnum()) {
            filewriter.countWrite("elements.get(" + elementsIndex + ").mSet(elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\"),Enum.valueOf((java.lang.Class<? extends Enum>)elements.get(" + elementsIndex + ").getMClass().getAttribute(\"" + attribute.getName() + "\").getType(), \"" + this.paramManager.parameterFormater(((Enum<?>) attValue).name(), element) + "\"));");
        }
    }
