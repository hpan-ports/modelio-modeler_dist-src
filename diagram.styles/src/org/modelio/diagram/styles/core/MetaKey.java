...
public class MetaKey {
    ...
    /**
     * Features and inner name spaces auto unmask filter. Possible values are: <li>
     * {@link UmaskByVisibilityStragegy#ALL} : show all, <li> {@link UmaskByVisibilityStragegy#ALL_PUBLIC} : show only
     * public, <li> {@link UmaskByVisibilityStragegy#ALL_NON_PRIVATE} : show all but privates, <li>
    ...
    public String toString() {
        return this.getKey() + ": " + this.getType().getSimpleName();
    }
    ...
    public static final class InternalGroup {
        ...
        /**
         * Internal structure viewing mode meta key. {@link InternalsViewMode} type. Possible values are: <li>
         * {@link InternalsViewMode#NONE}, <li> {@link InternalsViewMode#LIST}, <li> {@link InternalsViewMode#DIAGRAM},
         */
    ...
    public static final class InnerGroup {
        ...
        /**
         * Inner classes unmask strategy. Possible values are: <li> {@link UmaskByVisibilityStragegy#ALL}, <li>
         * {@link UmaskByVisibilityStragegy#ALL_PUBLIC}, <li> {@link UmaskByVisibilityStragegy#ALL_NON_PRIVATE}, <li>
