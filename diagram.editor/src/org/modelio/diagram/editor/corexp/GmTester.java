 ...
 * Operates on selection.<p/>
 * Supported properties are:<ul>
 * <li>'is-gmnsu' - true is all selected elements are NamespaceUse links </li>
...
public class GmTester extends PropertyTester {
    ...
    public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
        ...
        case IS_GMLINK:
            ...
            for (Object element : elements) {
                if (!(element instanceof GmLinkEditPart)) {
                    return false;
                }
            }
            return true;
        ...
        case IS_GMNSU:
            // true is all selected elements are NamespaceUse links 
            for (Object element : elements) {
                if (!isNsu(element)) {
                    return false;
                }
    ...
    private boolean isNsu(Object element) {
        return (element instanceof GmLinkEditPart) && (((GmLinkEditPart) element).getModel() instanceof GmNamespaceUse);
    }
