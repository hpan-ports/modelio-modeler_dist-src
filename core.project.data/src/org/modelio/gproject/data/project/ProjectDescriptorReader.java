...
public class ProjectDescriptorReader {
    ...
    private ModuleDescriptor decodeModule(final Element domEl) throws IOException {
        ...
        md.setActivated(readBoolean(domEl.getAttribute("activated"), true));
        ...
        try {
            ...
            try {
                ...
                e.addSuppressed(e2);
                String msg = GProjectData.getMessage("ProjectDescriptorReader.module.invalidUri"
                        , md.getName(), archiveLoc, e.getLocalizedMessage());
