...
class JarRunner {
    ...
    public void runJarFile(GProject openedProject, File scriptFile, Map<String, String> params) {
        ...
        try {
            ...
            //staticContext.set("", Display.getDefault().getActiveShell());
            staticContext.set(Modelio.class, Modelio.getInstance());
            staticContext.set(GProject.class, openedProject);
            staticContext.set(IModelingSession.class, Modelio.getInstance().getModelingSession());
