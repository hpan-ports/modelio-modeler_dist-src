...
public class CheckboxLabelProvider extends ColumnLabelProvider {
    ...
    private static final Image CHECKED = ModulePropertyTab.getImageDescriptor("icons/checked.gif").createImage();

    @objid ("c891ea01-1eba-11e2-9382-bc305ba4815c")
    private static final Image UNCHECKED = ModulePropertyTab.getImageDescriptor("icons/unchecked.gif").createImage();

    @objid ("c8921111-1eba-11e2-9382-bc305ba4815c")
