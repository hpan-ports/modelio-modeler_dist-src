...
import org.modelio.metamodel.impl.expert.links.impl.creation.BindingCreationExpert;
import org.modelio.metamodel.impl.expert.links.impl.creation.BpmnDataAssociationCreationExpert;
import org.modelio.metamodel.impl.expert.links.impl.creation.BpmnMessageFlowCreationExpert;
import org.modelio.metamodel.impl.expert.links.impl.creation.BpmnSequenceFlowCreationExpert;
import org.modelio.metamodel.impl.expert.links.impl.creation.ClassAssociationCreationExpert;
import org.modelio.metamodel.impl.expert.links.impl.creation.DefaultLinkExpert;
import org.modelio.metamodel.impl.expert.links.impl.creation.TemplateBindingCreationExpert;
import org.modelio.metamodel.impl.expert.links.impl.ends.ChangeDestinationVisitor;
import org.modelio.metamodel.impl.expert.links.impl.ends.ChangeSourceVisitor;
import org.modelio.metamodel.impl.expert.links.impl.ends.GetSourceVisitor;
import org.modelio.metamodel.impl.expert.links.impl.ends.GetTargetVisitor;
import org.modelio.metamodel.impl.expert.meta.IMetaExpert;
import org.modelio.metamodel.impl.expert.meta.impl.BpmnLaneCreationExpert;
import org.modelio.metamodel.impl.expert.meta.impl.DefaultMetaExpert;
import org.modelio.metamodel.impl.expert.meta.impl.PartDecompositionCreationExpert;
...
public class StandardMetamodelExpert extends org.modelio.vcore.smkernel.meta.DefaultMetaExpert {
    ...
    public void setTarget(MObject linkElement, final MObject oldTarget, MObject newTarget) throws IllegalArgumentException {
        ...
        try {
            linkElement.accept(this.changeDestVisitor);
        } catch (final ClassCastException e) {
...
// typical usage : property box for element editor ?
    ...
    private static class LinkExpertRegistry {
        ...
        public LinkExpertRegistry(MMetamodel mm) {
            ...
            this.EXPERTS.put(mm.getMClass(Binding.class.getSimpleName()), new BindingCreationExpert(this.DEFAULT_EXPERT));
            this.EXPERTS.put(mm.getMClass(BpmnDataAssociation.class.getSimpleName()), new BpmnDataAssociationCreationExpert(
                    this.DEFAULT_EXPERT));
            this.EXPERTS.put(mm.getMClass(BpmnMessageFlow.class.getSimpleName()), new BpmnMessageFlowCreationExpert(
                    this.DEFAULT_EXPERT));
            this.EXPERTS.put(mm.getMClass(BpmnSequenceFlow.class.getSimpleName()), new BpmnSequenceFlowCreationExpert(
                    this.DEFAULT_EXPERT));
            this.EXPERTS.put(mm.getMClass(TemplateBinding.class.getSimpleName()), new TemplateBindingCreationExpert(
                    this.DEFAULT_EXPERT));
            this.EXPERTS.put(mm.getMClass(ClassAssociation.class.getSimpleName()), new ClassAssociationCreationExpert(
                    this.DEFAULT_EXPERT));
        }
    ...
    private static class MetaExpertRegistry {
        ...
        public MetaExpertRegistry(MMetamodel mm) {
            ...
            this.EXPERTS.put(mm.getMClass(Lifeline.class),
                    new PartDecompositionCreationExpert((SmClass) mm.getMClass(PartDecomposition.class)));
