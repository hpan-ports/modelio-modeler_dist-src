...
public class DefaultMetaExpert implements IMetaExpert {
    ...
    static class MetamodelRules {
        ...
        private void registerUmlNodes() {
            ...
            addRule("AnalystProject", "RiskContainer");
            ...
            // Risk
            addRule("Risk", "Constraint");
            addRule("Risk", "MatrixDefinition");
            addRule("Risk", "Note");
            addRule("Risk", "ExternDocument");
            addRule("Risk", "PropertyValueSet");
            addRule("Risk", "Risk");
            
            // RiskContainer
            addRule("RiskContainer", "Constraint");
            addRule("RiskContainer", "MatrixDefinition");
            addRule("RiskContainer", "Note");
            addRule("RiskContainer", "ExternDocument");
            addRule("RiskContainer", "Risk");
            addRule("RiskContainer", "RiskContainer");
            addRule("RiskContainer", "StaticDiagram");
