...
public class UseCaseDependencyData extends ModelElementData {
    @objid ("13ebfb87-30d2-4bfa-aac1-c0d33d2f9cb4")
     SmObjectImpl mOrigin;

    @objid ("b007635e-2647-4d8e-8d97-b17977624b6d")
     List<SmObjectImpl> mExtensionLocation = null;

    @objid ("703e7655-72d1-480e-93ec-2f2c452472b6")
     SmObjectImpl mTarget;

    @objid ("c55ac727-04c8-4dd7-94ff-0ff9e242bca1")
