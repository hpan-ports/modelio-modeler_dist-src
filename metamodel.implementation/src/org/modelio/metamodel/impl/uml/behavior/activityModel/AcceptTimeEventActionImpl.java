...
public class AcceptTimeEventActionImpl extends ActivityActionImpl implements AcceptTimeEventAction {
    ...
    @objid ("da73fbda-3b35-433a-b920-340068fd8e2b")
    @Override
    ...
    @objid ("e5fd448f-dfb6-4872-9737-38d69c40c3b1")
    @Override
