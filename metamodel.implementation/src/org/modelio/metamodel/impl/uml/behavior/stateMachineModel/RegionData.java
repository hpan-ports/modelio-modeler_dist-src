...
public class RegionData extends ModelElementData {
    @objid ("374fefab-e2f9-45fd-81e7-21b40955015b")
     SmObjectImpl mParent;

    @objid ("10f66916-ff1f-497e-8051-5d8815f61ab7")
     SmObjectImpl mRepresented;

    @objid ("0054170a-a313-415f-9a68-21fed34e7b25")
     List<SmObjectImpl> mSub = null;

    @objid ("92b027f9-6cfe-4a48-9420-c020080fad6b")
