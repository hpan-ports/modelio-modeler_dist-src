...
public class ConnectionPointReferenceData extends StateVertexData {
    @objid ("48c0402b-ca57-45d3-92a4-2d45c2d8b88b")
     SmObjectImpl mExit;

    @objid ("1bc13a3c-6874-49e4-8b59-604520d649ee")
     SmObjectImpl mEntry;

    @objid ("2fdde231-36a8-4c66-8497-5038d1f6200c")
     SmObjectImpl mOwnerState;

    @objid ("20b0afa8-4c50-4d77-88cb-ef38b07d57f5")
