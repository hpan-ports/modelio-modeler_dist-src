...
public class InteractionOperandData extends InteractionFragmentData {
    @objid ("7f4b1425-69eb-449b-8dea-18c8860a2ffd")
     Object mGuard = "";

    @objid ("3357a93d-2a2d-41e0-9770-3843663764ba")
     Object mEndLineNumber = 0;

    @objid ("646b9614-704b-4a7a-8d40-9586963e10a6")
     List<SmObjectImpl> mFragment = null;

    @objid ("d2564613-766e-4f8a-b753-2128109aebd1")
     SmObjectImpl mOwnerFragment;

    @objid ("8ae818be-b5e2-4a5d-8606-32b0bdd277d5")
