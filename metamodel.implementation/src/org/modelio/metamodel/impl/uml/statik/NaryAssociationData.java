...
public class NaryAssociationData extends ModelElementData {
    @objid ("285d46c2-5230-4b20-bba8-5be1d11a64e6")
     List<SmObjectImpl> mOccurence = null;

    @objid ("9eb13756-89b6-4bbc-ac52-ba60b7ead0a2")
     List<SmObjectImpl> mNaryEnd = null;

    @objid ("57ecc86d-fd88-4198-8abc-446ad33352fa")
     SmObjectImpl mLinkToClass;

    @objid ("59c47f49-a5d2-413b-86d0-7d40bba518fa")
