...
public class BpmnUserTaskImpl extends BpmnTaskImpl implements BpmnUserTask {
    ...
    @objid ("7193aad5-5d64-4bde-9245-2eb1c4a27976")
    @Override
    ...
    @objid ("8134f0e6-1ad2-4cf6-a0d4-57f4217a9e5c")
    @Override
