...
public class BpmnComplexGatewayImpl extends BpmnGatewayImpl implements BpmnComplexGateway {
    @objid ("b97e6c84-1e19-4e4b-80eb-8a848f3b56a4")
    @Override
    ...
    @objid ("e7c0a30c-756c-4789-b1cf-2bbb7cf41b97")
    @Override
    ...
    @objid ("07344040-2b79-4fd2-83a3-0d4719844177")
    @Override
    ...
    @objid ("7806b623-18f1-42d2-9540-66a6113c3534")
    @Override
    ...
    @objid ("57680846-04d5-45a5-87be-9e026f6dc0b8")
    @Override
    ...
    @objid ("fbcfc7b5-3a14-4b70-ab93-cf0fb0b87a04")
    @Override
    ...
    @objid ("263ebbac-fde4-4f20-84ef-fa4a8f6e7f58")
    @Override
