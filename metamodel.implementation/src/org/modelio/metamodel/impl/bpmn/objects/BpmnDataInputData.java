...
public class BpmnDataInputData extends BpmnItemAwareElementData {
    @objid ("672f2f82-7350-4f5b-b176-3c97c2e447f2")
     SmObjectImpl mRepresentedParameter;

    @objid ("df79748e-0003-4e55-b205-cbd751e16542")
     SmObjectImpl mOwnerLoopCharacteristics;

    @objid ("ea37390f-6064-4936-ac7f-804b43776323")
     SmObjectImpl mOwnerActivity;

    @objid ("574c728f-293d-4579-99ca-be4b0b86f736")
     SmObjectImpl mOwnerThrowEvent;

    @objid ("6d5830e4-8dac-497b-94fc-e36c752a1d34")
