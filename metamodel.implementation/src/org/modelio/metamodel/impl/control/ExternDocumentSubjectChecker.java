...
public class ExternDocumentSubjectChecker extends AbstractDependencyTypeChecker {
    ...
    public ExternDocumentSubjectChecker(SmMetamodel mm) {
        ...
        // Direct checker
        register(mm.getMClass(ExternDocument.class), "Subject");
        
        // Symetric checker
        ModelElementDocumentChecker symetricChecker = new ModelElementDocumentChecker(this);
        symetricChecker.register(mm.getMClass(ModelElement.class), "Document");
    }
    ...
    private SmClass getBaseClass(ExternDocument note) {
        ExternDocumentType type = note.getType();
