 ...
 * 
 */
package org.modelio.linkeditor.showinheritance;
 ...
 * @author fpoyer
 */
@objid ("1b7e367a-5e33-11e2-b81d-002564c97630")
public class ShowInheritanceHandler {
    @objid ("1b7e367c-5e33-11e2-b81d-002564c97630")
    @Execute
    public Object execute(MPart part) {
        if (part.getObject() instanceof LinkEditorView) {            
            ...
            linkEditorView.getOptions().setInheritanceShown(!linkEditorView.getOptions().isInheritanceShown());
