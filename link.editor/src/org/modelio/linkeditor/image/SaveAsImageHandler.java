...
public class SaveAsImageHandler {
    ...
    @objid ("1b477742-5e33-11e2-b81d-002564c97630")
     static final int[] filterFormats = { SWT.IMAGE_PNG, SWT.IMAGE_BMP, SWT.IMAGE_JPEG, SWT.IMAGE_GIF };
    ...
    public Object execute(@Named(IServiceConstants.ACTIVE_PART) final MPart part) {
        ...
        if (saveInfo != null)
            saveAsImage(editor.getGraphicalViewer().getRootEditPart(), saveInfo);
        return null;
    }

    @objid ("1b477750-5e33-11e2-b81d-002564c97630")
    private void saveAsImage(final RootEditPart rootEditPart, final SaveInfo saveInfo) {
