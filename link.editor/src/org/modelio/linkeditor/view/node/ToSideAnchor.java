...
public class ToSideAnchor extends AbstractConnectionAnchor {
    ...
    public ToSideAnchor(final IFigure owner) {
        super(owner);
    }
    ...
    public Point getLocation(final Point reference) {
        Point p = LinkEditorView.getOptions().isLayoutOrientationVertical() ? this.getOwner().getBounds().getTop().getCopy() : this.getOwner()
