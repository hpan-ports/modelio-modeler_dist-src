...
class DialogView extends ModelioDialog {
    ...
    public Control createContentArea(final Composite parent) {
        ...
        this.removeAll.setText(LinkEditor.I18N.getString("RemoveAll"));
    ...
    public void init() {
        ...
        getShell().setText(LinkEditor.I18N.getMessage("DialogView.WindowTitle"));
        setTitle(LinkEditor.I18N.getMessage("DialogView.DialogTitle"));
        setMessage(LinkEditor.I18N.getMessage("DialogView.DialogMessage"));
