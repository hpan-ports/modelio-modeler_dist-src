...
public class GmArtifactPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmArtifactPrimaryNode(GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmArtifact.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmArtifactPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmArtifactPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
