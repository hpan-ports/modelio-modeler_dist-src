...
public class GmNodePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmNodePrimaryNode(GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmNode.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNodePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNodePrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
