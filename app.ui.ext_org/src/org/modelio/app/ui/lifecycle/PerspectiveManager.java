...
/**
 * This class manages perspectives for Modelio, implementing the
 * IModelioUiService.<br/>
 * It is also listening to project open and close events in order to
 * automatically switch from the workspace to the model perspective
 * 
 * @author phv
 */
