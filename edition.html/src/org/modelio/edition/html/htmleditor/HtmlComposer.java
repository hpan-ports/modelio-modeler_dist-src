...
package org.modelio.edition.html.htmleditor;
...
import org.modelio.edition.html.htmleditor.commands.Command;
import org.modelio.edition.html.htmleditor.commands.GetHtmlCommand;
import org.modelio.edition.html.htmleditor.commands.SetHtmlCommand;
import org.modelio.edition.html.htmleditor.events.NodeSelectionEvent;
import org.modelio.edition.html.htmleditor.listener.NodeSelectionChangeListener;
import org.modelio.edition.html.htmleditor.util.ColorConverter;
...
public class HtmlComposer {
    ...
    public HtmlComposer(final Composite parent, final int style) {
        ...
        URL baseUrl;
        try {
            baseUrl = FileLocator.resolve(FileLocator.find(HtmlTextPlugin.getDefault().getBundle(), new Path("rte/js/base.html"),
