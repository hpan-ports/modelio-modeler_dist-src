...
/**
 * Warning: class is a singleton (to avoid repeated parsing of the extensions)
 */
...
public class CreationContributorManager {
    ...
    private static CreationContributorManager instance = null;
    ...
    public static CreationContributorManager getInstance() {
        if (instance == null) {
            instance = new CreationContributorManager();
        }
        return instance;
    }

    @objid ("4ce97c94-0cc4-4c1a-a289-a7352e8132d6")
    public CreationContributorManager() {
    ...
    private void readExtensions() {
        ...
        for (IConfigurationElement element : config) {
            if (element.getName().equals("creation")) {
    ...
    public List<IWizardContributor> getContributors(String category) {
    ...
    public List<IWizardContributor> getAllContributorsList() {
