...
import org.modelio.creation.wizard.contributor.ClassDiagramCreationContributor;
...
public class CreationWizardDialog extends ModelioDialog {
    ...
    public CreationWizardDialog(final Shell parentShell, final CreationContributorManager contributorManager, final CreationWizardModel dataModel, IProjectService projectService, IModelioPickingService pickingService) {
        super(parentShell);
        ...
        this.controller = new CreationWizardController(this, dataModel, contributorManager);
    }
    ...
    private void addListeners() {
        ...
        this.treeViewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                CreationWizardDialog.this.controller.onContributorSelection(SelectionHelper.getFirst(event.getSelection(),
                        IWizardContributor.class));
        ...
        this.treeViewer.addDoubleClickListener(new IDoubleClickListener() {
            ...
            public void doubleClick(DoubleClickEvent event) {
                // Double click to create the selected contribution if ok button is enabled
    ...
    private Composite createEditionArea(Composite parent) {
        Group editionArea = new Group(parent, SWT.BORDER_SOLID);
        editionArea.setLayout(new GridLayout(2, false));
        
        editionArea.setText(CreationWizard.I18N.getMessage("Ui.CreationWizard.IdGroup.label"));
        
        Label nameLabel = new Label(editionArea, SWT.NONE);
        ...
        this.nameText = new Text(editionArea, SWT.BORDER);
        this.nameText.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
        
        Label contextLabel = new Label(editionArea, SWT.NONE);
        ...
        this.contextText = new TextElement(editionArea, SWT.BORDER);
    ...
    private Composite createTypeBrowserArea(Composite parent) {
        Group typeBrowserArea = new Group(parent, SWT.NONE);
        typeBrowserArea.setLayout(new GridLayout(1, false));
        typeBrowserArea.setText(CreationWizard.I18N.getMessage("Ui.CreationWizard.TypeGroup.label"));
        
        // Diagrams list tree viewer
        this.treeViewer = new TreeViewer(typeBrowserArea, SWT.V_SCROLL | SWT.BORDER);
        this.treeViewer.setContentProvider(new ContributorTreeContentProvider(this.controller.getDataModel().getContext(), false));
        this.treeViewer.setLabelProvider(new ContributorTreeLabelProvider(null));
        this.treeViewer.setSorter(new ContributorSorter(null));
        this.treeViewer.setInput(new ContributorCategoryModel(this.controller.contributorManager.getContributorsMap()));
        this.treeViewer.getControl().setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
        
        // Hide invalid checkbox
        this.hideInvalidCheckBox = new Button(typeBrowserArea, SWT.CHECK);
    ...
    void updateCustomArea(CreationWizardModel dataModel) {
        ...
        if (contributor != null) {
            ...
            Control composite = (Control) this.customArea.createPanel(this.composite);
    ...
    private static class CreationWizardController {
        ...
        @objid ("1e1f2d30-1b94-4c5c-b103-b7dafdf1fe55")
        private CreationContributorManager contributorManager;
        ...
        public void onHideInvalidContributors(final boolean hideInvalidContributors) {
            ...
            // and if the currently selectedContributor is not valid for the current context
            ...
            ContributorTreeContentProvider cp = (ContributorTreeContentProvider) this.dwDialog.treeViewer.getContentProvider();
        ...
        public CreationWizardController(CreationWizardDialog dwDialog, CreationWizardModel dwModel, CreationContributorManager contributorManager) {
            this.dwData = dwModel;
                ...
                if (validContributors.size() > 0) {
                    ...
                    for (IWizardContributor contributor : validContributors) {
                        if (contributor instanceof IDiagramWizardContributor) {
                            if (classDiagramContributor == null && contributor.getClass().equals(ClassDiagramCreationContributor.class)) {
                                classDiagramContributor = contributor;
                            } else if (firstUmlDiagramContributor == null && contributor.getClass().getPackage() == ClassDiagramCreationContributor.class.getPackage()) {
                     ...
                     * - class diagram is always first
                     * - first UML diagram is class diagram isn't valid
                     * - first diagram when no UML diagram is valid
                     * - last chance fallback, use first contributor
                     */
        ...
        private List<IWizardContributor> getValidContributors(final MObject context) {
            ...
            for (IWizardContributor type : this.contributorManager.getAllContributorsList()) {
                if (context != null) {
        ...
        private static class WizardPreviewPanelUI {
            ...
            private void switchPreviewImage(ImageDescriptor imageDescriptor) {
                ...
                if (imageDescriptor != null) {
                    ...
                    URL imageUrl = FileLocator.find(bundle, new Path("icons/noimagepreview.png"), null);
            ...
            public void update(IWizardContributor selectedContributor) {
                ...
                if (selectedContributor != null) {
                    ...
                    this.detailsLink.setText((helpUrl != null) ? CreationWizard.I18N.getMessage("Ui.CreationWizard.More")
                            : "");
