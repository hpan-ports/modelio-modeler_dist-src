...
import org.modelio.creation.wizard.contributor.AbstractUMLDiagramCreationContributor;
...
public class ContributorSorter extends ViewerSorter {
    ...
    public int compare(Viewer viewer, Object e1, Object e2) {
        ...
        if (e1 instanceof Category && e2 instanceof Category) {
            ...
            boolean isStandardE1 = contributor1.getClass().getPackage() == AbstractUMLDiagramCreationContributor.class.getPackage();
            boolean isStandardE2 = contributor2.getClass().getPackage() == AbstractUMLDiagramCreationContributor.class.getPackage();
    ...
    public int category(Object element) {
        ...
        if (element instanceof Category) {
            ...
            if (contributor instanceof IDiagramWizardContributor) {
                return 2;
            } else /*if (contributor instanceof IMatrixWizardContributor)*/ {
                return 3;
            }
        }
        return 4;
