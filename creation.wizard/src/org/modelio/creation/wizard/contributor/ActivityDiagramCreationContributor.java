...
public class ActivityDiagramCreationContributor extends AbstractUMLDiagramCreationContributor {
    ...
    public String getDetails() {
        return CreationWizard.I18N.getString("CreationWizard.Activity.Details");
    }

    @objid ("f4d2aed7-590d-4761-9667-cc709fad8a6e")
    @Override
    public Image getIcon() {
        return MetamodelImageService.getIcon(getMetamodel().getMClass(ActivityDiagram.class));
    }

    @objid ("d086291b-41dc-4037-9c6b-72fa05c660d4")
    @Override
    public String getInformation() {
        return CreationWizard.I18N.getString("CreationWizard.Activity.Information");
    }

    @objid ("a5827623-b2ee-43e0-956c-3f7a4412bfbd")
    @Override
    public String getLabel() {
        return CreationWizard.I18N.getString("CreationWizard.Activity.Name");
    }
    ...
    @objid ("e8ad90ae-5840-4393-b19b-beb7c78dfea0")
    @Override
    public List<CommandScope> getScopes() {
        ...
        allowedScopes.add(new CommandScope(getMetamodel().getMClass(Activity.class), null));
        return allowedScopes;
    }

    @objid ("e0fcdb4d-3547-4a1e-b2db-c2863daa1ef3")
    @Override
    public ImageDescriptor getPreviewImage() {
        Bundle bundle = CreationWizard.getContext().getBundle();
        URL imageUrl = FileLocator.find(bundle, new Path("icons/activitydiagrampreview.png"), null);
