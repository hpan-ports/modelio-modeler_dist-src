...
public class StaticDiagramConfigurer implements IDiagramConfigurer {
    ...
    public PaletteRoot initPalette(final AbstractDiagramEditor diagram, final ToolRegistry toolRegistry) {
        ...
        paletteRoot.add(this.createCommonGroup());
        return paletteRoot;
    }

    @objid ("36f18e4c-55b7-11e2-877f-002564c97630")
    private PaletteEntry createCommonGroup() {
        final PaletteDrawer commonGroup = new PaletteDrawer(DiagramEditorStatik.I18N.getMessage("StatikPaletteGroup.Common"),
                                                            null);
