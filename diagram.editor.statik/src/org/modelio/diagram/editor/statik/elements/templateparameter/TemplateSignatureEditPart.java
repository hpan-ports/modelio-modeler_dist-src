...
public class TemplateSignatureEditPart extends ModelElementLabelEditPart {
    ...
    private void updateFigureBorder(final IFigure aFigure) {
        final TemplateSignatureFigure classFig = (TemplateSignatureFigure) aFigure;
        final ZoomableLineBorder inner = new ZoomableLineBorder(classFig.getLineColor(),
                                                                classFig.getLineWidth());
