...
public class GmPortPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmPortPrimaryNode(final GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPortPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPortPrimaryNode." + MINOR_VERSION_PROPERTY,
