...
public class GmCommunicationInteraction extends GmPortContainer {
    ...
    public GmCommunicationInteraction(final GmAbstractDiagram diagram, final CommunicationInteraction el, final MRef ref) {
        super(diagram, ref);
        this.element = el;
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationInteraction." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationInteraction." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(final IDiagramReader in) {
        super.read(in);
        this.element = (CommunicationInteraction) resolveRef(this.getRepresentedRef());
     ...
     */
    @objid ("3496d57c-55b7-11e2-877f-002564c97630")
    @Override
