...
public class GmConnectorLink extends GmInstanceLink {
    ...
    public GmConnectorLink(GmAbstractDiagram diagram, ConnectorEnd role, MRef roleRef, final MRef connectorRef) {
    ...
    protected void readLink(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmConnectorLink." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConnectorLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
