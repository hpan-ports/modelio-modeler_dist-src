...
public class GmInterfaceRealization extends GmLink {
    ...
    public GmInterfaceRealization(GmAbstractDiagram diagram, InterfaceRealization generalization, MRef ref) {
        super(diagram, ref);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInterfaceRealization." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
