...
public final class GmInternalStructure extends GmNoStyleCompositeNode implements PropertyChangeListener {
    ...
    public GmInternalStructure(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public GmInternalStructure(final GmAbstractDiagram diagram, final MRef relatedRef, final GmFreeZone zone, final GmGroup group) {
        super(diagram, relatedRef);
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInternalStructure." + MINOR_VERSION_PROPERTY);
    ...
    public void write(final IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInternalStructure." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    public GmCompositeNode getCompositeFor(final Class<? extends MObject> metaclass) {
        if (getStyle().getProperty(getStyleKey(MetaKey.InternalGroup.INTVIEWMODE)) == InternalsViewMode.DIAGRAM) {
    ...
    private boolean isManualUnmask() {
        ...
        if (styleKey != null) {
            boolean autoUnmask = this.getStyle().getProperty(styleKey);
