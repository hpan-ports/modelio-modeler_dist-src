...
public class GmQualifierGroup extends GmGroup {
    ...
    public GmQualifierGroup(GmAbstractDiagram diagram, MRef relatedRef, final AssociationEnd role) {
    ...
    protected void updateStyle(final GmLink parentLink) {
        ...
        if (gmRef != null)
            getStyle().setCascadedStyle(gmRef.getStyle());
        else
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmQualifierGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmQualifierGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
