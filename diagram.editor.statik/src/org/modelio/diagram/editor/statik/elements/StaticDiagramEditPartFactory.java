...
public class StaticDiagramEditPartFactory implements EditPartFactory {
    @objid ("36b792a4-55b7-11e2-877f-002564c97630")
    private static final StaticDiagramEditPartFactory INSTANCE = new StaticDiagramEditPartFactory();
     ...
     * @return the instance.
     */
    @objid ("36b792a9-55b7-11e2-877f-002564c97630")
    public static EditPartFactory getInstance() {
        return INSTANCE;
    }

    @objid ("36b792ae-55b7-11e2-877f-002564c97630")
    private StaticDiagramEditPartFactory() {
    ...
    public class StructuredModeEditPartFactory implements EditPartFactory {
        ...
        public EditPart createEditPart(EditPart context, Object model) {
            ...
            if (model.getClass() == GmPackage.class) {
                RepresentationMode realMode = RepresentationMode.STRUCTURED;
                GmPackagePrimaryNode mainNode = ((GmPackage) model).getMainNode();
                if (mainNode != null) {
                    realMode = mainNode.getRepresentationMode();
                }
                switch (realMode) {
                    case SIMPLE:
            ...
            if (model.getClass() == GmStaticDiagramView.class) {
