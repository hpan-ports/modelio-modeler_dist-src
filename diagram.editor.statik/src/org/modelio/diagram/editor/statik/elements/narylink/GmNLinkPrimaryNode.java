...
public class GmNLinkPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmNLinkPrimaryNode(final GmAbstractDiagram diagram, final NaryLink assoc, final MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmNLinkNode.KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNLinkPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNLinkPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
