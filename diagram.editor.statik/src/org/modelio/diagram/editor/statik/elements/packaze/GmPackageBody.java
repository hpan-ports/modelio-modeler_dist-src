...
public class GmPackageBody extends GmBodyFreeZone {
    ...
    public GmPackageBody(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void refreshFromObModel() {
        ...
        final StyleKey.UmaskByVisibilityStragegy mode = this.getStyle()
                .getProperty(GmPackageStructuredStyleKeys.UNMASKINGSTRATEGY);
        ...
        final Boolean unmaskInstances = this.getStyle()
                .getProperty(GmPackageStructuredStyleKeys.INSTANCEUNMASKING);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPackageBody." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPackageBody." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
