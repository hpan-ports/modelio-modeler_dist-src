...
public class GmEnumLitteralGroup extends GmGroup {
    ...
    public GmEnumLitteralGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        return ((Boolean) getStyle().getProperty(EnumStructuredStyleKeys.LITGROUPVISIBLE) && getParent().getRepresentationMode()
                                                                                                                                .equals(RepresentationMode.STRUCTURED));
    }
    ...
    protected void doSetVisible(boolean visible) {
        getStyle().setProperty(EnumStructuredStyleKeys.LITGROUPVISIBLE, visible);
        if (visible) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmEnumLitteralGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmEnumLitteralGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
