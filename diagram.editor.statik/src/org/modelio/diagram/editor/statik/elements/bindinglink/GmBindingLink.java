...
public class GmBindingLink extends GmLink {
    ...
    public GmBindingLink(GmAbstractDiagram diagram, Binding role, MRef ref) {
        super(diagram, ref);
        ...
        if (role != null) {
            ...
            addExtension(ExtensionLocation.TargetNW, new GmBindingLinkHeader(diagram, ref));
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBindingLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
