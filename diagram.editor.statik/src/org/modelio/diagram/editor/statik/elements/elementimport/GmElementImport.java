...
public final class GmElementImport extends GmLink {
    ...
    public GmElementImport(GmAbstractDiagram diagram, ElementImport role, MRef ref) {
        super(diagram, ref);
        ...
        if (role != null) {
            // Create extensions
            addExtension(ExtensionLocation.MiddleSE, new GmElementImportHeader(diagram, ref));
        }
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmElementImport." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
