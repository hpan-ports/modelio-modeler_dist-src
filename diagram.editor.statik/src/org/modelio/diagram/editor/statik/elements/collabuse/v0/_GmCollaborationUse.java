...
public final class _GmCollaborationUse extends GmCompositeNode implements IImageableNode {
    ...
    public _GmCollaborationUse(GmAbstractDiagram diagram, final CollaborationUse theCollabCase, MRef ref) {
        super(diagram, ref);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCollaborationUse." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
