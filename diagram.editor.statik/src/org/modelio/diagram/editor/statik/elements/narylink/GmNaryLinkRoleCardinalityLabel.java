...
public class GmNaryLinkRoleCardinalityLabel extends GmElementLabel {
    ...
    public GmNaryLinkRoleCardinalityLabel(GmAbstractDiagram diagram, NaryLinkEnd role, MRef roleRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNaryLinkRoleCardinalityLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNaryLinkRoleCardinalityLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
