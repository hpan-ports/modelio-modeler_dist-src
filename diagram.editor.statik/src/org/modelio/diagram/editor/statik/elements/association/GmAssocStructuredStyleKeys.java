...
public class GmAssocStructuredStyleKeys extends StaticAbstractStyleKeyProvider {
    @objid ("a58002f2-55c2-11e2-9337-002564c97630")
     static final StyleKey CONNECTIONROUTER = createStyleKey("ASSOC_CONNECTIONROUTER",
                                                            MetaKey.CONNECTIONROUTER);

    @objid ("a58002f4-55c2-11e2-9337-002564c97630")
     static final StyleKey FILLCOLOR = createStyleKey("ASSOC_FILLCOLOR", MetaKey.FILLCOLOR);

    @objid ("a58002f6-55c2-11e2-9337-002564c97630")
     static final StyleKey LINECOLOR = createStyleKey("ASSOC_LINECOLOR", MetaKey.LINECOLOR);

    @objid ("a58002f8-55c2-11e2-9337-002564c97630")
     static final StyleKey LINEWIDTH = createStyleKey("ASSOC_LINEWIDTH", MetaKey.LINEWIDTH);

    @objid ("a58002fa-55c2-11e2-9337-002564c97630")
     static final StyleKey LINERADIUS = createStyleKey("ASSOC_LINERADIUS", MetaKey.LINERADIUS);

    @objid ("a58002fc-55c2-11e2-9337-002564c97630")
     static final StyleKey DRAWLINEBRIDGES = createStyleKey("ASSOC_DRAWLINEBRIDGES", MetaKey.DRAWLINEBRIDGES);

    @objid ("a58002fe-55c2-11e2-9337-002564c97630")
     static final StyleKey FONT = createStyleKey("ASSOC_FONT", MetaKey.FONT);

    @objid ("a581898a-55c2-11e2-9337-002564c97630")
     static final StyleKey TEXTCOLOR = createStyleKey("ASSOC_TEXTCOLOR", MetaKey.TEXTCOLOR);

    @objid ("a581898c-55c2-11e2-9337-002564c97630")
     static final StyleKey SHOWSTEREOTYPES = createStyleKey("ASSOC_SHOWSTEREOTYPES", MetaKey.SHOWSTEREOTYPES);

    @objid ("a581898e-55c2-11e2-9337-002564c97630")
     static final StyleKey SHOWTAGS = createStyleKey("ASSOC_SHOWTAGS", MetaKey.SHOWTAGS);

    @objid ("a5818990-55c2-11e2-9337-002564c97630")
     static final StyleKey SHOWLABEL = createStyleKey("ASSOC_SHOWLABEL", MetaKey.SHOWLABEL);
    ...
    @objid ("a5818995-55c2-11e2-9337-002564c97630")
     static final StyleKey SHOWVISIBILITY = createStyleKey("ASSOC_SHOWVISIBILITY", MetaKey.SHOWVISIBILITY);
    ...
    @objid ("a581899d-55c2-11e2-9337-002564c97630")
     static final StyleKey LINEPATTERN = createStyleKey("ASSOC_LINEPATTERN", MetaKey.LINEPATTERN);

    @objid ("a581899f-55c2-11e2-9337-002564c97630")
     static final StyleKey SHOWFLOWS = createStyleKey("ASSOC_SHOWFLOWS", MetaKey.SHOWINFORMATIONFLOWS);
    ...
    public static class InfoFlows extends StaticAbstractStyleKeyProvider {
        ...
        @objid ("a58189a3-55c2-11e2-9337-002564c97630")
         static final StyleKey FLOWTEXTCOLOR = createStyleKey("ASSOC_FLOWS_TEXTCOLOR",
        ...
        @objid ("a58189a6-55c2-11e2-9337-002564c97630")
         static final StyleKey FLOWFONT = createStyleKey("ASSOC_FLOWS_FONT",
        ...
        @objid ("a58189a9-55c2-11e2-9337-002564c97630")
         static final StyleKey FLOWSHOWSTEREOTYPES = createStyleKey("ASSOC_FLOWS_SHOWSTEREOTYPES",
        ...
        @objid ("a58189ac-55c2-11e2-9337-002564c97630")
         static final StyleKey FLOWSHOWTAGS = createStyleKey("ASSOC_FLOWS_SHOWTAGS",
