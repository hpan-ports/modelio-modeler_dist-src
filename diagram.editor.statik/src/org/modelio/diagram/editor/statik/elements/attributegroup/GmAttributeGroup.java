...
public class GmAttributeGroup extends GmGroup {
    ...
    public GmAttributeGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        if (getParent().getRepresentationMode().equals(RepresentationMode.STRUCTURED)) {
            ...
            return getStyle().getProperty(styleKey);
        }
        return false;
    }
    ...
    protected void doSetVisible(boolean visible) {
        ...
        getStyle().setProperty(styleKey, visible);
    }
    ...
    protected boolean isValidElement(MObject el) {
        ...
        StyleKey.UmaskByVisibilityStragegy unmaskmode = getStyle().getProperty(styleKey);
        switch (unmaskmode) {
            case ALL:
                return true;
            case ALL_PUBLIC:
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmAttributeGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmAttributeGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
