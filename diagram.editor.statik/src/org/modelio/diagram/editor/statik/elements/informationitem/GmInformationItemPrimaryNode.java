...
public class GmInformationItemPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmInformationItemPrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmInformationItem.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInformationItemPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInformationItemPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
