...
public class GmTemplateSignature extends GmDefaultModelElementLabel {
    ...
    public GmTemplateSignature(final GmAbstractDiagram diagram, final NameSpace related, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmTemplateSignature." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmTemplateSignature." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
