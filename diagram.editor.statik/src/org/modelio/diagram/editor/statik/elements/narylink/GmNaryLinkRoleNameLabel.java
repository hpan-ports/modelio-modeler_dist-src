...
public class GmNaryLinkRoleNameLabel extends GmDefaultModelElementHeader {
    ...
    public GmNaryLinkRoleNameLabel(GmAbstractDiagram diagram, NaryLinkEnd role, MRef ref) {
        super(diagram, ref);
        this.role = role;
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNaryLinkRoleNameLabel." + MINOR_VERSION_PROPERTY);
    ...
    public boolean isVisible() {
        return getStyle().getProperty(getStyleKeyStrict(MetaKey.SHOWROLES));
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNaryLinkRoleNameLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.role = (NaryLinkEnd) resolveRef(this.getRepresentedRef());
    }
