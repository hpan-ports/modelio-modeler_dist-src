...
public class GmNAssocPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmNAssocPrimaryNode(final GmAbstractDiagram diagram, final NaryAssociation assoc, final MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmNAssocNode.KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNAssocPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNAssocPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
