...
public class GmConveyedInformationItemLabel extends GmConveyedClassifierLabel {
    ...
    public GmConveyedInformationItemLabel(GmAbstractDiagram diagram, InformationItem el, MRef ref) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmConveyedInformationItemLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConveyedInformationItemLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
