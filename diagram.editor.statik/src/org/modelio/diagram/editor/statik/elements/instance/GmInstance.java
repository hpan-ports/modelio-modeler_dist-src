...
public class GmInstance extends GmPortContainer {
    ...
    public GmInstance(GmAbstractDiagram diagram, Instance el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInstance." + MINOR_VERSION_PROPERTY);
    ...
    @objid ("3533ffc5-55b7-11e2-877f-002564c97630")
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInstance." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("3533ffe3-55b7-11e2-877f-002564c97630")
    @Override
