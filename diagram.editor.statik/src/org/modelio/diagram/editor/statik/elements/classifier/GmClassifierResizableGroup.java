...
public class GmClassifierResizableGroup extends GmResizableGroup {
    ...
    public GmClassifierResizableGroup(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void write(final IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmClassifierResizableGroup." + MINOR_VERSION_PROPERTY,
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmClassifierResizableGroup." + MINOR_VERSION_PROPERTY);
