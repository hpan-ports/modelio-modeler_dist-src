...
public class GmNConnectorEndLink extends GmNLinkEndLink {
    ...
    public GmNConnectorEndLink(GmAbstractDiagram diagram, NaryConnectorEnd role, MRef roleRef) {
    ...
    protected void readLink(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNConnectorEndLink." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNConnectorEndLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
