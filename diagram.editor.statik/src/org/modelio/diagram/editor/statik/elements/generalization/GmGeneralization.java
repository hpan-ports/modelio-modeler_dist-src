...
public class GmGeneralization extends GmLink {
    ...
    public GmGeneralization(GmAbstractDiagram diagram, MObject generalization, MRef ref) {
        super(diagram, ref);
        this.element = (Generalization) generalization;
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmGeneralization." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
