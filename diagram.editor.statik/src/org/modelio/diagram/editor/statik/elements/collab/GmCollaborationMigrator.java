...
public class GmCollaborationMigrator implements IPersistentMigrator {
    ...
    private IPersistent migrateFromV0(final IPersistent instanceToMigrate) {
        _GmCollaboration oldCollaboration = (_GmCollaboration) instanceToMigrate;
        ...
        GmCollaborationPrimaryNode newPrimaryNode = newCollaboration.getMainNode();
        ...
        newCollaboration.getStyle().setCascadedStyle(oldCollaboration.getStyle().getCascadedStyle());
        for (StyleKey key : oldCollaboration.getStyle().getLocalKeys()) {
            newCollaboration.getStyle().setProperty(key, oldCollaboration.getStyle().getProperty(key));
        }
