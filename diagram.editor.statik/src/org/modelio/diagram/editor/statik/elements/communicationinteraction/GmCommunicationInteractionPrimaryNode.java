...
public class GmCommunicationInteractionPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmCommunicationInteractionPrimaryNode(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationInteractionPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationInteractionPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
