...
public class GmPackage extends GmPortContainer {
    ...
    @objid ("3618e1b5-55b7-11e2-877f-002564c97630")
     static final String BODY_CONTENT_AS_SATELLITE = "body content as satellite";
    ...
    public GmPackage(GmAbstractDiagram diagram, Package thePackage, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPackage." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPackage." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("361beecf-55b7-11e2-877f-002564c97630")
    @Override
    public GmPackagePrimaryNode getMainNode() {
        return (GmPackagePrimaryNode) getFirstChild(GmPortContainer.MAIN_NODE_ROLE);
    }
    ...
    protected boolean isValidChild(final GmNodeModel node) {
        if (BODY_CONTENT_AS_SATELLITE.equals(node.getRoleInComposition())) {
            ...
            return childEl == null || (childEl.isValid() && getMainNode().getBody().canUnmask(childEl));
        }
        return true;
    }
