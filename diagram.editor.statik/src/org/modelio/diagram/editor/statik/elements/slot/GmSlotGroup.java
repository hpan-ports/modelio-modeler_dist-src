...
public class GmSlotGroup extends GmGroup {
    ...
    public GmSlotGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        if (getParent().getRepresentationMode().equals(RepresentationMode.STRUCTURED)) {
            return getStyle().getProperty(GmInstanceStructuredStyleKeys.SLOTGROUPVISIBLE);
        } else {
            return false;
        }
    }
    ...
    protected void doSetVisible(boolean visible) {
        ...
        getStyle().setProperty(GmInstanceStructuredStyleKeys.SLOTGROUPVISIBLE, visible);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmSlotGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmSlotGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
