...
public final class GmPackageImport extends GmLink {
    ...
    public GmPackageImport(GmAbstractDiagram diagram, PackageImport role, MRef ref) {
        super(diagram, ref);
        ...
        if (role != null) {
            // Create extensions
            addExtension(ExtensionLocation.MiddleSE, new GmPackageImportHeader(diagram, ref));
        }
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPackageImport." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
