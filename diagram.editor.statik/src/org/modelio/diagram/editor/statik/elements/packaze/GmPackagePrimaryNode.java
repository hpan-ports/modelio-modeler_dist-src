...
public class GmPackagePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmPackagePrimaryNode(GmAbstractDiagram diagram, MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmPackage.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPackagePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPackagePrimaryNode." + MINOR_VERSION_PROPERTY,
