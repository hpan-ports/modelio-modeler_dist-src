...
public class GmNConnectorPrimaryNode extends GmNLinkPrimaryNode {
    ...
    public GmNConnectorPrimaryNode(final GmAbstractDiagram diagram, final NaryConnector assoc, final MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmNConnectorNode.KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNConnectorPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNConnectorPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
