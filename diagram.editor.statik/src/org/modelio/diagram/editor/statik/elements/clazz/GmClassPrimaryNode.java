...
public class GmClassPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmClassPrimaryNode(GmAbstractDiagram diagram, final Classifier el, final MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmClass.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmClassPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmClassPrimaryNode." + MINOR_VERSION_PROPERTY,
