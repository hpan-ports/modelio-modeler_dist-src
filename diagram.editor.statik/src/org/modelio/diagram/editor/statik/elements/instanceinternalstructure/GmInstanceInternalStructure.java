...
public final class GmInstanceInternalStructure extends GmNoStyleCompositeNode implements PropertyChangeListener {
    ...
    public GmInstanceInternalStructure(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public GmInstanceInternalStructure(final GmAbstractDiagram diagram, final MRef relatedRef, final GmFreeZone zone, final GmGroup group) {
        super(diagram, relatedRef);
    ...
    public GmCompositeNode getCompositeFor(final Class<? extends MObject> metaclass) {
        ...
        if (getStyle().getProperty(styleKey) == InternalsViewMode.DIAGRAM) {
