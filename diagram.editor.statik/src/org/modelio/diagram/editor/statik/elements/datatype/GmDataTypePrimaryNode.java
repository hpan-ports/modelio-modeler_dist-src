...
public class GmDataTypePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmDataTypePrimaryNode(GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmDataType.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDataTypePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDataTypePrimaryNode." + MINOR_VERSION_PROPERTY,
