...
public class GmInternalStructureGroup extends GmGroup {
    ...
    public GmInternalStructureGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void refreshFromObModel() {
        ...
        final Boolean mode = this.getStyle().getProperty(styleKey);
        if (mode) {
    ...
    protected void updateHiddenFeatures() {
        ...
        if (relatedIElement instanceof Classifier) {
            final Classifier classifier = (Classifier) relatedIElement;
            final Boolean mode = this.getStyle()
                                     .getProperty(getStyleKeyStrict(MetaKey.InternalGroup.INTAUTOUNMASK));
        ...
        } else if (relatedIElement instanceof NameSpace) {
            final NameSpace namespace = (NameSpace) relatedIElement;
            final Boolean mode = this.getStyle()
                                     .getProperty(getStyleKeyStrict(MetaKey.InternalGroup.INTAUTOUNMASK));
            boolean hasHiddenFeature = false;
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInternalStructureGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInternalStructureGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
