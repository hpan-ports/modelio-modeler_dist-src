...
public final class GmInternalStructureZone extends GmFreeZone {
    ...
    public GmInternalStructureZone(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInternalStructureZone." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInternalStructureZone." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
