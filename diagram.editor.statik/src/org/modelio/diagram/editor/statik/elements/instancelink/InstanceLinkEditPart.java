...
public class InstanceLinkEditPart extends GmLinkEditPart {
    ...
    protected void refreshFromStyle(IFigure aFigure, IStyle style) {
        ...
        boolean showArrows = gmModel.getStyle().getProperty(InstanceLinkStructuredStyleKeys.SHOWNAVIGABILITY);
