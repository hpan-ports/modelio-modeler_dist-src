...
public class _GmPackage extends GmCompositeNode implements IImageableNode {
    ...
    public _GmPackage(GmAbstractDiagram diagram, Package thePackage, MRef ref) {
        super(diagram, ref);
    ...
    public boolean canUnmask(MObject el) {
        ...
        if (el instanceof NameSpace) {
            ...
            StyleKey.UmaskByVisibilityStragegy unmaskmode = getStyle().getProperty(GmPackageStructuredStyleKeys.UNMASKINGSTRATEGY);
            switch (unmaskmode) {
            case ALL:
                return true;
            case ALL_PUBLIC:
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
