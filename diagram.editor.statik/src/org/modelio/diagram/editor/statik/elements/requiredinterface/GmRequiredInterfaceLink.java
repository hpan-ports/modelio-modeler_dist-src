...
public class GmRequiredInterfaceLink extends GmLink {
    ...
    public GmRequiredInterfaceLink(GmAbstractDiagram diagram, final RequiredInterface el, MRef relatedRef) {
        super(diagram, relatedRef);
        this.element = el;
        
        addExtension(new GmRequiredInterfaceLabel(diagram, el, relatedRef),
                     new GmFractionalConnectionLocator(0.9, 0, -25));
    }
    ...
    public Collection<ConnectorEnd> getConnections() {
        ...
        for (LinkEnd l : this.getRelatedElement().getProvider(ConnectorEnd.class)) {
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmRequiredInterfaceLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
