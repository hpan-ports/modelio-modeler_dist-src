...
public class GmOperation extends GmModelElementFlatHeader {
    ...
    public GmOperation(GmAbstractDiagram diagram, Operation op, MRef ref) {
        super(diagram, ref);
        this.element = op;
        init();
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmOperation." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmOperation." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
