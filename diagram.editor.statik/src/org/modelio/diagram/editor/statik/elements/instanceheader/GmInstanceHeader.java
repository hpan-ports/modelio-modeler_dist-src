...
import org.modelio.diagram.editor.statik.elements.instance.InstanceSymbolProvider;
...
public class GmInstanceHeader extends GmDefaultModelElementHeader {
    ...
    public GmInstanceHeader(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInstanceHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInstanceHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
