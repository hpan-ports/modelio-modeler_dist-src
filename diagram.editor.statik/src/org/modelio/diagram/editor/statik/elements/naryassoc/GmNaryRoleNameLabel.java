...
public class GmNaryRoleNameLabel extends GmDefaultModelElementLabel {
    ...
    public GmNaryRoleNameLabel(GmAbstractDiagram diagram, NaryAssociationEnd role, MRef ref) {
        super(diagram, ref);
        this.role = role;
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNaryRoleNameLabel." + MINOR_VERSION_PROPERTY);
    ...
    private boolean isRoleVisible() {
        return this.getStyle().getProperty(NAssocStructuredStyleKeys.SHOWROLES);
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNaryRoleNameLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
