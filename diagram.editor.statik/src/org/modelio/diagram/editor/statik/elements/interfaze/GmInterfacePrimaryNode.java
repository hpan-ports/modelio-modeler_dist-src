...
public class GmInterfacePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmInterfacePrimaryNode(GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmInterface.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInterfacePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInterfacePrimaryNode." + MINOR_VERSION_PROPERTY,
