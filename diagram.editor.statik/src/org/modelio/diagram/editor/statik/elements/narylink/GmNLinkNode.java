...
public class GmNLinkNode extends GmPortContainer {
    ...
    public GmNLinkNode(GmAbstractDiagram diagram, NaryLink el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNLinkNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNLinkNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("35e9943d-55b7-11e2-877f-002564c97630")
    @Override
