...
public class GmNConnectorNode extends GmPortContainer {
    ...
    public GmNConnectorNode(GmAbstractDiagram diagram, NaryConnector el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNConnectorNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNConnectorNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("35d8cb79-55b7-11e2-877f-002564c97630")
    @Override
