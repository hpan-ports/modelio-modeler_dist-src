...
import org.modelio.diagram.editor.statik.elements.packaze.ContentAsSatelliteDragTrackerProvider;
...
public class TemplateContainerEditPart extends PortContainerEditPart {
    ...
    protected void addChildVisual(final EditPart childEditPart, final int index) {
        ...
        if ("body content as satellite".equals(childModel.getRoleInComposition())) {
            ((GmNodeEditPart) childEditPart).setDragTrackerProvider(new ContentAsSatelliteDragTrackerProvider(childEditPart));
        }
    }
