...
public abstract class GmTemplateContainer extends GmPortContainer {
     ...
     * @Deprecated use {@link GmTemplateContainer#GmTemplateContainer(GmAbstractDiagram, MRef)} instead. The main node
     * should be accessed in {@link GmPortContainer#getMainNode()}.
     */
    @objid ("36e0c59f-55b7-11e2-877f-002564c97630")
    public GmTemplateContainer(final GmAbstractDiagram diagram, final GmNodeModel mainNode, final MRef relatedRef) {
    ...
    public void write(final IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmTemplateContainer." + MINOR_VERSION_PROPERTY,
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmTemplateContainer." + MINOR_VERSION_PROPERTY);
     ...
     * should be accessed in {@link GmPortContainer#getMainNode()}.
     */
    @objid ("36e24c2d-55b7-11e2-877f-002564c97630")
    public GmTemplateContainer(final GmAbstractDiagram diagram, final MRef relatedRef) {
        super(diagram, relatedRef);
    }
