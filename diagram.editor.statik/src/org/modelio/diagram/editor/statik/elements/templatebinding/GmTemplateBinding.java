...
public final class GmTemplateBinding extends GmLink {
    ...
    public GmTemplateBinding(GmAbstractDiagram diagram, TemplateBinding role, MRef ref) {
        super(diagram, ref);
        ...
        if (role != null) {
            // Create extensions
            addExtension(ExtensionLocation.MiddleSE, new GmTemplateBindingHeader(diagram, ref));
        }
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmTemplateBinding." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
