...
public class NLinkNodeEditPart extends GmNodeEditPart {
    ...
    protected IFigure createFigure() {
        final ShapedBorderedFigure fig = new ShapedBorderedFigure(DIAMOND_SHAPE);
    ...
    private List<NaryLinkEnd> getMissingBranches(final GmNodeModel gmModel) {
        ...
        if (element == null || !element.isValid()) {
            ...
            List<NaryLinkEnd> newbranches = new ArrayList<NaryLinkEnd>(element.getNaryLinkEnd());
