...
public class GmLinkRoleNameLabel extends GmDefaultModelElementHeader {
    ...
    public GmLinkRoleNameLabel(GmAbstractDiagram diagram, LinkEnd role, MRef ref) {
        super(diagram, ref);
        this.role = role;
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmLinkRoleNameLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmLinkRoleNameLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
