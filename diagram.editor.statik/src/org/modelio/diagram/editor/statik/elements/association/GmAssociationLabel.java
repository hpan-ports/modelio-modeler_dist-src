...
public class GmAssociationLabel extends GmDefaultModelElementLabel {
    ...
    public GmAssociationLabel(GmAbstractDiagram diagram, MRef assocRef) {
        super(diagram, assocRef);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmAssociationLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmAssociationLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.assoc = (Association) resolveRef(this.getRepresentedRef());
    }
