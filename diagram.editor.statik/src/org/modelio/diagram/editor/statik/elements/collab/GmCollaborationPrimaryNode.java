...
public class GmCollaborationPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmCollaborationPrimaryNode(GmAbstractDiagram diagram, MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmCollaboration.SIMPLEKEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCollaborationPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCollaborationPrimaryNode." + MINOR_VERSION_PROPERTY,
