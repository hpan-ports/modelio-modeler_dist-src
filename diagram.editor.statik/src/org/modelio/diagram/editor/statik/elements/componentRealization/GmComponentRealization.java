...
public class GmComponentRealization extends GmLink {
    ...
    public GmComponentRealization(GmAbstractDiagram diagram, ComponentRealization dependency, MRef ref) {
        super(diagram, ref);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmComponentRealization." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
