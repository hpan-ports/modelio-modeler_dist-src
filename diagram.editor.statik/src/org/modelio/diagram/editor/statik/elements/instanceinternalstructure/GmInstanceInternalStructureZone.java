...
public final class GmInstanceInternalStructureZone extends GmFreeZone {
    ...
    public GmInstanceInternalStructureZone(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    protected void doSetVisible(boolean visible) {
        if (visible) {
            getStyle().setProperty(GmInstanceStructuredStyleKeys.INTERNALSVIEWMODE, InternalsViewMode.DIAGRAM);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInstanceInternalStructureZone." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInstanceInternalStructureZone." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
