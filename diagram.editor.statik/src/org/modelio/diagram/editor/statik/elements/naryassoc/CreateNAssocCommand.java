    ...
    public void execute() {
        ...
        if (newAssoc == null) {
            ...
            for (IGmLinkable sourceModel : this.sourceModels) {
                ...
                elementConfigurer.configure(modelManager.getModelFactory(role), role, this.context.getProperties());
            }
            ...
            elementConfigurer.configure(modelManager.getModelFactory(newAssoc), newAssoc, this.context.getProperties());
        }
