...
public class GmClassAssociationLink extends GmLink {
    ...
    public GmClassAssociationLink(GmAbstractDiagram diagram, ClassAssociation generalization, MRef ref) {
        super(diagram, ref);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmClassAssociationLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
