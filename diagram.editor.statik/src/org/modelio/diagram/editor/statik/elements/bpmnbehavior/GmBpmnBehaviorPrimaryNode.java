...
public class GmBpmnBehaviorPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmBpmnBehaviorPrimaryNode(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnBehaviorPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnBehaviorPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
