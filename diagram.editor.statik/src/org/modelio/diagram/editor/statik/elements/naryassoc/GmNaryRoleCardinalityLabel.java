...
public class GmNaryRoleCardinalityLabel extends GmElementLabel {
    ...
    public GmNaryRoleCardinalityLabel(GmAbstractDiagram diagram, NaryAssociationEnd role, MRef roleRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNaryRoleCardinalityLabel." + MINOR_VERSION_PROPERTY);
    ...
    public boolean isVisible() {
        return this.getStyle().getProperty(NAssocStructuredStyleKeys.SHOWCARD);
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNaryRoleCardinalityLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
