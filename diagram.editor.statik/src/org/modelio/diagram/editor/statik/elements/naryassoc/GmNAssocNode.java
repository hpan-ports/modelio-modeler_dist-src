...
public class GmNAssocNode extends GmPortContainer {
    ...
    public GmNAssocNode(GmAbstractDiagram diagram, NaryAssociation el, MRef ref) {
        super(diagram,ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNAssocNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNAssocNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("35c67bc8-55b7-11e2-877f-002564c97630")
    @Override
