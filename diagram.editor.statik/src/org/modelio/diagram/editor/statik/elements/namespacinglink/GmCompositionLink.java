...
public class GmCompositionLink extends GmLink {
    ...
    public GmCompositionLink(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    private void refreshStyle(final IStyleProvider provider) {
        // Modify the style
        getStyle().setCascadedStyle(provider.getStyle());
    }
    ...
    public void write(final IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCompositionLink." + MINOR_VERSION_PROPERTY,
