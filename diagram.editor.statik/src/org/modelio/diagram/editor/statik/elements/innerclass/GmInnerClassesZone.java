...
public final class GmInnerClassesZone extends GmFreeZone {
    ...
    public GmInnerClassesZone(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    protected void doSetVisible(boolean visible) {
        if (visible) {
            getStyle().setProperty(getViewModeStyleKey(), InternalsViewMode.DIAGRAM);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInnerClassesZone." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInnerClassesZone." + MINOR_VERSION_PROPERTY,
