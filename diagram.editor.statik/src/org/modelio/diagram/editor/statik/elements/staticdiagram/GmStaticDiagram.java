...
public class GmStaticDiagram extends GmAbstractDiagram {
     ...
     */
    @objid ("36b2fea6-55b7-11e2-877f-002564c97630")
    public GmStaticDiagram() {
        super();
    }
    ...
    public GmStaticDiagram(ModelManager modelManager, MObject el, MRef ref) {
        super(modelManager, ref);
        this.obDiagram = (StaticDiagram) el;
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmStaticDiagram." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmStaticDiagram." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        ...
        this.obDiagram = (StaticDiagram) resolveRef(this.getRepresentedRef());
    }
