...
public class GmCollaborationUseHeader extends GmDefaultModelElementHeader {
    ...
    public GmCollaborationUseHeader(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    protected String computeMainLabel() {
        final CollaborationUse c = this.getRelatedElement();
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCollaborationUseHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCollaborationUseHeader." + MINOR_VERSION_PROPERTY,
