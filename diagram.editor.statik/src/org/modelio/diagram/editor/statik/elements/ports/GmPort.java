...
public class GmPort extends GmPortContainer {
    ...
    public GmPort(GmAbstractDiagram diagram, Port el, MRef ref) {
        super(diagram,  ref);
        this.element = el;
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPort." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPort." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("36421478-55b7-11e2-877f-002564c97630")
    @Override
    public GmPortPrimaryNode getMainNode() {
        return (GmPortPrimaryNode) getFirstChild(MAIN_NODE_ROLE);
    }
