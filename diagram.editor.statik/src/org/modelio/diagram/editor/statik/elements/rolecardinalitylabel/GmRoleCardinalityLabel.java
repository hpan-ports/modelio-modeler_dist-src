...
package org.modelio.diagram.editor.statik.elements.rolecardinalitylabel;
...
public class GmRoleCardinalityLabel extends GmElementLabel {
    ...
    public GmRoleCardinalityLabel(GmAbstractDiagram diagram, AssociationEnd role, MRef roleRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmRoleCardinalityLabel." + MINOR_VERSION_PROPERTY);
    ...
    public boolean isVisible() {
        return this.getStyle().getProperty(GmAssocStructuredStyleKeys.SHOWCARD);
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmRoleCardinalityLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
