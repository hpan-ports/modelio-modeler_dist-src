...
public class GmActivityPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmActivityPrimaryNode(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmActivityPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmActivityPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
