...
public final class GmRaisedException extends GmLink {
    ...
    public GmRaisedException(GmAbstractDiagram diagram, RaisedException role, MRef ref) {
        super(diagram, ref);
        ...
        if (role != null) {
            // Create extensions
            addExtension(ExtensionLocation.MiddleSE, new GmRaisedExceptionHeader(diagram, ref));
        }
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmRaisedException." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
