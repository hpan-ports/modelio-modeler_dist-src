...
public final class GmPackageMerge extends GmLink {
    ...
    public GmPackageMerge(GmAbstractDiagram diagram, PackageMerge role, MRef ref) {
        super(diagram, ref);
        ...
        if (role != null) {
            // Create extensions
            addExtension(ExtensionLocation.MiddleSE, new GmPackageMergeHeader(diagram, ref));
        }
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPackageMerge." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
