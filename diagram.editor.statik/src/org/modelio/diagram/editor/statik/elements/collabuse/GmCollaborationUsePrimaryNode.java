...
public class GmCollaborationUsePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmCollaborationUsePrimaryNode(GmAbstractDiagram diagram, MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmCollaborationUse.SIMPLEKEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCollaborationUsePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCollaborationUsePrimaryNode." + MINOR_VERSION_PROPERTY,
