...
public class GmProvidedInterfaceLink extends GmLink {
    ...
    public GmProvidedInterfaceLink(GmAbstractDiagram diagram, final ProvidedInterface el, MRef relatedRef) {
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmProvidedInterfaceLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
