...
public class GmConveyedClassifiersGroup extends GmGroup {
    ...
    public GmConveyedClassifiersGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        return (Boolean) getStyle().getProperty(getViewModeStyleKey());
    }
    ...
    protected void doSetVisible(boolean visible) {
        getStyle().setProperty(getViewModeStyleKey(), visible);
    }
    ...
    protected boolean isValidElement(MObject el) {
        ...
        return this.getRelatedElement().getConveyed().contains(el);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmConveyedClassifiersGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConveyedClassifiersGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
