...
public class ModelioPreferenceDialog extends PreferenceDialog {
    ...
    public static final String PREFS_PAGE_XP = "org.modelio.app.preferences.preferencePages";
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        // Add a watch dog that will abort the transaction if still alive.
    ...
    protected void setTitleLeftImage(Image newTitleImage) {
        ...
        if (this._titleLeftImageLabel != null && !this._titleLeftImageLabel.isDisposed()) {
            ...
            /*
             * if (newTitleImage != null) resetWorkAreaAttachments(_titleArea);
             */
        }
    }
    ...
    private void createTitle(Composite parent) {
        // image from plugin
        ImageDescriptor imageDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin("org.modelio.app.preferences", "icons/headerleft.png");
            ...
            if (elmt.getAttribute(ATTR_CLASS) != null) {
                ...
                try {
                    ...
                    if (!(object instanceof IPreferencePage)) {
                        AppPreferences.LOG.error("Expected instance of IPreferencePage: %s", elmt.getAttribute(ATTR_CLASS));
                        continue;
                    }
