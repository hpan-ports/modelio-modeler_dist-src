...
public class ModelImportDataModel implements AutoCloseable {
    @objid ("84d7c8d8-1cc2-4ef9-82fb-8980ced56f12")
    private boolean reidentify = false;

    @objid ("8a016301-daf7-4c15-8e2f-60a239452b0f")
    private List<SmObjectImpl> elementsToImport = new ArrayList<>();
    ...
    public List<SmObjectImpl> getElementsToImport() {
    ...
    /**
     * Whether or not the imported elements must be re-identified.
     * @return <code>true</code> for an 'import by copy', <code>false</code> for a 'standard import'.
     */
    @objid ("b932b078-0423-4b03-a2da-ce23303f91f3")
    public boolean isReidentify() {
        return this.reidentify;
    }

    /**
     * Set the state of re-identification.
     * @param reidentify Whether or not the imported elements must be re-identified.
     */
    @objid ("7259950c-ff27-4960-8798-42e07852e5e8")
