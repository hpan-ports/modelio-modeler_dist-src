...
/**
 * This interface is to be implemented if a {@link IPersistent} goes through a change important enough to require a
 * major version change (for example: its inheritance tree is modified). In such a case, a class implementing this
 * interface is to be provided <strong>in the same package as the IPersistent and the name of the implementing class
 * must be <em>NameOfTheIPersistent</em>Migrator, with <em>NameOfTheIPersistent</em> being the name of the
 * IPersistent</strong>.
 */
