...
public interface IDiagramReader {
    ...
    Map<String, Object> readAllProperties();
    ...
    void readDiagram(String data, IPersistent into);
    ...
    <K,V> Map<K, V> readMapProperty(String mapName);
    ...
    Object readProperty(String attName);
    ...
    <T> List<T> readListProperty(String listName);
