...
public class OperationSignaturePanel implements IPanelProvider {
    ...
    public void setInput(Object input) {
        if (input instanceof OperationModel) {
            ...
            if (this.opModel.isAbstract()) {
                Font italicFont = CoreFontRegistry.getModifiedFont(this.container.getFont(), SWT.ITALIC);
    ...
    static class OpSignatureBuilder {
        @objid ("db3601d9-040a-4db3-95c4-1002e6665369")
        public String getSignature(OperationModel opModel) {
            ...
            if (returnParameter != null) {
                s.append(" : ");
                s.append(opModel.getReturnParameterType().getName());
            }
            return s.toString();
        }

        @objid ("f73af903-8374-49f9-86b9-aaf6aeb0bfc3")
        private String getVisibility(OperationModel opModel) {
    ...
    static class IOParamSignatureBuilder {
