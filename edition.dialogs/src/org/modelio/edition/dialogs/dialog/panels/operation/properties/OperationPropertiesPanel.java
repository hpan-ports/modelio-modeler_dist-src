...
public class OperationPropertiesPanel implements IPanelProvider {
    ...
    private Composite createRedefinesField(Composite parent) {
        ...
        this.redefinitionTextElement = new TextElement(field, SWT.BORDER);
        gd = new GridData(SWT.FILL, SWT.CENTER, true, false);
        this.redefinitionTextElement.getTextControl().setLayoutData(gd);
        
        this.redefinitionTextElement.setAcceptNullValue(true);
        // redefinesViewer.activatePicking(this.pickingService);
        // redefinesViewer.activateCompletion(this.projectService.getSession());
        // redefinesViewer.setFilter(this.elementFilter);
        // redefinesViewer.activateDragAndDrop(this.projectService.getSession());
        return field;
    }
