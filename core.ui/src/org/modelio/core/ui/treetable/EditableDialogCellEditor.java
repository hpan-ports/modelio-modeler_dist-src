...
package org.modelio.core.ui.treetable;
...
/* (non-Javadoc)
    ...
    protected Control createControl(Composite parent) {
        ...
        this.editor.addFocusListener(getButtonFocusListener());
        ...
        this.button.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                EditableDialogCellEditor.this.editor.removeFocusListener(getButtonFocusListener());
        
                Object newValue = openDialogBox(EditableDialogCellEditor.this.editor);
        
                // Re-add the listener once the dialog closes
                EditableDialogCellEditor.this.editor.addFocusListener(getButtonFocusListener());
...
/* (non-Javadoc)
    ...
    public void deactivate() {
        if (this.button != null && !this.button.isDisposed()) {
            this.editor.removeFocusListener(getButtonFocusListener());
        }
...
static {
        ...
        reg.put(CELL_EDITOR_IMG_DOTS_BUTTON, ImageDescriptor.createFromFile(
                EditableDialogCellEditor.class, "images/dots_button.gif"));//$NON-NLS-1$
    }
    /**
    ...
    private class DialogCellLayout extends Layout {
        ...
        public Point computeSize(Composite anEditor, int wHint, int hHint, boolean force) {
            ...
            Point contentsSize = EditableDialogCellEditor.this.contents.computeSize(SWT.DEFAULT, SWT.DEFAULT,
                    force);
            Point buttonSize = EditableDialogCellEditor.this.button.computeSize(SWT.DEFAULT, SWT.DEFAULT,
                    force);
