    ...
    public Control createContentArea(Composite parent) {
        ...
        this.textfield.addSelectionListener(new SelectionListener() {
            ...
            public void widgetDefaultSelected(SelectionEvent event) {
                EditionDialog.this.searcher.setExpression(EditionDialog.this.textfield.getText());
                EditionDialog.this.searchResultTree.setInput(EditionDialog.this.searcher.search());
            }
        ...
        upButton.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (element != null) {
                    ...
                    EditionDialog.this.searchResultTree.remove(element);
                    EditionDialog.this.searchResultTree.add(element);
                }
            }
        });
        ...
        class PickingHandler implements ShellListener, DisposeListener {
            ...
            public void shellClosed(ShellEvent e) {
                ...
                if (EditionDialog.this.dialogActive) {
                    getShell().removeShellListener(this);
                    getShell().removeDisposeListener(this);
                    close();
                    EditionDialog.this.editor.closeEditor(true);
                    abort();
                    EditionDialog.this.dialogActive = false;
                }
            }
