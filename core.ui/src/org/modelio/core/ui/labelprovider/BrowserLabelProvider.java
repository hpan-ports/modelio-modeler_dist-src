...
package org.modelio.core.ui.labelprovider;
...
public class BrowserLabelProvider extends LabelProvider implements IModelioElementLabelProvider {
    ...
    public static final Font italicFont = CoreFontRegistry.getModifiedFont(normalFont, SWT.ITALIC);
    ...
    public StyledString getStyledText(Object obj) {
        if (obj == null) {
            ...
            return new StyledString(nbLinks <= 1 ? CoreUi.I18N.getMessage("LinkContainer.Single", nbLinks)
                    : CoreUi.I18N.getMessage("LinkContainer.Multi", nbLinks));
        
        } else if (obj instanceof ArchiveContainer) {
            final int nbVersions = ((ArchiveContainer) obj).getNbVersions();
            return new StyledString(nbVersions <= 1 ? CoreUi.I18N.getMessage("ArchiveContainer.Single", nbVersions)
                    : CoreUi.I18N.getMessage("ArchiveContainer.Multi", nbVersions));
        }
    ...
    /**
     * Returns the simple label of an object, without style additions. Uses {@link BrowserLabelProvider#getStyledText(Object)}.
     */
    ...
    protected static Image loadImage(String imageFileName) {
    ...
    private static class BrowserLabelService extends DefaultModelVisitor {
        ...
        public Object visitActivityEdge(ActivityEdge theActivityEdge) {
            ...
            if (target != null) {
                ...
                symbol.append(labelService.getLabel(target, this.showVisibility).toString(),
                        ElementStyler.getStyler(theActivityEdge, target));
            } else {
        ...
        public Object visitAssociationEnd(AssociationEnd theAssociationEnd) {
            ...
            if (associationEndName.isEmpty()) {
                symbol.append(CoreUi.I18N.getString("NoName"), styler);
            } else {
        ...
        public Object visitBinding(Binding theBinding) {
            ...
            final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
            if (role != null) {
                symbol.append(labelService.getLabel(role, this.showVisibility).toString(),
                        ElementStyler.getStyler(theBinding, role));
            }
            symbol.append(" --> ", styler);
            if (feature != null) {
                symbol.append(labelService.getLabel(feature, this.showVisibility).toString(),
                        ElementStyler.getStyler(theBinding, feature));
            }
        ...
        public Object visitCollaborationUse(CollaborationUse theCollaborationUse) {
            ...
            if (base != null) {
                ...
                symbol.append(CoreUi.I18N.getString("NoBase"), styler);
            }
        ...
        public Object visitCommunicationMessage(CommunicationMessage theCommunicationMessage) {
            ...
            if (name.equals("")) {
                symbol.append(CoreUi.I18N.getString(messageSort.name()), styler);
            } else {
        ...
        public Object visitCommunicationNode(CommunicationNode theCommunicationNode) {
            ...
            if (instance != null) {
                final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                symbol.append(labelService.getLabel(instance, this.showVisibility).toString(),
                        ElementStyler.getStyler(theCommunicationNode, instance));
            } else {
        ...
        public Object visitGeneralization(Generalization theGeneralization) {
            ...
            if (parent != null) {
                symbol.append(labelService.getLabel(parent, this.showVisibility).toString(),
                        ElementStyler.getStyler(theGeneralization, parent));
        ...
        public Object visitInstanceNode(InstanceNode theInstanceNode) {
            ...
            if (type != null) {
                ...
                final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                symbol.append(labelService.getLabel(instance, this.showVisibility).toString(),
                        ElementStyler.getStyler(theInstanceNode, instance));
            } else if (attribut != null) {
                final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                symbol.append(labelService.getLabel(attribut, this.showVisibility).toString(),
                        ElementStyler.getStyler(theInstanceNode, attribut));
            } else if (assocEnd != null) {
                final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                symbol.append(labelService.getLabel(assocEnd, this.showVisibility).toString(),
                        ElementStyler.getStyler(theInstanceNode, assocEnd));
            } else if (behaviorParameter != null) {
                final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                symbol.append(labelService.getLabel(behaviorParameter, this.showVisibility).toString(),
                        ElementStyler.getStyler(theInstanceNode, behaviorParameter));
            } else {
                symbol.append(theInstanceNode.getName(), styler);
            }
        ...
        public Object visitInterfaceRealization(InterfaceRealization theInterfaceRealization) {
            ...
            if (implemented != null) {
                symbol.append(labelService.getLabel(implemented, this.showVisibility).toString(),
                        ElementStyler.getStyler(theInterfaceRealization, implemented));
        ...
        public Object visitObjectNode(ObjectNode theObjectNode) {
            ...
            if (parameter != null) {
                symbol.append(labelService.getLabel(parameter, this.showVisibility).toString(),
                        ElementStyler.getStyler(theObjectNode, parameter));
            } else if (instance != null) {
                symbol.append(labelService.getLabel(instance, this.showVisibility).toString(),
                        ElementStyler.getStyler(theObjectNode, instance));
            } else if (attribute != null) {
                symbol.append(labelService.getLabel(attribute, this.showVisibility).toString(),
                        ElementStyler.getStyler(theObjectNode, attribute));
            } else if (role != null) {
                symbol.append(labelService.getLabel(role, this.showVisibility).toString(),
                        ElementStyler.getStyler(theObjectNode, role));
            } else {
            ...
            if (symbol.length() == 0) {
                ...
                if (requiredInterfaces.size() > 0) {
                    ...
                    for (int i = 0; i < requiredInterfaces.size(); i++) {
                        ...
                        final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                        symbol.append(labelService.getLabel(ri, this.showVisibility).toString(),
                                ElementStyler.getStyler(thePort, ri));
                    }
                }
                ...
                if (providedInterfaces.size() > 0) {
                    ...
                    for (int i = 0; i < providedInterfaces.size(); i++) {
                        ...
                        final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                        symbol.append(labelService.getLabel(pi, this.showVisibility).toString(),
                                ElementStyler.getStyler(thePort, pi));
                    }
                }
            }
        ...
        public Object visitProvidedInterface(ProvidedInterface theProvidedInterface) {
            ...
            if (providedElements.size() > 0) {
                for (int i = 0; i < providedElements.size(); i++) {
                    ...
                    final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                    symbol.append(labelService.getLabel(pe, this.showVisibility).toString(),
                            ElementStyler.getStyler(theProvidedInterface, pe));
                }
            } else {
        ...
        public Object visitRaisedException(RaisedException theRaisedException) {
            ...
            if (thrownType != null) {
                symbol.append(labelService.getLabel(thrownType, this.showVisibility).toString(),
                        ElementStyler.getStyler(theRaisedException, thrownType));
        ...
        public Object visitRequiredInterface(RequiredInterface theRequiredInterface) {
            ...
            if (requiredElements.size() > 0) {
                for (int i = 0; i < requiredElements.size(); i++) {
                    ...
                    final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                    symbol.append(labelService.getLabel(re, this.showVisibility).toString(),
                            ElementStyler.getStyler(theRequiredInterface, re));
                }
            } else {
                symbol.append("none", styler);
            }
        ...
        public Object visitTemplateBinding(TemplateBinding theTemplateBinding) {
            ...
            for (int i = 0; i < substitutions.size(); i++) {
                ...
                final BrowserLabelService labelService = new BrowserLabelService(this.elementStack);
                symbol.append(labelService.getLabel(ts, this.showVisibility).toString(),
                        ElementStyler.getStyler(theTemplateBinding, ts));
            }
        ...
        public Object visitTemplateParameterSubstitution(TemplateParameterSubstitution theTemplateParameterSubstitution) {
            ...
            if (templateParameter != null) {
                symbol.append(labelService.getLabel(templateParameter, this.showVisibility).toString(),
                        ElementStyler.getStyler(theTemplateParameterSubstitution, templateParameter));
            }
        ...
        private static StringBuilder getDependencyVerb(ModelElement dep, String defaultVerb) {
            ...
            if (!dep.getExtension().isEmpty()) {
                ...
                /*
                 * if (dep instanceof Usage) stringBuilder.append("uses"); else if (dep instanceof ElementRealization)
                 * stringBuilder.append("realizes"); else if (dep instanceof Abstraction) stringBuilder.append("abstracts"); else
        ...
        private Object visitDependencyLikeObject(ModelElement theDependency, String mmverb, ModelElement destination) {
            ...
            if (destination != null) {
                ...
                final StyledString destLabel = new BrowserLabelService(this.elementStack).getLabel(destination, false);
        ...
        public Object visitBpmnLane(BpmnLane obj) {
            ...
            final ModelElement represented = obj.getPartitionElement();
