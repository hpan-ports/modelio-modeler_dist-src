...
/*
    ...
    public void activateCompletion(ICoreSession session) {
        if (session != null) {
            this.completionDriver = new HybridCompletionDriver(this, (CoreSession) session, this.tooltip);
        } else {
    ...
    private void setSelectedElement(Object value) {
        this.selected = value;
    ...
    class HybridCompletionDriver {
        ...
        @objid ("8a27dd34-f3b7-42a8-91d7-ee13013be640")
        private Text text;
        ...
        @objid ("8db4a873-5e3a-4536-bdd3-89db5afd2a00")
        private DefaultToolTip tooltip;

        @objid ("02a1e894-6ef7-4ba1-8b1e-2ca69530aa37")
        public HybridCompletionDriver(final HybridTextElement textElement, CoreSession session, DefaultToolTip tooltip) {
            ...
            if (elements.isEmpty()) {
                ...
                if (elements.isEmpty()) {
                    if (isAcceptStringValue()) {
                        this.textElement.setSelectedElement(this.text.getText());
                    } else {
                        this.textElement.validate(false);
                    }
