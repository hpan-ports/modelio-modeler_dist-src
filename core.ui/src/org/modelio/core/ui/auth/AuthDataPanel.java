...
package org.modelio.core.ui.auth;
...
import org.modelio.core.ui.auth.ui.IAuthDataUi;
...
public class AuthDataPanel implements IPanelProvider {
    ...
    public AuthDataPanel createPanel(Composite parent) {
        ...
        this.schemeSelector.setLabelProvider(new LabelProvider() {
            ...
            public String getText(Object element) {
                // return
                // CoreUi.I18N.getString(element.getClass().getSimpleName());
    ...
    protected void selectScheme(Class<? extends IAuthData> scheme) {
        ...
        if (ui != null) {
            ...
            // this.fragmentDescription.setText(CoreUi.I18N.getString(selectedType.toString()
            // + ".description"));
            // this.dataPanel.setText(CoreUi.I18N.getString(selectedType.toString()));
            this.currentUi = ui;
        }
    }
    ...
    private Composite createDataPanel(final Composite parent) {
        ...
        //data.setText(CoreUi.I18N.getString("AddFragmentDialog.FragmentData")); //$NON-NLS-1$
        ...
        // this.fragmentDescription = new Text(data, SWT.MULTI);
        // gd = new GridData(SWT.FILL, SWT.FILL, true, true);
        // gd.horizontalSpan = 2;
