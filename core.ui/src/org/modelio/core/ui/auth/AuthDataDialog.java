...
public class AuthDataDialog extends ModelioDialog {
    ...
    private static final String HELP_TOPIC = CoreUi.I18N.getString("AuthDataDialog.HelpTopic");
    ...
    public void addButtonsInButtonBar(Composite parent) {
        createButton(parent, OK, CoreUi.I18N.getString("AuthDataDialog.ok"), true);
        createButton(parent, CANCEL, CoreUi.I18N.getString("AuthDataDialog.cancel"), false);
    }
