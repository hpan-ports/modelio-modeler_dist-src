...
import org.modelio.core.ui.ktable.types.textlist.StringListEditionComposite;
...
public class ListEditor extends AbstractCellEditor {
    ...
    private StringListEditionComposite cdt;
    ...
    @Override
    public StringListEditionComposite createEditorControl(Composite parentComposite) {
        return new StringListEditionComposite(parentComposite, SWT.NONE, -1);
    }
