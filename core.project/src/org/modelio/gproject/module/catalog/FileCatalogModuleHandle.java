...
class FileCatalogModuleHandle implements IModuleHandle, Comparable<Object> {
    ...
    FileCatalogModuleHandle(Path moduleCachePath, String name, Version version, String uid, String mainClassName, Version binaryVersion, List<VersionedItem<?>> dependencies, List<VersionedItem<?>> weakDependencies, List<Path> docPaths, List<Path> jarPaths, Map<String, Path> stylePaths, List<IMetamodelFragmentHandle> metamodelFragments) {
    ...
    public boolean equals(Object obj) {
        ...
        FileCatalogModuleHandle other = (FileCatalogModuleHandle) obj;
