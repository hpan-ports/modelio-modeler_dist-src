...
class JmdacArchiveModuleHandle implements IModuleHandle, Closeable {
    @objid ("d378f9d8-f36d-11e1-9173-001ec947ccaf")
    ...
    @objid ("f8816502-f369-11e1-9173-001ec947ccaf")
    @Override
    ...
    private void init(final JxbModule loadedModule) throws IOException {
    ...
    private JxbModule loadModule(final Path moduleFile) throws IOException {
        try (InputStream inputStream = Files.newInputStream(moduleFile)){
            String packageName = JxbModule.class.getPackage().getName();
            JAXBContext jaxbContext = JAXBContext.newInstance(packageName);
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            
            JxbModule loadedModule = (JxbModule) unmarshaller.unmarshal(inputStream);
