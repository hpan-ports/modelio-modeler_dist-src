...
public class JxbDocpath {
    ...
    protected List<org.modelio.gproject.module.jaxbmodel.JxbDocpath.Entry> entry;
    ...
    public List<org.modelio.gproject.module.jaxbmodel.JxbDocpath.Entry> getEntry() {
        if (this.entry == null) {
