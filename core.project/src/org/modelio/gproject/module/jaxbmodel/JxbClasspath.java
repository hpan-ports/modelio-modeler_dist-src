...
public class JxbClasspath {
    ...
    protected List<org.modelio.gproject.module.jaxbmodel.JxbClasspath.Entry> entry;
    ...
    public List<org.modelio.gproject.module.jaxbmodel.JxbClasspath.Entry> getEntry() {
        if (this.entry == null) {
