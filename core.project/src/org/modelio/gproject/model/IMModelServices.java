...
public interface IMModelServices {
     ...
     * Find stereotypes by name and metaclass
     * 
     * Deprecated: use the method using both the module name and the stereotype name
     * @param stereotypeName
     * @param metaclass @return
     */
     ...
     * @param metaclass @return
     */
    @objid ("70d36d55-c890-4069-96ee-7854492224ca")
    @Deprecated
    List<Stereotype> findStereotypes(String stereotypeName, String metaclass) throws UnknownMetaclassException;
    ...
    @Deprecated
    Stereotype getStereotype(String stereotypeName, String metaclass) throws ElementNotUniqueException, UnknownMetaclassException;
