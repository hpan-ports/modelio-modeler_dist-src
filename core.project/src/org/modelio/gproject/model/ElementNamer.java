...
public class ElementNamer implements IElementNamer {
    ...
    @Override
    public String getUniqueName(final MObject object) {
        return getUniqueName(getBaseName(object), object);
    }

    @objid ("0068621c-030f-1035-9f91-001ec947cd2a")
    @Override
    public String getUniqueName(final String radix, final MObject object) {
    ...
    private static class GetSiblingsVisitor extends DefaultModelVisitor {
    ...
    private static class GetDefaultNameVisitor extends DefaultModelVisitor {
