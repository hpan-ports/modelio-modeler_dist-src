...
public interface IElementConfigurator {
     ...
     * @param modelFactory the model factory that can be used if other elements must be created
     ...
     * @deprecated Use {@link #configure(MObject, Map)} that guesses the model factory to use.
     */
