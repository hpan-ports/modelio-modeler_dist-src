...
public final class ProjectDescriptor implements Serializable {
    ...
    public static ProjectDescriptor createEmpty(String projectName, Path projectPath) {
        ...
        descriptor.setProperties(new GProperties());
    ...
    void setProperties(final GProperties gProperties) {
    ...
    public void cleanup() {
        ...
        while (it.hasNext()) {
            ...
            if (! d.isValid()) {
                Log.trace("Removed incomplete '"+d+"' fragment descriptor.");
                it.remove();
            }
        }
        ...
        while (mit.hasNext()) {
            ...
            if (! d.isValid()) {
                Log.trace("Removed incomplete '"+d+"' module descriptor.");
                mit.remove();
            }
        }
    }
