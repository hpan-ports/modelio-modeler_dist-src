...
public class MDDEditor implements IDocumentEditor {
    ...
    public void setReadonlyMode(boolean readOnly) {
        if (readOnly) {
            ...
            this.editor.setIconURI("platform:/plugin/org.modelio.editors.texteditors/icons/TextEditorRO_16.png");
        } else {
            this.viewer.setEditable(true);
            this.viewer.getControl().setBackground(UIColor.TEXT_WRITABLE_BG);
            this.editor.setIconURI("platform:/plugin/org.modelio.editors.texteditors/icons/TextEditorRW_16.png");
        }
    }
