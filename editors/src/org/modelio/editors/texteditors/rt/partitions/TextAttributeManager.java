...
public class TextAttributeManager {
    ...
    private TextAttributeManager() {
        ...
        defaultTextAttribute = new TextAttribute(UIColor.EDITOR_RWTEXT_FG, null, 0);
                
        // Keywords
        att = new TextAttribute(UIColor.EDITOR_KEYWORD_FG, null, SWT.BOLD);
        attributes.put(RTPartitionTypes.KEYWORD_PARTITION, att);
                
        // MDD tags
        att = new TextAttribute(UIColor.EDITOR_MDDTAG_FG, null, SWT.ITALIC);
        attributes.put(RTPartitionTypes.OBJINGID_PARTITION, att);
                
        // Comments
        att = new TextAttribute(UIColor.EDITOR_COMMENT_FG, null, SWT.ITALIC);
        attributes.put(RTPartitionTypes.COMMENT_PARTITION, att);
    }
