...
public class DeployArchiveHandler {
    ...
    void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell shell, ModelioEnv modelioEnv, IModuleService moduleSvc, IProjectService projectservice, IModelioProgressService progressService) {
        ...
        //AppProjectConf.LOG.debug("DeployArchiveHandler: parent path is :"+dlg.getFilterPath());
        ...
        DeployModule runnable = new DeployModule(paths, catalog, moduleSvc, projectservice.getOpenedProject());
    ...
    class DeployModule implements IRunnableWithProgress {
        ...
        public void run(IProgressMonitor monitor) throws InterruptedException, InvocationTargetException {
            ...
            if (this.report.length() > 0) {
                this.report.insert(0, AppProjectConf.I18N.getMessage("DeployArchiveHandler.SomeFailed"));
