...
public final class AddLocalModelDialog extends ModelioDialog {
    ...
    @objid ("40ad629a-99af-4f4d-864f-54c002f2362d")
    private static final String HELP_TOPIC = "/org.modelio.documentation.modeler/html/Modeler-_modeler_managing_projects_configuring_project_work_models.html";
    ...
    public void addButtonsInButtonBar(Composite parent) {
        ...
        this.addBtn = createButton(parent, OK, AppProjectConf.I18N.getString("AddLocalModelDialog.AddFragment"), true); //$NON-NLS-1$
    ...
    @Override
    public void init() {
        this.getShell().setText(AppProjectConf.I18N.getString("AddLocalModelDialog.ShellTitle")); //$NON-NLS-1$
