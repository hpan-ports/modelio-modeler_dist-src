...
public class DocumentationSection {
    ...
    public static class UrlLabelProvider {
        @objid ("eee29736-f3e4-4c28-824b-b0dca832f9c0")
        private static Image undefined = AbstractUIPlugin.imageDescriptorFromPlugin(AppProjectConf.PLUGIN_ID, "icons/sample.png")
                .createImage();

        @objid ("4a326dbf-66b9-4132-8cc8-5bf76888c781")
        public static Image getIcon(Object element) {
            // TODO: provide a significant icon, ideally the Url icon
            return undefined;
        }
