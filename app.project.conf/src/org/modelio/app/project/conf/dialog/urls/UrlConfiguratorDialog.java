...
public class UrlConfiguratorDialog extends ModelioDialog {
    ...
    @objid ("a10446dd-ad03-4d49-8869-e89c6cb01922")
    private static final String HELP_TOPIC = "/org.modelio.documentation.modeler/html/Modeler-_modeler_managing_projects_configuring_project_URL.html";
        ...
        this.nameText.addModifyListener(new ModifyListener() {
            ...
            public void modifyText(ModifyEvent e) {
                ...
                if (text.matches("[^\\=\\<\\>\"\']+")) {   // Not allow: =, <, >, ", '
                    ...
                    if (UrlConfiguratorDialog.this.addBtn != null) UrlConfiguratorDialog.this.addBtn.setEnabled(true);
                    if (UrlConfiguratorDialog.this.editBtn != null) UrlConfiguratorDialog.this.editBtn.setEnabled(true);
                } else {
                    ((Text) e.getSource()).setForeground(e.display.getSystemColor(SWT.COLOR_RED));
                    if (UrlConfiguratorDialog.this.addBtn != null) UrlConfiguratorDialog.this.addBtn.setEnabled(false);
                    if (UrlConfiguratorDialog.this.editBtn != null) UrlConfiguratorDialog.this.editBtn.setEnabled(false);
                }
            }
        });
