...
class AuditSection {
    ...
    @objid ("26345a04-4717-4edf-8961-f7b50a6d30f2")
    ...
    public AuditSection(IEclipseContext application, IAuditService auditService) {
    ...
    public Section createControls(final FormToolkit toolkit, final Composite parent) {
        ...
        section.setText(AppProjectConf.I18N.getString("AuditSection.SectionText")); //$NON-NLS-1$
        section.setDescription(AppProjectConf.I18N.getString("AuditSection.SectionDescription")); //$NON-NLS-1$
