...
public class CreateBpmnDataObjectCommand extends Command {
     ...
     * the element that lead to this command.
    ...
    public void execute() {
        ...
        newElement = modelFactory.createElement(BpmnDataObject.class);
        ...
        BpmnDataAssociation sourceAssociation = modelFactory.createElement(BpmnDataAssociation.class);
        ...
        BpmnDataAssociation targetAssociation = modelFactory.createElement(BpmnDataAssociation.class);
        ...
        BpmnSequenceFlowDataAssociation sequenceFlowAssociation = modelFactory.createElement(BpmnSequenceFlowDataAssociation.class);
