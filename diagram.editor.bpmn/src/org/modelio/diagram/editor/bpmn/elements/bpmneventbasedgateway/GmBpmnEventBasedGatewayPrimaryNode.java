...
public final class GmBpmnEventBasedGatewayPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmBpmnEventBasedGatewayPrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnEventBasedGatewayPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnEventBasedGatewayPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
