...
public class GmBpmnNodeHeader extends GmModelElementHeader {
    ...
    public GmBpmnNodeHeader(GmAbstractDiagram diagram, MRef relatedRef, boolean showIcone) {
    ...
    public void addHeaderImage(final List<Image> images) {
        this.images = images;
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnNodeHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnNodeHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
