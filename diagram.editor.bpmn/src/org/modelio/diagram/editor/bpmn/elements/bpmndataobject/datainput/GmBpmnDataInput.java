...
public class GmBpmnDataInput extends GmPortContainer {
     ...
     * Creates a GmNote.
     * @param relatedRef
     * The represented note reference
    ...
    public GmBpmnDataInput(GmAbstractDiagram diagram, BpmnDataInput theElement, final MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnDataInput." + MINOR_VERSION_PROPERTY);
    ...
    @objid ("60b2c141-55b6-11e2-877f-002564c97630")
    ...
    @objid ("60b4479e-55b6-11e2-877f-002564c97630")
    @Override
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnDataInput." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("60b447b7-55b6-11e2-877f-002564c97630")
    @Override
