...
public class GmBpmnEdgeGuard extends GmElementLabel {
    ...
    public GmBpmnEdgeGuard(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        if (getParent() instanceof GmBpmnSequenceFlow)
            return getStyle().getProperty(GmBpmnSequenceFlowStyleKeys.GUARDVISIBLE);
        else
            return getStyle().getProperty(GmBpmnSequenceFlowStyleKeys.GUARDVISIBLE);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnEdgeGuard." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnEdgeGuard." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
