...
public class GmBpmnServiceTaskTypeLabel extends GmDefaultModelElementHeader {
    ...
    public GmBpmnServiceTaskTypeLabel(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    protected String computeMainLabel() {
        Boolean showLabel = getStyle().getProperty(GmBpmnServiceTaskStructuredStyleKeys.SHOWREPRESENTED);
        if (showLabel) {
