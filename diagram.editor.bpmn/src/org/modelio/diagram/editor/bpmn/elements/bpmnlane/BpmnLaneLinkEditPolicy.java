    ...
    public EditPart getTargetEditPart(final Request request) {
        if (REQ_CONNECTION_START.equals(request.getType())) {
            ...
            if (request instanceof CreateConnectionRequest) {
                CreateConnectionRequest bendedrequest = (CreateConnectionRequest) request;
                ModelioLinkCreationContext newobject = ModelioLinkCreationContext.lookRequest(bendedrequest);
                if (newobject == null ||
                        newobject.getJavaClass() == BpmnSequenceFlow.class ||
                        newobject.getJavaClass() == BpmnDataAssociation.class) {
                    return null;
                }
            }
