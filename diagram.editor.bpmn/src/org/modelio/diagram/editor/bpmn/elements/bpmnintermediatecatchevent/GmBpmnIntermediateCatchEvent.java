...
public class GmBpmnIntermediateCatchEvent extends GmPortContainer {
    ...
    public GmBpmnIntermediateCatchEvent(GmAbstractDiagram diagram, BpmnIntermediateCatchEvent el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnIntermediateCatchEvent." + MINOR_VERSION_PROPERTY);
    ...
    @objid ("6102199a-55b6-11e2-877f-002564c97630")
    ...
    @objid ("610219a0-55b6-11e2-877f-002564c97630")
    @Override
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnIntermediateCatchEvent." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("610219b8-55b6-11e2-877f-002564c97630")
    @Override
