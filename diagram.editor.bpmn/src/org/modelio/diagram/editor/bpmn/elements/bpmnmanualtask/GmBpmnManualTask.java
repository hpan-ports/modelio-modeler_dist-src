...
public class GmBpmnManualTask extends GmPortContainer {
    ...
    public GmBpmnManualTask(GmAbstractDiagram diagram, BpmnManualTask element, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnManualTask." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnManualTask." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.element = (BpmnManualTask) resolveRef(this.getRepresentedRef());
     ...
     */
    @objid ("61547f62-55b6-11e2-877f-002564c97630")
    @Override
