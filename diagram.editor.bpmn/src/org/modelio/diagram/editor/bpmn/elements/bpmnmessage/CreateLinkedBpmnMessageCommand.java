...
public class CreateLinkedBpmnMessageCommand extends CreateLinkedNodeCommand {
    ...
    public void execute() {
        ...
        if (newElement == null) {
            ...
            newElement = modelFactory.createElement(BpmnMessage.class);
            BpmnBehavior behavior = ((BpmnMessageFlow) this.parentElement).getCollaboration().getOwner();
            newElement.setOwner(behavior);
