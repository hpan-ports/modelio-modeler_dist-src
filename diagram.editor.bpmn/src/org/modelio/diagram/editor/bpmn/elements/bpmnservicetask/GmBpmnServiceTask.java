...
public class GmBpmnServiceTask extends GmPortContainer {
    ...
    public GmBpmnServiceTask(GmAbstractDiagram diagram, BpmnServiceTask element, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnServiceTask." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnServiceTask." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.element = (BpmnServiceTask) resolveRef(this.getRepresentedRef());
     ...
     */
    @objid ("61a86bc9-55b6-11e2-877f-002564c97630")
    @Override
