...
public class GmBpmnReceiveTaskPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmBpmnReceiveTaskPrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnReceiveTaskPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    @objid ("6191885d-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("61918863-55b6-11e2-877f-002564c97630")
    @Override
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnReceiveTaskPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
