...
public class GmBpmnSubProcess extends GmPortContainer {
    ...
    public GmBpmnSubProcess(GmAbstractDiagram diagram, BpmnSubProcess element, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnSubProcess." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnSubProcess." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.element = (BpmnSubProcess) resolveRef(this.getRepresentedRef());
     ...
     */
    @objid ("61c9fd59-55b6-11e2-877f-002564c97630")
    @Override
