 ...
 */
@objid ("60ff0c3a-55b6-11e2-877f-002564c97630")
public final class BpmnIntermediateCatchEventEditPart extends GmNodeEditPart {
    @objid ("60ff0c3e-55b6-11e2-877f-002564c97630")
    @Override
    public boolean isSelectable() {
        return false;
    }

    @objid ("60ff0c43-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("60ff0c46-55b6-11e2-877f-002564c97630")
    @Override
    protected IFigure createFigure() {
        Image image = DiagramEditorBpmn.getImageRegistry()
                                       .getImage(BpmnIntermediateCatchEventImageService.getImageRef((GmModel) this.getModel()));
        
        if (image == null) {
            image = DiagramEditorBpmn.getImageRegistry()
                                     .getImage(BpmnIntermediateThrowEvent.MNAME);
        }
    ...
    @objid ("60ff0c4b-55b6-11e2-877f-002564c97630")
    @Override
    ...
    @objid ("60ff0c52-55b6-11e2-877f-002564c97630")
    @Override
    protected void refreshVisuals() {
        GmBpmnIntermediateCatchEventPrimaryNode initialNodeModel = (GmBpmnIntermediateCatchEventPrimaryNode) this.getModel();
        getFigure().getParent().setConstraint(getFigure(), initialNodeModel.getLayoutData());
    }

    @objid ("60ff0c55-55b6-11e2-877f-002564c97630")
    @Override
