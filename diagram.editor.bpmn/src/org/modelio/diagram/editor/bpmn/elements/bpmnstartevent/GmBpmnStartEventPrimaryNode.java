...
public final class GmBpmnStartEventPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    @objid ("61bc41ea-55b6-11e2-877f-002564c97630")
    private BpmnStartEventImageService image_service;
    ...
    public GmBpmnStartEventPrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void refreshFromObModel() {
        ...
        if (this.image_service == null) {
            this.image_service = new BpmnStartEventImageService();
        }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnStartEventPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnStartEventPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
