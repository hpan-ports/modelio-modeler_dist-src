...
public class GmBpmnSequenceFlowStyleKeys extends BpmnAbstractStyleKeyProvider {
    ...
    /**
     * Show the guard label. public static final StyleKey GUARDVISIBLE = createStyleKey("BPMNSEQUENCEFLOW_GUARDVISIBLE",
     * MetaKey.SHOWNAME); Show the weight label. public static final StyleKey WEIGHTVISIBLE =
     * createStyleKey("BPMNSEQUENCEFLOW_WEIGHTVISIBLE", Boolean.class); Show the main label that displays the name, the
     * tags and the stereotypes.
     */
