...
public class BpmnLaneSetContainerEditPart extends GmNodeEditPart {
    ...
    protected IFigure createFigure() {
        ...
        layoutManager.setHorizontal(false);
    ...
    protected void refreshVisuals() {
        ...
        if (!GmBodyHybridContainer.SUB_PARTITION.equals(partitionContainerModel.getRoleInComposition())) {
            fig.getParent().setConstraint(getFigure(), partitionContainerModel.getLayoutData());
        } else {
            fig.getParent().setConstraint(getFigure(), BorderLayout.CENTER);
        }
    }
