...
public class GmBpmnSendTaskTypeLabel extends GmDefaultModelElementHeader {
    ...
    public GmBpmnSendTaskTypeLabel(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    protected String computeMainLabel() {
        Boolean showLabel = getStyle().getProperty(GmBpmnSendTaskStructuredStyleKeys.SHOWREPRESENTED);
        if (showLabel) {
