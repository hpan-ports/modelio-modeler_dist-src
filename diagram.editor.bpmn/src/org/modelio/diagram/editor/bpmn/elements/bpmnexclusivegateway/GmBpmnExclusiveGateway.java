...
public class GmBpmnExclusiveGateway extends GmPortContainer {
    ...
    public GmBpmnExclusiveGateway(GmAbstractDiagram diagram, BpmnExclusiveGateway el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnExclusiveGateway." + MINOR_VERSION_PROPERTY);
    ...
    @objid ("60f2d73f-55b6-11e2-877f-002564c97630")
    ...
    @objid ("60f2d745-55b6-11e2-877f-002564c97630")
    @Override
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnExclusiveGateway." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("60f2d75e-55b6-11e2-877f-002564c97630")
    @Override
