...
public class GmBpmnTaskPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmBpmnTaskPrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBpmnTaskPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBpmnTaskPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
