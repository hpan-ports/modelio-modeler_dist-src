...
public final class BpmnEndEventEditPart extends GmNodeEditPart {
    ...
    protected IFigure createFigure() {
        Image image = DiagramEditorBpmn
                .getImageRegistry()
                .getImage(BpmnEndEventImageService.getImageRef((GmModel) this.getModel()));
    ...
    protected void refreshVisuals() {
        GmBpmnEndEventPrimaryNode initialNodeModel = (GmBpmnEndEventPrimaryNode) this.getModel();
