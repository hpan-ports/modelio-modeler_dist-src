...
public class SmartCreateLifelineCommand extends Command {
    ...
    public void execute() {
        ...
        IModelFactory factory = modelManager.getModelFactory(this.parentElement);
        
        Interaction interaction = (Interaction) this.parentElement;
        
        // Create the lifeline
        Lifeline lifelineNode = factory.createLifeline("", interaction);
    ...
    private BindableInstance createInstance(final IModelFactory factory, IElementNamer elementNamer, final Interaction interaction) {
    ...
    private Collaboration createLocalsCollaboration(final IModelFactory factory, final Interaction interaction) {
