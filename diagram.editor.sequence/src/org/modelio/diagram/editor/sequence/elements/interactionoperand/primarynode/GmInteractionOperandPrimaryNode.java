...
public class GmInteractionOperandPrimaryNode extends GmNoStyleCompositeNode {
    /**
     * This property name is used to indicate to the edit part that a refresh from model indicated that a resize is
     * needed.
     */
    ...
    public GmInteractionOperandPrimaryNode(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInteractionOperandPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInteractionOperandPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
