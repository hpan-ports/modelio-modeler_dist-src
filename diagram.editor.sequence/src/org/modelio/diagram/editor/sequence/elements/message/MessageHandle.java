...
public class MessageHandle extends ConnectionHandle {
    ...
    /**
     * Creates a new MessageHandle, sets its owner to <code>owner</code> , and sets its locator to a
     * {@link ConnectionLocator}.
     * @param owner the ConnectionEditPart owner
     * @param location one of {@link ConnectionLocator#SOURCE}, {@link ConnectionLocator#MIDDLE} or
    ...
    /**
     * Creates a new MessageHandle and sets its owner to <code>owner</code>. If the handle is fixed, it cannot be
     * dragged.
     * @param owner the ConnectionEditPart owner
     ...
     * @return the location, which is is either {@link ConnectionLocator#SOURCE}, {@link ConnectionLocator#MIDDLE} or
     * {@link ConnectionLocator#TARGET}.
     * @since 3.5
     */
