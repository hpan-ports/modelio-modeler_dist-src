...
public class ExecutionOccurenceSpecificationEditPart extends GmNodeEditPart implements IPlacementConstraintProvider {
    ...
    /**
     * Overridden so that fill color is not null even when fill mode is transparent, because the fill color may be used
     * when execution occurrence specification is a destruction event
     */
