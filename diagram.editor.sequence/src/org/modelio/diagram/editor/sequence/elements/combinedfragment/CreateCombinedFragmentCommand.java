...
public class CreateCombinedFragmentCommand extends Command {
    ...
    public void execute() {
        ...
        if (newElement == null) {
            ModelManager modelManager = this.diagram.getModelManager();
            ...
            elementConfigurer.configure(modelManager.getModelFactory(newElement), operand, this.context.getProperties());
        }
