...
/**
 * <p>
 * This interface defines the capacity to create a {@link PlacementConstraint} for a given Gm that will be used to place
 * the corresponding figure on the sequence diagram background.
 * </p>
 * <p>
 * This interface is to be implemented by the edit part of all the org.modelio.diagram.editor.sequence.elements that are on the diagram background
 * (lifeline, combined fragments, etc).
 * </p>
 * 
 * @author fpoyer
 */
