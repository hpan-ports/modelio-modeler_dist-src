...
public class GmGateOnInteractionUse extends GmPortContainer {
    ...
    public GmGateOnInteractionUse(final GmAbstractDiagram diagram, final Gate gate, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmGateOnInteractionUse." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmGateOnInteractionUse." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("d9175f2a-55b6-11e2-877f-002564c97630")
    @Override
