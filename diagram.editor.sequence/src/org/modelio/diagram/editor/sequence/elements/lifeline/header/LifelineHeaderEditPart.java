...
/**
 * Specialisation of the default edit part for a header wrapping the header figure inside a {@link RectangularFigure}
 * and adding the handling of Image representation mode.
 * 
 * @author fpoyer
 */
...
public class LifelineHeaderEditPart extends ModelElementHeaderEditPart {
    ...
    protected IFigure createFigure() {
        ...
        refreshFromStyle(lifelineHeaderFigure, ((GmAbstractObject) getModel()).getStyle());
