...
public class GmLifelineHeader extends GmDefaultModelElementHeader {
    ...
    public GmLifelineHeader(final GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmLifelineHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmLifelineHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
