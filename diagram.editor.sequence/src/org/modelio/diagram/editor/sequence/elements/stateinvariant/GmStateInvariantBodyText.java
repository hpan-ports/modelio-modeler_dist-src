...
public class GmStateInvariantBodyText extends GmElementText {
    ...
    public GmStateInvariantBodyText(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmStateInvariantBodyText." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmStateInvariantBodyText." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
