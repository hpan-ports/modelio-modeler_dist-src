...
public class GmInteractionOperand extends GmPortContainer {
    ...
    public GmInteractionOperand(final GmAbstractDiagram diagram, final InteractionOperand interactionOperand, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInteractionOperand." + MINOR_VERSION_PROPERTY);
    ...
    public void refreshFromObModel() {
        ...
        if (this.interactionOperand != null && this.interactionOperand.isValid()) {
            ...
            firePropertyChange(PROPERTY_LAYOUTDATA, super.getLayoutData(), Integer.valueOf(height));
        }
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInteractionOperand." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("d9050fd0-55b6-11e2-877f-002564c97630")
    @Override
