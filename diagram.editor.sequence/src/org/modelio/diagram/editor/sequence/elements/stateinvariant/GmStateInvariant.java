...
public class GmStateInvariant extends GmCompositeNode {
    ...
    public GmStateInvariant(GmAbstractDiagram diagram, StateInvariant element, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmStateInvariant." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmStateInvariant." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
