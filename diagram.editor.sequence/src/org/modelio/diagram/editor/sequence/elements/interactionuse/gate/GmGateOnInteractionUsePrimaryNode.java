...
public class GmGateOnInteractionUsePrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmGateOnInteractionUsePrimaryNode(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmGateOnInteractionUse.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmGateOnInteractionUsePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmGateOnInteractionUsePrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
