...
public class IsBeforePredicate extends Predicate {
    ...
    /**
     * C'tor.
     * @param before the first variable. Predicate returns <code>true</code> if it is less than (or equal, depending on the
     * value of "strict") <code>after - offset</code>.
     * @param after the second variable. Predicate returns <code>true</code> if it is greater than (or equal, depending on
     * the value of "strict") <code>before + offset</code>.
     * @param offset an offset that may be used to define a minimal spacing between the variables.
     * @param strict wether the equality is accepted or not.
     */
    ...
    /**
     * Return <code>true</code> if the value of the first variable ("before") if less than (or equal if not strict) to
     * the second variable ("after").
     */
