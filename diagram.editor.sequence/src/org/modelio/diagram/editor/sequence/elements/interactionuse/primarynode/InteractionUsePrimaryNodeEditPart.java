...
public class InteractionUsePrimaryNodeEditPart extends GmNodeEditPart {
    ...
    @objid ("d929aea9-55b6-11e2-877f-002564c97630")
    @Override
    public void propertyChange(final PropertyChangeEvent evt) {
        if (evt.getPropertyName().equals(IGmObject.PROPERTY_LAYOUTDATA)) {
            ...
            */
            ...
            this.figureUpdater.postLayout(getFigure());
        }
