...
public class CombinedFragmentPrimaryNodeEditPart extends GmNodeEditPart {
            ...
            Command updateModelCommand = new Command() {
                ...
                public void execute() {
                    ...
                    if (newTime != combinedFragment.getLineNumber() || newSize != actualFragmentSize) {
                        //                        System.err.println("resize fragment:" +
                        //                                           combinedFragment.getLineNumber() +
                        //                                           "=>" +
                        //                                           newTime +
                        //                                           ", " +
                        //                                           actualFragmentSize +
                        ...
                        for (InteractionOperand operand : combinedFragment.getOperand()) {
                            ...
                            if (operand.getLineNumber() != lineNumber) {
                                ...
                                //SequenceModelManipulationHelper.moveInteractionOperand(operand, lineNumber, operand.getEndLineNumber(), model.getDiagram().getModelFactory());
                            }
                            lineNumber += (ratio * newSize);
                            if (operand.getEndLineNumber() != lineNumber) {
                                //SequenceModelManipulationHelper.moveInteractionOperand(operand, operand.getLineNumber(), lineNumber, model.getDiagram().getModelFactory());
