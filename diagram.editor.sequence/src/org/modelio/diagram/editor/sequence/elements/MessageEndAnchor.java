...
public class MessageEndAnchor extends AbstractConnectionAnchor {
    ...
    /**
     * The MessageEndAnchor's location is computed as the coordinates given at creation, with the X coordinate being
     * modified by the given offset. This offset is either added or subtracted to the X coordinate, based on the
     * reference point used when computing the location.
     */
