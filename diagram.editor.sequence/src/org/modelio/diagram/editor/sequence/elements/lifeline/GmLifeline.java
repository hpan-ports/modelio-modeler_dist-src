...
public class GmLifeline extends GmCompositeNode {
    ...
    public static GmLifelineImageStyleKeys IMAGEKEYS = new GmLifelineImageStyleKeys();

    /**
     * Structured mode style keys.
     */
    @objid ("d938f0e8-55b6-11e2-877f-002564c97630")
    public static GmLifelineStructuredStyleKeys STRUCTKEYS = new GmLifelineStructuredStyleKeys();
    ...
    public static GmLifelineSimpleStyleKeys SIMPLEKEYS = new GmLifelineSimpleStyleKeys();
    ...
    public GmLifeline(GmAbstractDiagram diagram, Lifeline obLifeline, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmLifeline." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmLifeline." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
