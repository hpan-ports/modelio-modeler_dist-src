...
/**
 * Specific anchor that is always on the "dashed line" part of a lifeline (that's the x coordinate) and at the y given
 * by the source time of the corresponding {@link ExecutionOccurenceSpecification}.
 * 
 * @author fpoyer
 */
