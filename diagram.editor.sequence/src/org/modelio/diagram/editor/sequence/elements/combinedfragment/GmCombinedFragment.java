...
public class GmCombinedFragment extends GmPortContainer {
    ...
    public GmCombinedFragment(final GmAbstractDiagram diagram, final CombinedFragment combinedFragment, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCombinedFragment." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCombinedFragment." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("d8c6801d-55b6-11e2-877f-002564c97630")
    @Override
