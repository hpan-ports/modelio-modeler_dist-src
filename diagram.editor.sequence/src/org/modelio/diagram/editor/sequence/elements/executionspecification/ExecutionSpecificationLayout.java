...
import org.modelio.diagram.editor.sequence.elements.sequencediagram.SequenceDiagramLayout;

/**
 * <p>
 * Layout Manager that is specific to the Execution. It is mostly based on a {@link DelegatingLayout} (because most
 * children can determine their Y coordinates by themselves by reading the Ob model) with the exception of the first
 * child that is the visible part of the execution and that is placed "manually" (this last part is what makes it
 * different from the {@link SequenceDiagramLayout}).
 * </p>
 * <p>
 * Constraints for each child figure are instances of {@link PlacementConstraint} which is an implementation of the
 * {@link Locator} interface. Basically, being given a desired X coordinate in absolute coordinates and a desired width,
 * a PlacementConstraint should be able to determine the correct bounds by reading informations in the Ob model.
 * </p>
 * 
 * @author fpoyer
 */
