...
public class GmLifelineHeaderContainer extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmLifelineHeaderContainer." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmLifelineHeaderContainer." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
