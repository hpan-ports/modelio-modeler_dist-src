...
public class GmInteractionUse extends GmPortContainer {
    ...
    public GmInteractionUse(final GmAbstractDiagram diagram, final InteractionUse interactionUse, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInteractionUse." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInteractionUse." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("d91f0056-55b6-11e2-877f-002564c97630")
    @Override
