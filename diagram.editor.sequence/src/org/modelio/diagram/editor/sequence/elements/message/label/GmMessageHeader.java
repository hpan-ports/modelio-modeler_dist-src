...
public class GmMessageHeader extends GmDefaultModelElementLabel {
    ...
    public GmMessageHeader(final GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    }
    ...
    protected String computeMainLabel() {
        ...
        return MessageLabelProvider.computeSimpleLabel(inst);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmMessageHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmMessageHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
