...
/**
 * EditPart for the body zone of the lifeline (== dashed line). This class is in charge of the usual (EditPolicies, etc)
 * but has the additional value of returning anchors that are centred on the lifeline.
 * 
 * @author fpoyer
 */
@objid ("d92e42b0-55b6-11e2-877f-002564c97630")
public class LifelineBodyEditPart extends GmNodeEditPart {
    ...
    protected IFigure createFigure() {
        ...
        refreshFromStyle(fig, ((GmAbstractObject) getModel()).getStyle());
        return fig;
    }
