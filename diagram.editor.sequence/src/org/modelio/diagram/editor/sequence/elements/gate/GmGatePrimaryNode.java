...
public class GmGatePrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmGatePrimaryNode(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return getStyle().getProperty(GmGate.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmGatePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmGatePrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
