...
public class GmExecutionSpecification extends GmCompositeNode {
    ...
    public GmExecutionSpecification(GmAbstractDiagram diagram, ExecutionSpecification element, MRef ref) {
        super(diagram, ref);
    ...
    public boolean canUnmask(MObject el) {
        return canCreate(el.getClass()) &&
                                       ((InteractionFragment) el).getCovered().get(0).equals(getRelatedElement().getCovered());
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmExecutionSpecification." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmExecutionSpecification." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
