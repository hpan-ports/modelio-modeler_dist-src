...
public interface IScriptRunner {
    ...
    void runFile(Path file, ISelection selection, Collection<Element> selectedElements);

    @objid ("0077d2ec-cbcd-1065-a2b8-001ec947cd2a")
    void runScript(String script, ISelection selection, Collection<Element> elements);
