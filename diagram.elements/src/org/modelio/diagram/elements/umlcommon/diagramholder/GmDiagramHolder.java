...
public class GmDiagramHolder extends GmCompositeNode {
    /**
    ...
    @objid ("813a13d2-1dec-11e2-8cad-001ec947c8cc")
     static final DiagramHolderStyleKeys KEYS = new DiagramHolderStyleKeys();

    /**
     * Constructor to use only for deserialization.
     */
    @objid ("813a13d9-1dec-11e2-8cad-001ec947c8cc")
    public GmDiagramHolder() {
    }
    ...
    public GmDiagramHolder(GmAbstractDiagram diagram, final Dependency dependency, final MRef dependencyRef) {
    ...
    @objid ("813c7635-1dec-11e2-8cad-001ec947c8cc")
    @Override
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDiagramHolder." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDiagramHolder." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
