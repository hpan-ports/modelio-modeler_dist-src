...
public final class GmInformationFlowArrow extends GmNoStyleSimpleNode {
    ...
    public GmInformationFlowArrow(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInformationFlowArrow." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInformationFlowArrow." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
