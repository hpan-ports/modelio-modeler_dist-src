...
public final class GmInfoFlowsGroup extends GmGroup {
    ...
    public GmInfoFlowsGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public final boolean isVisible() {
        return getParent() == null || getStyle().getBoolean(getStyleKeyStrict(MetaKey.SHOWINFORMATIONFLOWS));
    }
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInfoFlowsGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInfoFlowsGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
