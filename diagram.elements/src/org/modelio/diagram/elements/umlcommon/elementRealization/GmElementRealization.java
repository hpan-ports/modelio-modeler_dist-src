...
public class GmElementRealization extends GmLink {
    ...
    public GmElementRealization(GmAbstractDiagram diagram, ElementRealization dependency, MRef ref) {
        super(diagram, ref);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmElementRealization." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
