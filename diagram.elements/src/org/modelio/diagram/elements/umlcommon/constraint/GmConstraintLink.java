...
public class GmConstraintLink extends GmLink {
    ...
    public GmConstraintLink(final GmAbstractDiagram diagram, final MRef relatedRef, final ModelElement constrainedElement, final MRef constrainedRef) {
    ...
    public void write(final IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConstraintLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
