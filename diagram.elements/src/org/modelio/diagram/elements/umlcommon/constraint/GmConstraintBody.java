...
public class GmConstraintBody extends GmCompositeNode {
    ...
    public GmConstraintBody(final GmAbstractDiagram diagram, final Constraint constraint, final MRef relatedRef) {
    ...
    public void refreshFromObModel() {
        ...
        if (this.constraint != null ) {
            List<ModelElement> constrainedElements = this.constraint.getConstrainedElement();
            ...
            for (ModelElement constrained : constrainedElements) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmConstraintBody." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConstraintBody." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
