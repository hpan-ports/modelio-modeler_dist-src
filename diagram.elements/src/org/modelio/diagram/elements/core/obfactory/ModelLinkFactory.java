...
public class ModelLinkFactory implements IModelLinkFactory {
    ...
    private static class ImplVisitor extends DefaultModelVisitor {
        ...
        public ImplVisitor(final IModelFactory modelFactory, MObject source, MObject target, final MObject owner) {
            this.source = source;
            this.target = target;
            this.owner = owner;
        ...
        public Object visitBpmnDataAssociation(final BpmnDataAssociation theDataAssociation) {
            if (this.source instanceof BpmnSequenceFlow) {
            
                BpmnSequenceFlow flow = (BpmnSequenceFlow) this.source;
            
                if (flow.getSourceRef() instanceof BpmnActivity) {
                    theDataAssociation.setStartingActivity((BpmnActivity) flow.getSourceRef());
                } else if (flow.getSourceRef() instanceof BpmnThrowEvent) {
                    theDataAssociation.setStartingEvent((BpmnThrowEvent) flow.getSourceRef());
                }
                if (flow.getSourceRef() instanceof BpmnCatchEvent) {
                    theDataAssociation.setEndingEvent((BpmnCatchEvent) flow.getSourceRef());
                }
            
                theDataAssociation.setTargetRef((BpmnItemAwareElement) this.target);
                BpmnSequenceFlowDataAssociation sfdata = this.modelFactory.createElement(BpmnSequenceFlowDataAssociation.class);
                sfdata.setConnected((BpmnSequenceFlow) this.source);
                sfdata.getDataAssociation().add(theDataAssociation);
                // return sfdata;
            } else if (this.target instanceof BpmnSequenceFlow) {
            
                BpmnSequenceFlow flow = (BpmnSequenceFlow) this.target;
                ...
                theDataAssociation.setTargetRef((BpmnItemAwareElement) this.source);
                BpmnSequenceFlowDataAssociation sfdata = this.modelFactory.createElement(BpmnSequenceFlowDataAssociation.class);
                sfdata.setConnected((BpmnSequenceFlow) this.target);
                sfdata.getDataAssociation().add(theDataAssociation);
            } else if (this.source instanceof BpmnActivity) {
                theDataAssociation.setStartingActivity((BpmnActivity) this.source);
                theDataAssociation.setTargetRef((BpmnItemAwareElement) this.target);
            } else if (this.source instanceof BpmnThrowEvent) {
                theDataAssociation.setStartingEvent((BpmnThrowEvent) this.source);
                theDataAssociation.setTargetRef((BpmnItemAwareElement) this.target);
            ...
            } else if (this.target instanceof BpmnCatchEvent) {
                theDataAssociation.setEndingEvent((BpmnCatchEvent) this.target);
                theDataAssociation.getSourceRef().add((BpmnItemAwareElement) this.source);
            }
        ...
        public Object visitBpmnMessageFlow(BpmnMessageFlow theMessageeFlow) {
            ...
            while (parent != null && !(parent instanceof BpmnBehavior)) {
                parent = parent.getCompositionOwner();
            }
            
            if (parent != null) {
                BpmnBehavior behavior = (BpmnBehavior) parent;
                BpmnCollaboration collaboration = null;
                for (BpmnRootElement element : behavior.getRootElement(BpmnCollaboration.class)) {
        ...
        public Object visitElement(Element theElement) {
            throw new IllegalArgumentException(theElement.getMClass().getName() + " link creation is illegal.");
        }
        ...
        public Object visitInformationFlow(final InformationFlow theFlow) {
            theFlow.getInformationSource().add((ModelElement) this.source);
            theFlow.getInformationTarget().add((ModelElement) this.target);
        ...
        public Object visitManifestation(Manifestation theManifestation) {
            ...
            theManifestation.setUtilizedElement((ModelElement) this.target);
    ...
    private static class BindingLinkFactory {
        ...
        public Object createBinding(final Binding theBinding, final MObject source, final MObject target, final MObject owner) throws IllegalArgumentException {
            if (source instanceof CollaborationUse) {
                ...
                theBinding.setRepresentedFeature((ModelElement) target);
            } else {
