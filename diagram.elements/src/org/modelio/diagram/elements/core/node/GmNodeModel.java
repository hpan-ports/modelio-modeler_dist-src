...
import org.modelio.diagram.elements.core.IGmNode;
...
public abstract class GmNodeModel extends GmModel implements IGmNode {
    ...
    public GmNodeModel(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void delete() {
        ...
        //firePropertyChange(IGmObject.PROPERTY_LINK, null, null);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNodeModel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNodeModel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
