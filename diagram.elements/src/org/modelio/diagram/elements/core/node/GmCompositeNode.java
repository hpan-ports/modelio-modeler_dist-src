...
public abstract class GmCompositeNode extends GmNodeModel {
    ...
    public GmCompositeNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCompositeNode." + MINOR_VERSION_PROPERTY);
    ...
    public void removeChild(GmNodeModel child) {
        if (this.children.remove(child)) {
            ...
            assert (false) : "Child is not a valid child";
        }
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCompositeNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
