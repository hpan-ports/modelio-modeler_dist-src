...
public abstract class GmNoStyleCompositeNode extends GmCompositeNode {
    ...
    public GmNoStyleCompositeNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    @Override
    protected final IStyle createStyle(GmAbstractDiagram aDiagram) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmNoStyleCompositeNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmNoStyleCompositeNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
