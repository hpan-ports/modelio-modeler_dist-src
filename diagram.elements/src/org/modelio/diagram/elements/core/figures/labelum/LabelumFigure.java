...
public class LabelumFigure extends Figure implements PositionConstants, IPenOptionsSupport {
    ...
    public LayoutManager getLayoutManager() {
        ...
        assert (manager != null && (manager instanceof LM));
        return manager;
    }
     ...
     * on the <code>LabelumFigure</code>: <ul>
    ...
    public void setLayoutManager(LayoutManager manager) {
        if (manager == null || !(manager instanceof LM)) {
     ...
     * @deprecated The name of this method taken from {@link org.eclipse.draw2d.Label} is error prone.<ul><li>If you want to set the text horizontal alignment, use {@link #setLabelAlignment(int)}.
     * <li>If you want to set the minor alignment of the text <b>relative to the icon</b>
     * within the label use {@link #setTextMinorAlignment(int)}.</ul>
     */
    @objid ("6bdbbb54-fe84-4d4c-8c3c-825eec0467fa")
    @Deprecated
    public void setTextAlignment(int align) {
        setTextMinorAlignment(align);
    }
    ...
    protected Dimension calculatePreferredSize(int wHint, int hHint) {
        ...
        if ((wHint >= 0 && wHint < lprefSize.width) || (hHint>=0 && hHint < lprefSize.height)) {
            ...
            return result;
        } else if ((wHint >= 0 && wHint > lprefSize.width && this.labelAlignment==LEFT+RIGHT)) {
     ...
     */
    @objid ("24e658af-d741-4a0a-8163-92dca7532761")
