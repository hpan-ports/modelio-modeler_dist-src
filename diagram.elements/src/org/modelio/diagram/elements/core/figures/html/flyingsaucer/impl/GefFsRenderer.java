...
public class GefFsRenderer extends Figure implements UserInterface, FSCanvas {
    @objid ("03891d8f-5647-4cef-823c-d09321a048e1")
    ...
    @objid ("1994b38d-1c70-4496-a8d5-7676dfd64ad7")
    ...
    public GefFsRenderer(Composite swtComposite) {
        this(swtComposite, new NaiveUserAgent(swtComposite.getDisplay()));
    }
    ...
    public GefFsRenderer(Composite swtComposite, UserAgentCallback uac) {
        this.display = swtComposite.getDisplay();
    ...
    @objid ("855226e5-0847-4674-b766-4a27e0e6c828")
    @Override
     ...
     * <p>
     * This is a hack to have the whole image transparent on start because by default new Images are entirely opaque.
     * @see http://stackoverflow.com/questions/8270474/drawing-on-a-transparent-image-using-java-swt
     * @param size the image bounds. Only width and height are used.
     * @return the created transparent Image.
     */
    @objid ("a8417650-04ae-41d6-80df-25961c6a702d")
    @Deprecated
    private Image createTransparentImage(Rectangle size) {
        ImageData imData = new ImageData(size.width, size.height, 24, new PaletteData(0xff0000,0x00ff00, 0x0000ff));
        ...
        return new Image(getDisplay(), imData);
    }
