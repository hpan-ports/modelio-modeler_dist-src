...
public class RoundedBoxFigure extends Figure implements IBrushOptionsSupport, IPenOptionsSupport, HandleBounds {
    ...
    public RoundedBoxFigure() {
        ...
        this.setBorder(new RoundedRectangleBorder(null, 1));
    }
    ...
    class RoundedRectangleBorder extends LineBorder {
        /**
        ...
        public void paint(IFigure figure, Graphics graphics, Insets insets) {
            ...
            graphics.setLineStyle(RoundedBoxFigure.this.getLinePattern().toSWTConstant());
        ...
        /**
         * Returns the space used by the border for the figure provided as input. In this border all sides always have
         * equal width.
