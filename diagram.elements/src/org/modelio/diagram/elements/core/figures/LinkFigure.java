 ...
 * <p>
 * It inherits from {@link PolylineConnection} and implements {@link IPenOptionsSupport}. This class may be used as is
 * or redefined.
 * 
 * @author cmarin
 */
...
public class LinkFigure extends PolylineConnection implements IPenOptionsSupport {
    ...
    /**
     * Creates an instance of LinkFigure. The tolerance (used in {@link #containsPoint(int, int)}) is set to 3 (default
     * from {@link Polyline} is 2).
     */
