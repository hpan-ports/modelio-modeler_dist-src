...
public class BendPointMoveHandle extends ConnectionHandle {
    ...
    public BendPointMoveHandle(final ConnectionEditPart owner, final int index) {
        super();
        setOwner(owner);
        setIndex(index);
    }
    ...
    public BendPointMoveHandle(final ConnectionEditPart owner, final int index, final Orientation orientationOfPreviousSegment) {
        super();
        setOwner(owner);
        setIndex(index);
