...
/**
 * Specific drag tracker "installed" on segments of orthogonal-routed connections. It sends specific type of
 * {@link BendpointRequest} so that the corresponging {@link OrthoBendpointEditPolicy} can understand them.
 * 
 * @author fpoyer
 */
...
public class ConnectionSegmentTracker extends SimpleDragTracker {
    ...
    protected String getCommandName() {
        return ConnectionSegmentTracker.REQ_MOVE_SEGMENT.toString();
    }
