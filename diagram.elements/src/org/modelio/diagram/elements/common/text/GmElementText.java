...
public abstract class GmElementText extends GmSimpleNode {
    ...
    public GmElementText(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    protected void setParent(GmCompositeNode newParent) throws IllegalStateException {
        ...
        if (newParent != null && oldParent != newParent) {
            getStyle().setCascadedStyle(newParent.getStyle());
        }
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmElementText." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmElementText." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
