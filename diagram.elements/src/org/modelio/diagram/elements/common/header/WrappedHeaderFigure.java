...
public class WrappedHeaderFigure extends GradientFigure implements IHeaderFigure {
    ...
    protected LabelumFigure createCenterFigures() {
        ...
        Border border = new MarginBorder(2, 0, 3, 0);
    ...
    protected void layout() {
        ...
        // Place the main label at the center of the figure if it is invisible,
        // because cell editors use the main label bounds to place themselves
        if (this.mainLabel.getParent() == null) {
            Rectangle oldBounds = this.mainLabel.getBounds();
            this.mainLabel.setLocation(getBounds().getCenter().translate(oldBounds.width / 2, oldBounds.height / 2));
        }
    }
