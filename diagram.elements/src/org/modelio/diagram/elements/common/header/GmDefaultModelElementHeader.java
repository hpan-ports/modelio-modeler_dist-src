...
public class GmDefaultModelElementHeader extends GmModelElementHeader {
    ...
    public GmDefaultModelElementHeader(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    @Override
    protected IStyle createStyle(GmAbstractDiagram diagram) {
        return new ProxyStyle(diagram.getStyle());
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDefaultModelElementHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDefaultModelElementHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
