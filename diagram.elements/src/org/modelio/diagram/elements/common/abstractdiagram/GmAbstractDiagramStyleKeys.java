...
public class GmAbstractDiagramStyleKeys extends ElementsAbstractStyleKeyProvider {
    ...
    /**
     * This StyleKey defines the page size. String value. * Supported string format: * - discrete values:
     * A5H,A4H,A3H,A2H,A1H,A0H, A5V,A4V,A3V,A2V,A1V,A0V * - inches values: '8.5" x 3.4"' * - mm values: '210 mm x 297
     * mm'
     */
