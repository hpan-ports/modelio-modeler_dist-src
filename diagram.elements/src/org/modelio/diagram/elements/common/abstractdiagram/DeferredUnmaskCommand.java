...
/**
 * Command that unmask an element in the first diagram node representing the parent composite element that allows
 * unmasking . its parent IF said parent is also unmasked in the diagram at the time of execution.
 * 
 * @author fpoyer
 */
...
public class DeferredUnmaskCommand extends Command {
    ...
    private Command createCommand() {
        ...
        List<GmModel> parentModels = gmDiagram.getAllGMRelatedTo(new MRef(this.parent));
