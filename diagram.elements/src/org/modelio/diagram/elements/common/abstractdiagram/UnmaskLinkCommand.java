...
public class UnmaskLinkCommand extends Command {
    ...
    public void execute() {
        ...
        if (this.routerKey != null) {
            req.getData()
               .setRoutingMode((ConnectionRouterId) ((GmAbstractDiagram) this.host.getModel()).getStyle()
    ...
    private EditPart getEditPartFor(MObject element, CreateConnectionRequest req) {
        ...
        List<GmModel> models = ((GmAbstractDiagram) getHost().getModel()).getAllGMRelatedTo(new MRef(element));
