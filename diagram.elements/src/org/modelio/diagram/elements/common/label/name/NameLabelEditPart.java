...
/**
 * Specialisation of the {@link ModelElementLabelEditPart} to remove the DefaultDeleteNodeEditPolicy so that
 * NameLabel cannot be masked.
 * 
 * @author fpoyer
 */
...
public class NameLabelEditPart extends ModelElementLabelEditPart {
    ...
    protected void createEditPolicies() {
        ...
        // Remove the DefaultDeleteNodeEditPolicy installed by default by GmNodeEditPart, since NameLabel is a floating label, selectable but NOT maskable.
