...
public class GmDefaultModelElementLabel extends GmModelElementLabel {
    ...
    public GmDefaultModelElementLabel(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDefaultModelElementLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDefaultFlatHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(minorVersion));
        }
    }
