...
public class PortContainerLayoutHelper {
     ...
     * <p>
     * Warn: The given rectangle is directly modified !
     * The already specified width and height are passed as hints to get preferred size.
    ...
    /**
     * Convert a port layout constraint to bounds the figure should take.
     * The bounds are relative to the container origin.
     ...
     * Complete the given rectangle with the child preferred size if width or height is not specified.
     * <p>
     * If the rectangle is already complete it is returned as is. In the other case a completed copy is returned.
     * The already specified width and height are then passed as hints to get preferred size.
     * @param init the rectangle to complete
     * @param child the figure
