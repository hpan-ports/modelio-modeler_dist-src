...
public class AutoSizeEditPolicy2 extends DefaultNodeResizableEditPolicy {
    ...
    private SelectionEditPolicy getMainNodeMovePolicy(GmNodeEditPart mainNodeEditPart) {
    ...
    private SelectionEditPolicy getMainNodeResizePolicy(GmNodeEditPart mainNodeEditPart) {
    ...
    protected Command getMoveCommand(ChangeBoundsRequest request) {
        ...
        GmNodeEditPart mainNodeEditPart = getMainNodeEditPart();
    ...
    protected SelectionEditPolicy getMainNodeDragPolicy(Request request, GraphicalEditPart mainNodeEditPart) {
        ...
        if(REQ_MOVE.equals(requestType) || REQ_ADD.equals(requestType)
            ...
            return getMainNodeMovePolicy((GmNodeEditPart) mainNodeEditPart);
        } else if(REQ_RESIZE.equals(requestType)) {
            return getMainNodeResizePolicy((GmNodeEditPart) mainNodeEditPart);
        }
        return null;
    }
    ...
    private GmNodeEditPart getMainNodeEditPart() {
        ...
        if (mainNodeEditPart instanceof GmNodeEditPart) {
            return (GmNodeEditPart) mainNodeEditPart;
        } else {
            return null;
        }
    }
