...
public class GmBodyFreeZone extends GmFreeZone {
    ...
    public GmBodyFreeZone(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmBodyFreeZone." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmBodyFreeZone." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
