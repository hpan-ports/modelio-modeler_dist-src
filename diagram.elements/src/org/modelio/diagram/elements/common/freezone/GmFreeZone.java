...
public abstract class GmFreeZone extends GmCompositeNode {
    ...
    public GmFreeZone(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmFreeZone." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmFreeZone." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
