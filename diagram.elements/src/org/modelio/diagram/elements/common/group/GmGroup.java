...
public abstract class GmGroup extends GmNoStyleCompositeNode {
    ...
    public GmGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    protected void setHiddenFeature(boolean hasHiddenFeatures) {
        if (hasHiddenFeatures != this.hasHiddenFeatures) {
            ...
            firePropertyChange(PROPERTY_CHILDREN, null, hasHiddenFeatures);
        }
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
