...
public abstract class GmResizableGroup extends GmNoStyleCompositeNode {
    ...
    public GmResizableGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmResizableGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmResizableGroup." + MINOR_VERSION_PROPERTY,
