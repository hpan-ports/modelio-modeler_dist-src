...
public class GmDrawingLayer extends GmAbstractObject implements IGmDrawingLayer {
    ...
    public GmDrawingLayer(GmAbstractDiagram diagram, MRef relatedRef, String layerIdent) {
        super(diagram);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDrawingLayer." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDrawingLayer." + MINOR_VERSION_PROPERTY);
    ...
    @Override
    public void delete() {
        final GmAbstractDiagram diagram = getDiagram();
