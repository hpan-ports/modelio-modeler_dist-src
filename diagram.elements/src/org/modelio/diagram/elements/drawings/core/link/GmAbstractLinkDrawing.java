...
public abstract class GmAbstractLinkDrawing extends GmDrawing implements IGmDrawingLink {
    ...
    public GmAbstractLinkDrawing(GmAbstractDiagram diagram, String identifier) {
    ...
    public final void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmAbstratLinkDrawing." + MINOR_VERSION_PROPERTY);
     ...
     * </pre>
     */
    @objid ("f60c692d-c116-4223-b3c2-e18a7a84850d")
    @Deprecated
     ...
     * </pre>
     */
    @objid ("ad11e9de-57c1-469a-a1cb-05a77214f8af")
    @Deprecated
