...
/**
 * Basic edit part for {@link IGmDrawingLink}. A GmLinkEditPart: <br/>
...
public class AbstractLinkDrawingEditPart extends AbstractConnectionEditPart implements PropertyChangeListener, IAnchorModelProvider {
     ...
     * <p>
     * Extends {@link AbstractConnectionEditPart#getAdapter(Class)} to support {@link IGmObject},
    ...
    protected List<Object> getModelSourceConnections() {
        return (List<Object>) (Object) (((IGmDrawingLinkable) getModel()).getStartingDrawingLinks());
    }
    ...
    protected List<Object> getModelTargetConnections() {
        // ugly cast...
        return (List<Object>) (Object) (getModel().getEndingDrawingLinks());
    }
    ...
    private void updateConnectionRoute(final Connection cnx) {
        ...
        final IGmDrawingLink gmLink = this.getModel();
    ...
    protected void activateFigure() {
        ...
        layerPart.addConnection(getFigure());
     ...
     * layer connection layer, and resetting the source and target connections to
     * <code>null</code>.
     */
