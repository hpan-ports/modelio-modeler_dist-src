...
public class CloneGmLinkDrawingCommand extends Command implements RequestConstants {
    ...
    public void execute() {
        ...
        // Move the source
        ReconnectRequest r2 = new ReconnectRequest(REQ_RECONNECT_SOURCE);
        ...
        // Move the target
        ReconnectRequest r3 = new ReconnectRequest(REQ_RECONNECT_TARGET);
    ...
    private IGmDrawingLink copyModel(IGmDrawingLink toCopy) {
        try {
            IGmDrawingLink newlink = toCopy.getClass().getConstructor(GmAbstractDiagram.class).newInstance(toCopy.getDiagram());
            ...
            IStyle origStyle = toCopy.getStyle();
            IStyle newStyle = newlink.getStyle();
