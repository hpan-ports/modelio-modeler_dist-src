...
public class CreateDrawingLinkEditPolicy extends GraphicalNodeEditPolicy {
    ...
    protected IGmPath createPathModel(final CreateConnectionRequest req) {
        ...
        ConnectionAnchor srcAnchor = (ConnectionAnchor) req.getExtendedData().get("srcAnchor");
    ...
    protected Command getReconnectSourceCommand(ReconnectRequest req) {
        ...
        final ReconnectDrawingSourceCommand cmd = new ReconnectDrawingSourceCommand(linkModel,
                (IGmDrawingLinkable) newSourceNodeEditPart.getModel());
     ...
     */
    @objid ("53ef8400-5ba3-49b6-8f6f-bf11b11fafd6")
     ...
     */
    @objid ("45cf4c69-46b3-48dd-8193-403a249d723b")
     ...
     */
    @objid ("83f5da2d-0e67-4361-9d82-fadc4143b91e")
    @SuppressWarnings("unchecked")
