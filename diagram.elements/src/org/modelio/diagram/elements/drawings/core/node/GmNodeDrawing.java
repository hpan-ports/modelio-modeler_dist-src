...
public abstract class GmNodeDrawing extends GmDrawing implements IGmNodeDrawing {
    ...
    public void write(IDiagramWriter out) {
        ...
        /*if (GmNodeDrawing.minorVersion != 0) {
            out.writeProperty("GmNodeDrawing." + MINOR_VERSION_PROPERTY, Integer.valueOf(GmNodeDrawing.minorVersion));
        }*/
    ...
    public GmNodeDrawing(GmAbstractDiagram diagram, String identifier) {
