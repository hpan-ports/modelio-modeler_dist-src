...
public class CloneGmNodeDrawingCommand extends Command {
    ...
    public void execute() {
        try {
            // copy the node
            IGmNodeDrawing newNode = this.toCopy.getClass().getConstructor(GmAbstractDiagram.class, String.class).newInstance(this.layer.getDiagram(), UUID.randomUUID().toString());
            ...
            IStyle origStyle = this.toCopy.getStyle();
            IStyle newStyle = newNode.getStyle();
