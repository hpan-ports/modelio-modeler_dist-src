...
//protected Combo metaclassCombo = null;
    ...
    @objid ("a5193e5e-5b5e-4822-8d49-8dbac2326b4d")
    private Image iconPlaceholderImage;
    ...
    /**
     * (non-Javadoc)
     * @see IModelioDialog#addButtonsInButtonBar(org.eclipse.swt.widgets.Composite)
     */
    ...
    /**
     * (non-Javadoc)
     * @see IModelioDialog#createContentArea(org.eclipse.swt.widgets.Composite)
     */
    ...
    public Control createContentArea(Composite parent) {
        ...
        this.iconPlaceholderImage = new Image(null, getFilePathOf("icons/placeholder16.png"));
        this.imagePlaceholderImage = new Image(null, getFilePathOf("icons/placeholder3248.png"));
    ...
    public boolean close() {
        ...
        if (this.iconPlaceholderImage != null) {
            this.iconPlaceholderImage.dispose();
            this.iconPlaceholderImage = null;
        }
        
        if (this.imagePlaceholderImage != null) {
            this.imagePlaceholderImage.dispose();
            this.imagePlaceholderImage = null;
        }
        return super.close();
    }
    ...
    private void createNameArea(Composite area) {
        ...
        GridData gd_noteTypeNameLabel = new GridData(SWT.LEFT, SWT.CENTER, false, false);
        ...
        GridData gd_stereotypeNameText = new GridData(SWT.FILL, SWT.CENTER, true, false);
    ...
    public void refresh() {
        ...
        if (openedProject != null) {
            ...
            if (diagramImagePath != null && !diagramImagePath.equals("")) {
                ...
                try {
                    ImageDescriptor diagramImageDesc = ImageDescriptor
                            .createFromURL(diagramImageFile.toURI().toURL());
