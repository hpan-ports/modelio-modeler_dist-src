...
public class TreePanelInput {
    ...
    @objid ("26968df3-1ee9-48f6-b607-f5cb0ff03807")
    ...
    private Element preselectedTypingElement;
    ...
    public TreePanelInput(IMModelServices modelService, Element typedElement, Element preselectedTypingElement, boolean displayHiddenAnnotations) {
        super();
     ...
     */
    @objid ("1c06f832-f3fd-4a33-9806-71a769bb4f22")
     ...
     */
    @objid ("b2b7031a-6895-4773-b9bc-fe01f552600b")
    ...
    public Element getPreselectedTypingElement() {
    ...
    public void setPreselectedTypingElement(Element preselectedTypingElement) {
        this.preselectedTypingElement = preselectedTypingElement;
    }
