...
/**
 * This factory returns a PropertyPanel used to display the "properties" part
 * of the property view, depending on the element metaclass.
 * Currently, there are two PropertyPanel implementation, both based on KTable:
 * <ul>
 * <li>{@link StandardPropertyPanel}</li>
 * <li>{@link ExtensionsPropertyPanel}</li>
 * </ul>
 * This allows for future specific panels for some metaclasses...
 * 
 * @author pvlaemyn
 */
