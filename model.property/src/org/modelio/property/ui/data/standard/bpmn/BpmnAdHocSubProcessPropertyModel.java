 ...
 * metaclass.
 */
@objid ("8e0aa29c-c068-11e1-8c0a-002564c97630")
public class BpmnAdHocSubProcessPropertyModel extends AbstractPropertyModel<BpmnAdHocSubProcess> {
    @objid ("a59a6f29-c068-11e1-8c0a-002564c97630")
    private final List<String> properties = new ArrayList<>();

    @objid ("ab3412ab-d004-11e1-9020-002564c97630")
    private final IMModelServices modelService;

    @objid ("17262f38-16da-11e2-aa0d-002564c97630")
     ...
     */
    @objid ("8e0aa2a5-c068-11e1-8c0a-002564c97630")
    public BpmnAdHocSubProcessPropertyModel(BpmnAdHocSubProcess theEditedElement, IMModelServices modelService, IModel model) {
     ...
     */
    @objid ("8e0aa2ab-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e0aa2b0-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e0aa2b5-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e0aa2bc-c068-11e1-8c0a-002564c97630")
    @Override
    public IPropertyType getTypeAt(int row, int col) {
        ...
        if (col == 1) // col 1 is the property value
        {
            if (row == 0) {
                ...
                return new EnumType(AdHocOrdering.class);
            } else if (row == 7) {
                return new BooleanType();
            } else if (row == 8) {
                return new StringType(true);
     ...
     */
    @objid ("8e0aa2c3-c068-11e1-8c0a-002564c97630")
    @Override
    ...
    @objid ("8e0c2927-c068-11e1-8c0a-002564c97630")
