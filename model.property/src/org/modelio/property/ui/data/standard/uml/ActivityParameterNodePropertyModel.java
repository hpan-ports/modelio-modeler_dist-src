...
public class ActivityParameterNodePropertyModel extends AbstractPropertyModel<ActivityParameterNode> {
    ...
    private static final String[] PROPERTIES = new String[] { "Property", "Name", "Type", "UpperBound", "IsControlType",
            "Ordering", "SelectionBehavior", "InState", "Represented" };
    ...
    public ActivityParameterNodePropertyModel(ActivityParameterNode theEditedElement) {
        ...
        this.generalClassType = new SingleElementType(true, GeneralClass.class, session);
        this.stateType = new SingleElementType(true, State.class, session);
        ...
        this.representedType = new SingleElementType(true, allowedClasses, session);
    }
