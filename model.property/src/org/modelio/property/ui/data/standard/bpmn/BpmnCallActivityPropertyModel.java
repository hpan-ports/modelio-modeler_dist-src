 ...
 */
@objid ("8e13ca5b-c068-11e1-8c0a-002564c97630")
public class BpmnCallActivityPropertyModel extends AbstractPropertyModel<BpmnCallActivity> {
    @objid ("a5a8b772-c068-11e1-8c0a-002564c97630")
    private List<String> properties = new ArrayList<>();

    @objid ("aac1a0a8-d004-11e1-9020-002564c97630")
    private IMModelServices modelService;

    @objid ("169c17a4-16da-11e2-aa0d-002564c97630")
    private IModel model;

    /**
     * Create a new <i>BpmnCallActivity</i> data model from an <i>BpmnCallActivity</i>.
     */
    @objid ("8e13ca64-c068-11e1-8c0a-002564c97630")
    public BpmnCallActivityPropertyModel(BpmnCallActivity theEditedElement, IMModelServices modelService, IModel model) {
     ...
     */
    @objid ("8e13ca6a-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e13ca6f-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e13ca74-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e13ca7b-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e13ca82-c068-11e1-8c0a-002564c97630")
    @Override
    public void setValueAt(int row, int col, Object value) {
        ...
        if (col == 1) // col 1 is the property value
        {
            if (row == 0) {
                ...
                this.theEditedElement.setCalledBehavior(null);
            } else if (row == 6) {
                this.theEditedElement.setCalledGlobalTask(null);
                this.theEditedElement.setCalledProcess((BpmnProcess) value);
                this.theEditedElement.setCalledOperation(null);
                this.theEditedElement.setCalledBehavior(null);
            }
                ...
                this.theEditedElement.setCalledProcess(null);
                this.theEditedElement.setCalledOperation(null);
                this.theEditedElement.setCalledBehavior((Behavior) value);
            }
