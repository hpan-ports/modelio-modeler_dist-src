 ...
 */
@objid ("8e230c85-c068-11e1-8c0a-002564c97630")
public class BpmnDataStorePropertyModel extends AbstractPropertyModel<BpmnDataStore> {
     ...
     * </ul>
     */
    @objid ("a5c547e8-c068-11e1-8c0a-002564c97630")
    private static final String[] properties = new String[] { "DataStore", "Name","GeneralClass","State",
            "Capacity", "Unlimited", "Instance", "AssociationEnd", "Attribute", "ItemDefinition" };

    @objid ("15b70ed4-16da-11e2-aa0d-002564c97630")
    private IModel model;

    /**
     * Create a new <i>BpmnDataStore</i> data model from an <i>BpmnDataStore</i>.
     */
    @objid ("8e230c90-c068-11e1-8c0a-002564c97630")
    public BpmnDataStorePropertyModel(BpmnDataStore theEditedElement, IModel model) {
     ...
     */
    @objid ("8e230c96-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e230c9b-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e230ca0-c068-11e1-8c0a-002564c97630")
    @Override
    public Object getValueAt(int row, int col) {
        switch (col) {
            case 0: // col 0 is the property key
                return BpmnDataStorePropertyModel.properties[row];
     ...
     */
    @objid ("8e230ca6-c068-11e1-8c0a-002564c97630")
    @Override
     ...
     */
    @objid ("8e230cac-c068-11e1-8c0a-002564c97630")
    @Override
            ...
            case 1: // col 1 is the property value
                switch (row) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        this.theEditedElement.setCapacity(Integer.valueOf((String) value));
                        break;
                    case 5:
    ...
    @objid ("e6f3e881-69f7-473f-98de-73a01d1a0529")
     ...
     */
    @objid ("b7f91699-cc79-4c80-8e3d-f8d5d99f0be8")
     ...
     */
    @objid ("8b92de63-8e1c-4f9e-8204-6b88c2e4d301")
