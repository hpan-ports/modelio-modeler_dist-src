...
public class IOParameterPropertyModel extends AbstractPropertyModel<Parameter> {
    ...
    private static final String[] PROPERTIES = new String[] { "Property", "Name", "Type", "MultiplicityMin", "MultiplicityMax",
            "ParameterPassing", "DefaultValue", "TypeConstraint", "Effect", "IsException", "IsStream", "IsOrdered", "IsUnique" };
