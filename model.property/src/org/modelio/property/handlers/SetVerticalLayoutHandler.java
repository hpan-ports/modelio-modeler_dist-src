...
/**
 * Handler for the setVerticalLayout command, using injection to execute on the {@link PropertyView} MPart.
 * Changes the property view layout to vertical.
 * @see SetHorizontalLayoutHandler
 * @see SetAutoLayoutHandler
 */
@objid ("8dfce6f3-c068-11e1-8c0a-002564c97630")
public class SetVerticalLayoutHandler {
    @objid ("8dfce6f4-c068-11e1-8c0a-002564c97630")
    @Execute
    public void execute(@Named(IServiceConstants.ACTIVE_PART) final MPart e) {
        if (e.getObject() instanceof PropertyView) {
            ...
            if (null != propertyView.getPanel()) {
                ...
                propertyView.getPanel().setVerticalLayout();
            }
        }
    }
