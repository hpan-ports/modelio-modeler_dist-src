...
/**
 * This class provides the StyleKey constants for a GmDecisionmerge when its representation mode is
...
public class GmDecisionMergeStructuredStyleKeys extends ActivityAbstractStyleKeyProvider {
    ...
    /**
     * Stereotype display mode: <li>none <li>text in the label <li>icon on the label
     */
