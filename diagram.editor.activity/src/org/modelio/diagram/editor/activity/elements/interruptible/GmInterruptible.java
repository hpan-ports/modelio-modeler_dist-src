...
public class GmInterruptible extends GmCompositeNode {
    ...
    public GmInterruptible(GmAbstractDiagram diagram, InterruptibleActivityRegion theInterruptible, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInterruptible." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInterruptible." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
