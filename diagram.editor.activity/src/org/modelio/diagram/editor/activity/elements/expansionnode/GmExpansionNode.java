...
public class GmExpansionNode extends GmPortContainer {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmExpansionNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmExpansionNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2a553670-55b6-11e2-877f-002564c97630")
    @Override
