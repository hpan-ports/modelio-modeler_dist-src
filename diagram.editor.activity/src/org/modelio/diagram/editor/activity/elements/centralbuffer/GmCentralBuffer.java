...
public class GmCentralBuffer extends GmPortContainer {
    ...
    public GmCentralBuffer(GmAbstractDiagram diagram, CentralBufferNode theCentralBuffer, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCentralBuffer." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCentralBuffer." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    @objid ("29e44c39-55b6-11e2-877f-002564c97630")
    @Override
    public GmCentralBufferPrimaryNode getMainNode() {
        return (GmCentralBufferPrimaryNode) getFirstChild(GmPortContainer.MAIN_NODE_ROLE);
    }
