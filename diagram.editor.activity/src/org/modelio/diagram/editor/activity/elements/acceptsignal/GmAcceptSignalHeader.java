...
public class GmAcceptSignalHeader extends GmActivityNodeHeader {
     ...
     */
    @objid ("2977f5ba-55b6-11e2-877f-002564c97630")
    ...
    public GmAcceptSignalHeader(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmAcceptSignalHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmAcceptSignalHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
