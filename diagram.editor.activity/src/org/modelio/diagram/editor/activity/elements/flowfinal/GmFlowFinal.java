...
public class GmFlowFinal extends GmPortContainer {
    ...
    public GmFlowFinal(GmAbstractDiagram diagram, FlowFinalNode el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmFlowFinal." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmFlowFinal." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2a76c849-55b6-11e2-877f-002564c97630")
    @Override
