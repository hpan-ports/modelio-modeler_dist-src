...
public class GmChangeEventExpression extends GmElementText {
    ...
    public GmChangeEventExpression(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmChangeEventExpression." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmChangeEventExpression." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
