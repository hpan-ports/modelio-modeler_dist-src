...
public class GmActivityNodeHeader extends GmModelElementHeader {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmActivityNodeHeader." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmActivityNodeHeader." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
