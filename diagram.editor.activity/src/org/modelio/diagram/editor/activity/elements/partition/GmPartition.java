...
public class GmPartition extends GmCompositeNode {
    ...
    public GmPartition(GmAbstractDiagram diagram, ActivityPartition thePartition, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPartition." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPartition." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     * @param vertical true if this partition must be vertical (header above body), false if it must be horizontal (header
     * left of body).
     */
