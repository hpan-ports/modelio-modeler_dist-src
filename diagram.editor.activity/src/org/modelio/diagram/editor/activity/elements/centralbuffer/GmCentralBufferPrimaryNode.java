...
public class GmCentralBufferPrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmCentralBufferPrimaryNode(GmAbstractDiagram diagram, MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmCentralBuffer.SIMPLEKEYS.getStyleKey(MetaKey.REPMODE));
    }
