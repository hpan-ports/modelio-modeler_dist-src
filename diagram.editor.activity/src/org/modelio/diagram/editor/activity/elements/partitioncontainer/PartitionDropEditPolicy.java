...
public class PartitionDropEditPolicy extends GraphicalEditPolicy {
    ...
    /**
     * <p>
     * If all dropped elements are partitions returns host if all dropped elements are sub partitions of host (with
     * potentially several not yet unmasked inbetween ancestors).
     * </p>
     * <p>
