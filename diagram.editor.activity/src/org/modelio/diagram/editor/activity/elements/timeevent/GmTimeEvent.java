...
public class GmTimeEvent extends GmPinContainer {
    ...
    public GmTimeEvent(GmAbstractDiagram diagram, AcceptTimeEventAction el, MRef ref) {
        super(diagram, ref);
        this.element = el;
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmTimeEvent." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmTimeEvent." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2b5f0574-55b6-11e2-877f-002564c97630")
    @Override
