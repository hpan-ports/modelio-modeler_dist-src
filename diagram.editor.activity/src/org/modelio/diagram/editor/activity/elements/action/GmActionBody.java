...
public class GmActionBody extends GmElementText {
    ...
    public GmActionBody(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmActionBody." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmActionBody." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
