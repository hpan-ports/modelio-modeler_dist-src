...
/**
 * This class provides the StyleKey constants for a GmClause when its representation mode is
...
public class GmClauseStructuredStyleKeys extends ActivityAbstractStyleKeyProvider {
    /**
     * @objid ("dd98a603-b766-11df-bcca-00137279a777") public static StyleKey SHOWTAGS = new StyleKey("CLAUSE_SHOWTAGS",
     * MetaKey.SHOWTAGS);
     * 
     * @objid ("dd98a607-b766-11df-bcca-00137279a777") public static StyleKey SHOWSTEREOTYPES = new
     * StyleKey("CLAUSE_SHOWSTEREOTYPES", MetaKey.SHOWSTEREOTYPES);
     */
