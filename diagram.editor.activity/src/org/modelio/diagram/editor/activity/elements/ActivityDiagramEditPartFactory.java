...
public class ActivityDiagramEditPartFactory implements EditPartFactory {
    @objid ("29980113-55b6-11e2-877f-002564c97630")
    private static final ActivityDiagramEditPartFactory INSTANCE = new ActivityDiagramEditPartFactory();
     ...
     * @return the instance.
     */
    @objid ("2999877b-55b6-11e2-877f-002564c97630")
    public static EditPartFactory getInstance() {
        return INSTANCE;
    }

    @objid ("29998780-55b6-11e2-877f-002564c97630")
    private ActivityDiagramEditPartFactory() {
    ...
    public class StructuredModeEditPartFactory implements EditPartFactory {
        ...
        public EditPart createEditPart(EditPart context, Object model) {
            ...
            if (model.getClass() == GmActivityDiagramView.class) {
    ...
    public static class ImageModeEditPartFactory implements EditPartFactory {
    ...
    public static class SimpleModeEditPartFactory implements EditPartFactory {
