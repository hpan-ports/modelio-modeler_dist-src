...
public class GmSendSignal extends GmPinContainer {
    ...
    public GmSendSignal(GmAbstractDiagram diagram, SendSignalAction el, MRef ref) {
        super(diagram, ref);
        this.element = el;
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmSendSignal." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmSendSignal." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.element = (SendSignalAction) resolveRef(this.getRepresentedRef());
     ...
     */
    @objid ("2b4514b3-55b6-11e2-877f-002564c97630")
    @Override
