...
public class GmLoopNodePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmLoopNodePrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmLoopNodePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmLoopNodePrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    public static final class GmSetup extends GmElementLabel {
        ...
        public GmSetup(GmAbstractDiagram diagram, MRef relatedRef) {
            super(diagram, relatedRef);
        }
        ...
        public void read(IDiagramReader in) {
            // Read version, defaults to 0 if not found
            Object versionProperty = in.readProperty("GmSetup." + MINOR_VERSION_PROPERTY);
            int readVersion = versionProperty == null ? 0 : ((Integer) versionProperty).intValue();
            switch (readVersion) {
                case 0: {
                    read_0(in);
        ...
        public void write(IDiagramWriter out) {
            ...
            // Write version of this Gm if different of 0.
            if (this.minorVersion != 0) {
                out.writeProperty("GmSetup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
            }
        }
    ...
    public static final class GmTest extends GmElementLabel {
        ...
        public GmTest(GmAbstractDiagram diagram, MRef relatedRef) {
            super(diagram, relatedRef);
        }
        ...
        public void read(IDiagramReader in) {
            // Read version, defaults to 0 if not found
            Object versionProperty = in.readProperty("GmTest." + MINOR_VERSION_PROPERTY);
            int readVersion = versionProperty == null ? 0 : ((Integer) versionProperty).intValue();
            switch (readVersion) {
                case 0: {
                    read_0(in);
        ...
        public void write(IDiagramWriter out) {
            ...
            // Write version of this Gm if different of 0.
            if (this.minorVersion != 0) {
                out.writeProperty("GmTest." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
            }
        }
