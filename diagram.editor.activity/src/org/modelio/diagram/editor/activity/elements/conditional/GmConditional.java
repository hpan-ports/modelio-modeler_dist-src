...
public class GmConditional extends GmPinContainer {
    ...
    public GmConditional(GmAbstractDiagram diagram, ConditionalNode el, MRef ref) {
        super(diagram, ref);
        this.element = el;
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmConditional." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConditional." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.element = (ConditionalNode) resolveRef(this.getRepresentedRef());
     ...
     */
    @objid ("2a16a6c4-55b6-11e2-877f-002564c97630")
    @Override
