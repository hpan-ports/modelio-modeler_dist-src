...
package org.modelio.diagram.editor.activity.elements.pincontainer;
...
public abstract class GmPinContainer extends GmPortContainer {
    ...
    public GmPinContainer(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    protected Boolean arePinsAutoDisplayed() {
        return getStyle().getProperty(getStyleKeyStrict(MetaKey.AUTOSHOWPINS));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPinContainer." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPinContainer." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
