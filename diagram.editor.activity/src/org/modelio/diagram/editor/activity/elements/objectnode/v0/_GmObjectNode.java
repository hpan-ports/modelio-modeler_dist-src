...
import org.modelio.diagram.editor.activity.elements.objectnode.GmObjectNodeImageStyleKeys;
import org.modelio.diagram.editor.activity.elements.objectnode.GmObjectNodeSimpleStyleKeys;
...
import org.modelio.diagram.editor.activity.elements.objectnode.GmObjectNodeUserImageStyleKeys;
...
public class _GmObjectNode extends GmCompositeNode implements IImageableNode {
    ...
    public _GmObjectNode(GmAbstractDiagram diagram, ObjectNode theObjectNode, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmObjectNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmObjectNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
