...
public class GmInputPin extends GmPortContainer {
    ...
    public GmInputPin(GmAbstractDiagram diagram, InputPin el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInputPin." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInputPin." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2aa922fb-55b6-11e2-877f-002564c97630")
    @Override
