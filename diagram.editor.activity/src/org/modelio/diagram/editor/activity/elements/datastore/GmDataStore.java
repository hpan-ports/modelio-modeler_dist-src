...
public class GmDataStore extends GmPortContainer {
    ...
    public GmDataStore(GmAbstractDiagram diagram, DataStoreNode theDataStore, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDataStore." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDataStore." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2a276fd9-55b6-11e2-877f-002564c97630")
    @Override
    public GmDataStorePrimaryNode getMainNode() {
        return (GmDataStorePrimaryNode) getFirstChild(GmPortContainer.MAIN_NODE_ROLE);
    }
