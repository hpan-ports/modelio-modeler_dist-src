...
public class GmInputBehaviourText extends GmElementText {
    ...
    public GmInputBehaviourText(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInputBehaviourText." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInputBehaviourText." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
