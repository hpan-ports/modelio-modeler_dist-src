...
public class CreatePartitionInPartitionContainerCommand extends Command {
    ...
    private void executeUnmask(final GmAbstractDiagram diagram, ActivityPartition requestedPartition) {
    ...
    private void createAndUnmaskFirstPairOfSubPartitions(final GmAbstractDiagram diagram, ActivityPartition newElement) {
        // Create the Element...
        final IModelFactory modelFactory = diagram.getModelManager().getModelFactory(diagram.getRelatedElement());
        ...
        ModelManager modelManager = diagram.getModelManager();
        final IElementConfigurator elementConfigurer = modelManager.getModelServices().getElementConfigurer();
        elementConfigurer.configure(modelManager.getModelFactory(newElement2), newElement2, this.context.getProperties());
    ...
    private GmCompositeNode unmaskAdditionalChild(final GmAbstractDiagram diagram, ActivityPartition newElement) {
