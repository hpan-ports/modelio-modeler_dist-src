...
public class GmObjectNodeHeader extends GmDefaultModelElementHeader {
    ...
    public GmObjectNodeHeader(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    private StringBuffer getAttributeMultiplicity(final Attribute theAttribute) {
    ...
    private StringBuffer getAssociationEndMultiplicity(final AssociationEnd theAssociationEnd) {
        StringBuffer multiplicity = new StringBuffer();
