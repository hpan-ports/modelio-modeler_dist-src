...
public class GmClause extends GmCompositeNode {
    ...
    public GmClause(GmAbstractDiagram diagram, Clause theClause, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmClause." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmClause." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    public static final class GmTest extends GmElementLabel {
        ...
        public GmTest(GmAbstractDiagram diagram, MRef ref) {
            super(diagram, ref);
        }
