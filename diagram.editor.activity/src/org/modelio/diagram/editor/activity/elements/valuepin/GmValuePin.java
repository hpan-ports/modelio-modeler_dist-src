...
public class GmValuePin extends GmPortContainer {
    ...
    public GmValuePin(GmAbstractDiagram diagram, ValuePin el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmValuePin." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmValuePin." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2b6b3a4a-55b6-11e2-877f-002564c97630")
    @Override
