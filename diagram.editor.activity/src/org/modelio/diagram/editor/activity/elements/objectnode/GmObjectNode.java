...
public class GmObjectNode extends GmPortContainer {
    ...
    public GmObjectNode(GmAbstractDiagram diagram, ObjectNode theObjectNode, MRef ref) {
        super(diagram, ref);
     ...
     */
    @objid ("2ad2559e-55b6-11e2-877f-002564c97630")
    @Override
    public GmObjectNodePrimaryNode getMainNode() {
        return (GmObjectNodePrimaryNode) getFirstChild(GmPortContainer.MAIN_NODE_ROLE);
    }
