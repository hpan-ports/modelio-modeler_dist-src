...
public class GmPartitionParameterContainer extends GmPortContainer {
    ...
    public GmPartitionParameterContainer(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmPartitionParameterContainer." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmPartitionParameterContainer." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2b2c8389-55b6-11e2-877f-002564c97630")
    @Override
