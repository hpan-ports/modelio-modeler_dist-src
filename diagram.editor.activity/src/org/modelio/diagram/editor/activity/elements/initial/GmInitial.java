...
public class GmInitial extends GmPortContainer {
    ...
    public GmInitial(GmAbstractDiagram diagram, InitialNode el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInitial." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInitial." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2a9b6740-55b6-11e2-877f-002564c97630")
    @Override
