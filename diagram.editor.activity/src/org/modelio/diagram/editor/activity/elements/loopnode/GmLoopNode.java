...
public class GmLoopNode extends GmPinContainer {
    ...
    public GmLoopNode(GmAbstractDiagram diagram, LoopNode el, MRef ref) {
        super(diagram, ref);
        this.element = el;
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmLoopNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmLoopNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    private void read_0(IDiagramReader in) {
        super.read(in);
        this.element = (LoopNode) resolveRef(this.getRepresentedRef());
     ...
     */
    @objid ("2abb7273-55b6-11e2-877f-002564c97630")
    @Override
