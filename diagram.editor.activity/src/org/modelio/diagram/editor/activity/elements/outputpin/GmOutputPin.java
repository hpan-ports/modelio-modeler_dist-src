...
public class GmOutputPin extends GmPortContainer {
    ...
    public GmOutputPin(GmAbstractDiagram diagram, OutputPin el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmOutputPin." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmOutputPin." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("2aeabfc4-55b6-11e2-877f-002564c97630")
    @Override
