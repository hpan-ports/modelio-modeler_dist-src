...
public class ActivityDiagramLayoutPolicy extends DiagramEditLayoutPolicy {
     ...
     * </p>
     * <p>
     * If the request is to ADD a partition, return null (do not accept the reparenting of a partition directly on the diagram
     * background: at least a partition container should be used). We have to do this, because ActivityPartition is considered a
    ...
    /**
     * If the request if to create a partition container, return specific command. If the request is to create a sibling partition
     * or to create an inner partition, ignore. Other return the result of super.getCreateCommand().
     */
