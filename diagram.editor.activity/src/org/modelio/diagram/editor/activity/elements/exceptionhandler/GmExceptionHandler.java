...
public class GmExceptionHandler extends GmLink {
    ...
    public GmExceptionHandler(GmAbstractDiagram diagram, ExceptionHandler exceptionhandler, MRef ref) {
        super(diagram, ref);
        this.element = exceptionhandler;
        addExtension(ExtensionLocation.MiddleNW, new GmExceptionHandlerHeader(diagram, ref));
    }
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmExceptionHandler." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
