...
@objid ("1186c273-4b7c-4542-afa7-0b215a98e31b")
public class StandardMetaclassSorter implements Comparator<MObject> {
    /**
     * Defines the standard metaclass order, from top to bottom.
     */
    @objid ("2ae2df2d-5619-49ad-b93b-f8efeb644c31")
    private static final List<java.lang.Class<? extends MObject>> ORDERING = Arrays.asList(TemplateParameter.class, // 0
            ...
            BpmnBehavior.class, // 73
            Transition.class, // 74
            InternalTransition.class // 75
            );

    @objid ("ed6143a7-7aba-4815-b50d-de5a21c83c9d")
    @Override
    public int compare(MObject mo1, MObject mo2) {
        return Integer.compare(-ORDERING.indexOf(mo1.getMClass().getJavaInterface()),
                        -ORDERING.indexOf(mo2.getMClass().getJavaInterface()));
    }
