...
import org.modelio.core.ui.edition.EditorActivationStrategy;
...
import org.modelio.model.browser.views.treeview.sm.SmBrowserContentProvider;
import org.modelio.model.browser.views.treeview.sm.SmBrowserLabelProvider;
...
public class ModelBrowserPanelProvider implements IPanelProvider {
    ...
    @objid ("58e8bcb2-e76b-4c67-a470-da5415c47c4d")
    public boolean isSemanticBrowsing() {
        return this.contentProvider instanceof SmBrowserContentProvider;
    }
    ...
    @objid ("35f2f0b6-82e9-456f-a263-514639921a63")
    public void setSemanticBrowsing(boolean semanticBrowsing) {
        configureTreeviewer(semanticBrowsing);
    ...
    private void configureTreeviewer(boolean semanticBrowsing) {
        // Keep configuration before switching content provider
        if (this.contentProvider != null) {
            boolean showAnalystModel = this.contentProvider.isShowAnalystModel();
            boolean showMdaModel = this.contentProvider.isShowMdaModel();
            boolean showProjects = this.contentProvider.isShowProjects();
            List<Object> localRoots = this.contentProvider.getLocalRoots();
        
            this.contentProvider = semanticBrowsing ? new SmBrowserContentProvider() : new BrowserContentProvider();
        ...
        // Keep configuration before switching label provider
        boolean showVisibility = this.baseProvider != null ? this.baseProvider.isShowVisibility() : true;
        
        this.baseProvider = semanticBrowsing ? new SmBrowserLabelProvider() : new BrowserLabelProvider();
