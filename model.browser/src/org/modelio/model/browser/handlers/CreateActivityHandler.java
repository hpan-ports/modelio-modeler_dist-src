...
public class CreateActivityHandler extends CreateElementHandler {
    ...
    private void smartCreateForClassifier(Activity activity, Classifier parentClassifier) {
    ...
    private void smartCreateForNameSpace(Activity activity) {
        IModelFactory modelFactory = this.mmServices.getModelFactory(activity);
    ...
    private void smartCreateForOperation(Activity activity, Operation parentOperation) {
        IModelFactory modelFactory = this.mmServices.getModelFactory(activity);
