...
public interface ISmMetamodelFragment extends MMetamodelFragment {
    ...
    Collection<SmDependencyTypeChecker> createCheckers(SmMetamodel metamodel);
    ...
    /**
     * Instantiate and initialize the metamodel expert that
     * must be returned by {@link #getMExpert()}.
     * @param mm the metamodel.
     */
    @objid ("a0dd80d3-246a-4a6b-9b36-dd141db63ad1")
    void configureExperts(SmMetamodel mm);
