...
public class FakeSmDependency extends SmMultipleDependency {
    ...
    /**
     * Initialize from a dependency that existed on the metaclass before it was discarded.
     * <p>
     * @param orig a dependency that existed on the metaclass before it becomes fake.
     */
    @objid ("2c6d83d0-0125-4dbd-ba1a-f5a23a2027f5")
    public void initFrom(SmDependency orig) {
        if (! this.copied) {
    ...
    void setSymetric(SmDependency symetric) {
