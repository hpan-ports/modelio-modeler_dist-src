...
public interface IRepositoryObject {
     ...
     * <p>
     * The repository object may choose to unload other objects with the passed one.
     * The returned list should not be modified by the caller and may be read-only.
     * @param obj the object to unload.
     * @return All objects that were unloaded.
     */
    @objid ("c66aaf03-0884-11e2-b33c-001ec947ccaf")
    Collection<SmObjectImpl> unload(SmObjectImpl obj);
