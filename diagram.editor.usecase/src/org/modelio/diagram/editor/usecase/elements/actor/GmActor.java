...
public class GmActor extends GmPortContainer {
    ...
    public GmActor(GmAbstractDiagram diagram, Actor el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmActor." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmActor." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
    ...
    @objid ("5e37e09e-55b7-11e2-877f-002564c97630")
    @Override
