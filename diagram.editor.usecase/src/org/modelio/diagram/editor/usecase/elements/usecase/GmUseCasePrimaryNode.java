...
public class GmUseCasePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmUseCasePrimaryNode(GmAbstractDiagram diagram, MRef ref) {
        super(diagram, ref);
        ...
        this.extensionPointGroup.setRoleInComposition(EXTENSIONS);
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmUseCase.SIMPLEKEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmUseCasePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmUseCasePrimaryNode." + MINOR_VERSION_PROPERTY,
