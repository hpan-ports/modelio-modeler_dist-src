...
public class GmExtensionPointGroup extends GmGroup {
    ...
    public GmExtensionPointGroup(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        boolean styleVisible = getStyle().getProperty(GmUseCaseStructuredStyleKeys.EXTENSIONPOINTGROUPVISIBLE);
    ...
    public void refreshFromObModel() {
        ...
        final StyleKey.UmaskByVisibilityStragegy mode = this.getStyle()
                                                            .getProperty(GmUseCaseStructuredStyleKeys.FEATURES);
        switch (mode) {
            case ALL:
    ...
    protected void doSetVisible(boolean visible) {
        getStyle().setProperty(GmUseCaseStructuredStyleKeys.EXTENSIONPOINTGROUPVISIBLE, visible);
    ...
    protected boolean isValidElement(MObject el) {
        ...
        StyleKey.UmaskByVisibilityStragegy unmaskmode = getStyle().getProperty(GmUseCaseStructuredStyleKeys.FEATURES);
        switch (unmaskmode) {
            case ALL:
                return true;
            case ALL_PUBLIC:
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmExtensionPointGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmExtensionPointGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
