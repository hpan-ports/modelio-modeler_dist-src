...
public class GmSystem extends GmCompositeNode {
    ...
    public GmSystem(final GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmSystem." + MINOR_VERSION_PROPERTY);
    ...
    public boolean isVisible() {
        final boolean isSystemVisible = getStyle().getProperty(GmUseCaseDiagramStyleKeys.SHOW_SYSTEM);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmSystem." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
