...
public final class GmSystemFreeZone extends GmFreeZone {
    ...
    public GmSystemFreeZone(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmSystemFreeZone." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmSystemFreeZone." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
