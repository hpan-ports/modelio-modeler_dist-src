...
public class GmCommunicationLink extends GmAssociation {
    ...
    public GmCommunicationLink(GmAbstractDiagram diagram, AssociationEnd role, MRef roleRef, MRef associationRef) {
        ...
        getStyle().setProperty(GmAssocStructuredStyleKeys.SHOWNAVIGABILITY, false);
    }
    ...
    protected void readLink(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationLink." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationLink." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
