...
public class E222Checker extends DepCardinalityChecker {
    ...
    public void register(final Plan plan, SmMetamodel smMetamodel) {
        ...
        plan.registerChecker(this, smMetamodel.getMClass(AnalystProject.class), TriggerType.Create, null);
        
        // trigger=create, metaclass=AnalystProject, feature=Properties
        plan.registerChecker(this, smMetamodel.getMClass(AnalystProject.class), TriggerType.Update, DEPNAME);
    }
