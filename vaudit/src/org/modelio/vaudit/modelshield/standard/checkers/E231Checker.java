...
public class E231Checker extends DepCardinalityChecker {
    ...
    public void register(final Plan plan) {
        ...
        plan.registerChecker(this, Metamodel.getMClass(RaisedException.class), TriggerType.Create, null);
        
        // trigger=create, metaclass=RaisedException, feature=ThrownType
        plan.registerChecker(this, Metamodel.getMClass(RaisedException.class), TriggerType.Update, DEPNAME);
    }
