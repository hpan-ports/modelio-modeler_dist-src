...
public class E234Checker extends DepCardinalityChecker {
    ...
    public void register(final Plan plan) {
        ...
        plan.registerChecker(this, Metamodel.getMClass(TaggedValue.class), TriggerType.Create, null);
        
        // trigger=create, metaclass=TaggedValue, feature=Definition
        plan.registerChecker(this, Metamodel.getMClass(TaggedValue.class), TriggerType.Update, DEPNAME);
    }
