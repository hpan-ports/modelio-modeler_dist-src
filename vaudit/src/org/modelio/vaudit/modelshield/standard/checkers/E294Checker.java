...
public class E294Checker implements IChecker {
    ...
    public void register(final Plan plan) {
        plan.registerChecker(this, Metamodel.getMClass(Stereotype.class), TriggerType.Update, DEPNAME);
    }
    ...
    public void check(final MObject object, final IErrorReport report) {
        ...
        MClass stereoBase = Metamodel.getMClass(stereo.getBaseClassName());
