...
public class E205Checker implements IChecker {
    ...
    public void register(final Plan plan, SmMetamodel smMetamodel) {
        plan.registerChecker(this, smMetamodel.getMClass(Element.class), TriggerType.Move, null);
        plan.registerChecker(this, smMetamodel.getMClass(Element.class), TriggerType.Create, null);
    }
