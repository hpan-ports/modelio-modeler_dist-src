 ...
 * <li>what = A package import belonging to ''{2}'' is not directed towards a package.</li>
 * </ul>
 */
...
public class E226Checker extends DepCardinalityChecker {
    ...
    public void register(final Plan plan) {
        ...
        plan.registerChecker(this, Metamodel.getMClass(PackageImport.class), TriggerType.Create, null);
        
        // trigger=create, metaclass=PackageImport, feature=ImportedPackage
        plan.registerChecker(this, Metamodel.getMClass(PackageImport.class), TriggerType.Update, DEPNAME);
    }
