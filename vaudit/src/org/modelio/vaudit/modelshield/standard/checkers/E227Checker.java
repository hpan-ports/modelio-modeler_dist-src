...
public class E227Checker extends DepCardinalityChecker {
    ...
    public void register(final Plan plan) {
        ...
        plan.registerChecker(this, Metamodel.getMClass(PackageMerge.class), TriggerType.Create, null);
        
        // trigger=create, metaclass=PackageMerge, feature=MergedPackage
        plan.registerChecker(this, Metamodel.getMClass(PackageMerge.class), TriggerType.Update, DEPNAME);
    }
