...
public class ImportServices {
    ...
    public boolean importEcoreModel(org.eclipse.uml2.uml.Model model, ProgressBarComposite progressBar, Shell shell, IModelingSession session) {
    ...
    private Resource loadModel(final File oldFile, final List<String> oldPatterns, final List<String> newPatterns) {
        ...
        try{
            newFile = updateFile(oldFile, oldPatterns, newPatterns);
