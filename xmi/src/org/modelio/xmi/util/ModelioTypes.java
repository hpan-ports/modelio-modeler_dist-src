...
public class ModelioTypes implements IUMLTypes {
    ...
    public DataType getBOOLEAN() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-0005-0000-000000000000"));
    }

    @objid ("3bcd9c0f-4a0a-44e6-b6c4-485060954877")
    @Override
    public DataType getBYTE() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-0013-0000-000000000000"));
    }

    @objid ("7f2b85b2-029b-44bc-8e8c-75ca549d6c15")
    @Override
    public DataType getCHAR() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-0007-0000-000000000000"));
    }

    @objid ("adc61762-2ba6-4ef5-8b54-4d0fb951d0ed")
    @Override
    public DataType getDATE() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-0014-0000-000000000000"));
    }

    @objid ("cd0f4cc0-dedb-40b9-a856-c0ecc4837c24")
    @Override
    public DataType getDOUBLE() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-0010-0000-000000000000"));
    }

    @objid ("99da8357-08d1-4466-8a08-88771168aa21")
    @Override
    public DataType getFLOAT() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-000b-0000-000000000000"));
    }

    @objid ("0a86c116-df43-4861-a3ad-8d18226b7efa")
    @Override
    public DataType getINTEGER() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-0009-0000-000000000000"));
    }

    @objid ("7414a385-4161-4310-99fe-8375576ed2f7")
    @Override
    public DataType getLONG() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-0011-0000-000000000000"));
    }

    @objid ("feefaa94-ce55-4cf3-8210-7b66180b9d15")
    @Override
    public DataType getSHORT() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass,UUID.fromString("00000004-0000-0012-0000-000000000000"));
    }

    @objid ("fb65a0b6-9143-4fb4-9b17-fe709e6f536c")
    @Override
    public DataType getSTRING() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-000d-0000-000000000000"));
    }

    @objid ("831887af-db6e-4307-a68e-96238bc74209")
    @Override
    public DataType getUNDEFINED() {
        return (DataType) this.mmServices.findById(this.dataTypeMClass, UUID.fromString("00000004-0000-000f-0000-000000000000"));
    }
