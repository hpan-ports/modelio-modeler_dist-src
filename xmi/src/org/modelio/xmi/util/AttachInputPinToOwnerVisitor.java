...
public class AttachInputPinToOwnerVisitor {
    ...
    private InputPinLinker linker = null;

    @objid ("32367d68-f1df-4e71-92cc-7f9aca946f1f")
    private org.modelio.metamodel.uml.behavior.activityModel.InputPin obInputPin = null;

    @objid ("248c7af0-bdbc-44b9-b79c-d26408547278")
    private InputPin inputPin = null;

    @objid ("c69b01a5-18de-428e-a477-0e9abde60509")
    public AttachInputPinToOwnerVisitor() {
        this.linker = new InputPinLinker();
    }
    ...
    class InputPinLinker extends UMLSwitch<Object> {
        ...
        public Object caseAction(org.eclipse.uml2.uml.Action owner) {
            if (!owner.getInputs().contains(inputPin))
                owner.getInputs().add(inputPin);
            return result;
        }
        ...
        public Object caseAddStructuralFeatureValueAction(org.eclipse.uml2.uml.AddStructuralFeatureValueAction owner) {
            if (obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2INSERTAT)){
                if ((owner.getInsertAt() == null ) ||(!owner.getInsertAt().equals(inputPin)))
                    owner.setInsertAt(inputPin);
                        
            }else if ((obInputPin instanceof ValuePin) || (obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2VALUE))){
                        
                if ((owner.getValue() == null ) || (!owner.getValue().equals(inputPin)))
                    owner.setValue(inputPin);
                        
            }else {
                if ((owner.getObject() == null) ||(!owner.getObject().equals(inputPin)))
                    owner.setObject(inputPin);
            }
            return result;
        }
        ...
        public Object caseCallOperationAction(org.eclipse.uml2.uml.CallOperationAction owner) {
            if (obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2TARGET)){
                if ((owner.getTarget() == null ) || (!owner.getTarget().equals(inputPin)))
                    owner.setTarget(inputPin);
            }else{
                        
                owner.getArguments().add(inputPin);
            }
            return result;
        }
        ...
        public Object caseLinkAction(org.eclipse.uml2.uml.LinkAction owner) {
            owner.getInputValues().add(inputPin);
            return result;
        }
        ...
        public Object caseLoopNode(org.eclipse.uml2.uml.LoopNode owner) {
            owner.getLoopVariableInputs().add(inputPin);
            return result;
        }
        ...
        public Object caseRaiseExceptionAction(org.eclipse.uml2.uml.RaiseExceptionAction owner) {
            if ((owner.getException() == null ) || (!owner.getException().equals(inputPin)))
                owner.setException(inputPin);
            return result;
        }
        ...
        public Object caseReduceAction(org.eclipse.uml2.uml.ReduceAction owner) {
            if ((owner.getCollection() == null ) || (!owner.getCollection().equals(inputPin)))
                owner.setCollection(inputPin);
            return result;
        }
        ...
        public Object caseRemoveStructuralFeatureValueAction(org.eclipse.uml2.uml.RemoveStructuralFeatureValueAction owner) {
            if ((owner.getRemoveAt() == null ) || (!owner.getRemoveAt().equals(inputPin)))
                owner.setRemoveAt(inputPin);
            return result;
        }
        ...
        public Object caseReplyAction(org.eclipse.uml2.uml.ReplyAction owner) {
            owner.getReplyValues().add(inputPin);
            return result;
        }
        ...
        public Object caseSendObjectAction(org.eclipse.uml2.uml.SendObjectAction owner) {
            if ((owner.getRequest() == null ) ||(!owner.getRequest().equals(inputPin)))
                owner.setRequest(inputPin);
            return result;
        }
        ...
        public Object caseTestIdentityAction(org.eclipse.uml2.uml.TestIdentityAction owner) {
            if (obInputPin.isStereotyped("ModelerModule",IModelerModuleStereotypes.UML2FIRST)){
                owner.setFirst(inputPin);
            }else if (obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2SECOND)){
                owner.setSecond(inputPin);
            }
            return result;
        }
        ...
        public Object caseWriteStructuralFeatureAction(org.eclipse.uml2.uml.WriteStructuralFeatureAction owner) {
            if (obInputPin instanceof ValuePin){
