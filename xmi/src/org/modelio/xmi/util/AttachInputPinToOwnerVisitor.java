...
public class AttachInputPinToOwnerVisitor {
    ...
    class InputPinLinker extends UMLSwitch<Object> {
        ...
        public Object caseAddStructuralFeatureValueAction(org.eclipse.uml2.uml.AddStructuralFeatureValueAction owner) {
            if (AttachInputPinToOwnerVisitor.this._obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2INSERTAT)){
                if ((owner.getInsertAt() == null ) 
                    ...
                    || (AttachInputPinToOwnerVisitor.this._obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2VALUE))){
        ...
        public Object caseCallOperationAction(org.eclipse.uml2.uml.CallOperationAction owner) {
            if (AttachInputPinToOwnerVisitor.this._obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2TARGET)){
        ...
        public Object caseTestIdentityAction(org.eclipse.uml2.uml.TestIdentityAction owner) {
            if (AttachInputPinToOwnerVisitor.this._obInputPin.isStereotyped("ModelerModule",IModelerModuleStereotypes.UML2FIRST)){
                owner.setFirst(AttachInputPinToOwnerVisitor.this._inputPin);
            }else if (AttachInputPinToOwnerVisitor.this._obInputPin.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2SECOND)){
