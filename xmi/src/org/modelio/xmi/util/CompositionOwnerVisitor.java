...
public class CompositionOwnerVisitor {
    ...
    private class CompositionOwnerSelector extends DefaultModelVisitor {
        ...
        public Object visitActivityNode(ActivityNode child) {
            if (theParent == null)
                theParent = child.getOwner();
                        
            if (theParent == null)
                theParent = child.getOwnerClause();
                        
            if (theParent == null)
                theParent = child.getOwnerNode();
                        
            if (theParent == null)
                theParent = child.getOwnerPartition();
        ...
        public Object visitActivityPartition(ActivityPartition child) {
            if (theParent == null)
                theParent = child.getSuperPartition();
        ...
        public Object visitBehavior(Behavior child) {
            ...
            if (theParent == null)
                theParent = child.getOwnerOperation();
        ...
        public Object visitBindableInstance(BindableInstance child) {
            if (theParent == null)
                theParent = child.getCluster();
                        
            if (theParent == null)
                theParent = child.getInternalOwner();
        ...
        public Object visitClassAssociation(ClassAssociation child) {
            if (theParent == null)
                theParent = child.getAssociationPart();
        ...
        public Object visitCollaboration(Collaboration child) {
            if (theParent == null)
                theParent = child.getBRepresented();
                        
            if (theParent == null)
                theParent = child.getORepresented();
        ...
        public Object visitCollaborationUse(CollaborationUse child) {
            if (theParent == null)
                theParent = child.getNRepresented();
        ...
        public Object visitCommunicationMessage(CommunicationMessage child) {
            if (theParent == null)
                theParent = child.getChannel();
                        
            if (theParent == null)
                theParent = child.getInvertedChannel();
        ...
        public Object visitConstraint(Constraint child) {
            //                        if (theParent == null)
            //                            theParent = child.getConstrainedElements().add();
        ...
        public Object visitElementImport(ElementImport child) {
            if (theParent == null)
                theParent = child.getImportingNameSpace();
                        
            if (theParent == null)
                theParent = child.getImportingOperation();
        ...
        public Object visitEntryPointPseudoState(EntryPointPseudoState child) {
            if (theParent == null)
                theParent = child.getEntryOf();
            
            if (theParent == null)
                theParent = child.getEntryOfMachine();
        ...
        public Object visitExitPointPseudoState(ExitPointPseudoState child) {
            if (theParent == null)
                theParent = child.getExitOf();
            
            if (theParent == null)
                theParent = child.getExitOfMachine();
        ...
        public Object visitFeature(Feature child) {
            if (theParent == null)
                theParent = child.getCompositionOwner();
        ...
        public Object visitGate(Gate child) {
            if (theParent == null)
                theParent = child.getOwnerFragment();
                        
            if (theParent == null)
                theParent = child.getOwnerInteraction();
                        
            if (theParent == null)
                theParent = child.getOwnerUse();
        ...
        public Object visitInteractionFragment(InteractionFragment child) {
            if (theParent == null)
                theParent = child.getEnclosingInteraction();
                        
            if (theParent == null)
                theParent = child.getEnclosingOperand();
        ...
        public Object visitInterfaceRealization(InterfaceRealization child) {
            if (theParent == null)
                theParent = child.getImplementer();
        ...
        public Object visitMessageFlow(MessageFlow child) {
            if (theParent == null)
                theParent = child.getSourcePartition();
        ...
        public Object visitModelElement(ModelElement child) {
            if (theParent == null)
                theParent = child.getOwnerTemplateParameter();
        ...
        public Object visitPackageMerge(PackageMerge child) {
            if (theParent == null)
                theParent = child.getReceivingPackage();
        ...
        public Object visitSubstitution(Substitution child) {
            if (theParent == null)
                theParent = child.getSubstitutingClassifier();
        ...
        public Object visitTemplateBinding(TemplateBinding child) {
            if (theParent == null)
                theParent = child.getBoundElement();
                        
            if (theParent == null)
                theParent = child.getBoundOperation();
        ...
        public Object visitTemplateParameter(TemplateParameter child) {
            if (theParent == null)
                theParent = child.getParameterized();
                        
            if (theParent == null)
                theParent = child.getParameterizedOperation();
