...
public class EChangeEvent extends ENamedElement implements IEElement {
    ...
    @objid ("d90028f2-1ad1-4f87-b844-30310bf4d1f8")
    ...
    private void setExpression(Event objingElt) {
        org.eclipse.uml2.uml.ValueSpecification value = ecoreElement.getChangeExpression();
