...
public class ESignal extends ENamedElement implements IEElement {
    ...
    @objid ("ca88beae-a73d-4dc4-a3ea-40743b965376")
    ...
    private void setBaseEAnnotation(Signal objingElt) {
        for (Object attribut : ecoreElement.getOwnedAttributes()){
            if (attribut instanceof Property){
                ...
                if ((property.getName().equals(ObjingEAnnotation.IS_BASE))&&(ObjingEAnnotation.isBase(property))){
                    //                    objingElt.setBase((GeneralClass) ReverseProperties.getInstance().getMappedElement(property.getType()));
    ...
    private void setIsEventEAnnotation(Signal objingElt) {
        objingElt.setIsEvent(ObjingEAnnotation.isEvent((ecoreElement)));
    }

    @objid ("cb5ceebf-6cb4-48eb-998c-d83232e885a5")
    private void setIsExceptionEAnnotation(Signal objingElt) {
        objingElt.setIsException(ObjingEAnnotation.isException((ecoreElement)));
    }
