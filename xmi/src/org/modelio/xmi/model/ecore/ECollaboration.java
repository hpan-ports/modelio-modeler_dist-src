...
public class ECollaboration extends ENamedElement implements IEElement {
    @objid ("3360dd2a-a073-49f0-a861-78cd1cd82364")
    private org.eclipse.uml2.uml.Collaboration ecoreElement;
    ...
    @objid ("0f4ecbd0-062b-4694-b051-2db971269203")
    ...
    private void setConcurrentEAnnotation(Collaboration objingElt) {
        objingElt.setIsConcurrent(ObjingEAnnotation.isConcurrent(ecoreElement));
    }
