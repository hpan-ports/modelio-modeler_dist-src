...
public class EInclude extends ENamedElement implements IEElement {
    @objid ("694cb544-2058-46f1-8abe-9fb65d66a2fa")
    private org.eclipse.uml2.uml.Include ecoreElement;
    ...
    public void attach(Element objingElt) {
        ...
        if (objingTarget != null && objingOrigin != null) {
            ...
            IMetamodelExtensions include = Modelio.getInstance()
                    .getModelingSession().getMetamodelExtensions();
        
            Stereotype extendStereo = include.getStereotype(
                    Xmi.I18N.getString("objing.java.stereotype.include"), objingUseCaseDependency.getMClass());
            objingUseCaseDependency.getExtension().add(extendStereo);
        
        }
    }

    @objid ("76b61693-80b4-4f15-95de-0f1345d94013")
    @Override
