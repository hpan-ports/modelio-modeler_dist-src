...
public class OEvent extends OModelElement {
    ...
    public org.eclipse.uml2.uml.Element createEcoreElt() {
        ...
        if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CREATIONEVENT)){
            return UMLFactory.eINSTANCE.createCreationEvent();
        }else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DESTRUCTIONEVENT)){
            return UMLFactory.eINSTANCE.createDestructionEvent();
        }else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2EXECUTIONEVENT)){
