...
public class OEvent extends OModelElement {
    ...
    public org.eclipse.uml2.uml.Element createEcoreElt() {
        ...
        if (this.objingElement.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CREATIONEVENT)){
            return UMLFactory.eINSTANCE.createCreationEvent();
        }else if (this.objingElement.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DESTRUCTIONEVENT)){
            return UMLFactory.eINSTANCE.createDestructionEvent();
        }else if (this.objingElement.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2EXECUTIONEVENT)){
