...
public class OOpaqueAction extends OActivityNode {
    ...
    public org.eclipse.uml2.uml.Element createEcoreElt() {
        if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2VALUESPECIFICATIONACTION))
            return UMLFactory.eINSTANCE.createValueSpecificationAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CREATEOBJECTACTION))
            return UMLFactory.eINSTANCE.createCreateObjectAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CREATELINKACTION))
            return UMLFactory.eINSTANCE.createCreateLinkAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READLINKACTION))
            return UMLFactory.eINSTANCE.createReadLinkAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DESTROYLINKACTION))
            return UMLFactory.eINSTANCE.createDestroyLinkAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CLEARASSOCIATIONACTION))
            return UMLFactory.eINSTANCE.createClearAssociationAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2ADDSTRUCTURALFEATUREVALUEACTION))
            return UMLFactory.eINSTANCE.createAddStructuralFeatureValueAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READSTRUCTURALFEATUREACTION))
            return UMLFactory.eINSTANCE.createReadStructuralFeatureAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READEXTENTACTION))
            return UMLFactory.eINSTANCE.createReadExtentAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DESTROYOBJECTACTION))
            return UMLFactory.eINSTANCE.createDestroyObjectAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2ADDVARIABLEVALUEACTION))
            return UMLFactory.eINSTANCE.createAddVariableValueAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CLEARSTRUCTURALFEATUREACTION))
            return UMLFactory.eINSTANCE.createClearStructuralFeatureAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CLEARVARIABLEACTION))
            return UMLFactory.eINSTANCE.createClearVariableAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2RAISEEXCEPTIONACTION))
            return UMLFactory.eINSTANCE.createRaiseExceptionAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READISCLASSIFIEROBJECTACTION))
            return UMLFactory.eINSTANCE.createReadIsClassifiedObjectAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READLINKOBJECTENDACTION))
            return UMLFactory.eINSTANCE.createReadLinkObjectEndAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READLINKOBJECTENDQUALIFIERACTION))
            return UMLFactory.eINSTANCE.createReadLinkObjectEndQualifierAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READSELFACTION))
            return UMLFactory.eINSTANCE.createReadSelfAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READVARIABLEACTION))
            return UMLFactory.eINSTANCE.createReadVariableAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2RECLASSIFYOBJECTACTION))
            return UMLFactory.eINSTANCE.createReclassifyObjectAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REDUCEACTION))
            return UMLFactory.eINSTANCE.createReduceAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REMOVESTRUCTURALFEATUREACTION))
            return UMLFactory.eINSTANCE.createRemoveStructuralFeatureValueAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REMOVEVARIABLEVALUEACTION))
            return UMLFactory.eINSTANCE.createRemoveVariableValueAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REPLYACTION))
            return UMLFactory.eINSTANCE.createReplyAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2SENDOBJECTACTION))
            return UMLFactory.eINSTANCE.createSendObjectAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2STARTCLASSIFIERBEHAVIORACTION))
            return UMLFactory.eINSTANCE.createStartClassifierBehaviorAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2TESTIDENTITYACTION))
            return UMLFactory.eINSTANCE.createTestIdentityAction();
        else if (getObjingElement().isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2UNMARSHALLACTION))
