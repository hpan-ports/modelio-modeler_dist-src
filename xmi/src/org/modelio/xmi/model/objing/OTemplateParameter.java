...
public class OTemplateParameter extends ONameSpace {
    ...
    public org.eclipse.uml2.uml.Element createEcoreElt() {
        if (((ModelElement) getObjingElement()).isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CONNECTABLEELEMENTTEMPLATEPARAMETER)){
            return UMLFactory.eINSTANCE.createConnectableElementTemplateParameter();
        }else  if (((ModelElement) getObjingElement()).isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CLASSIFIERTEMPLATEPARAMETER)){
