...
public class OExtensionPoint extends OModelElement implements IOElement {
    ...
    public void attach(org.eclipse.uml2.uml.Element ecoreElt) {
        ...
        UseCase objingOwner = objingElement.getOwner();
        ...
        if (ecoreOwner != null) {
            ((org.eclipse.uml2.uml.ExtensionPoint) currentExtensionPoint).setUseCase(ecoreOwner);
        }
    }
    ...
    private void setUseCaseDependency(org.eclipse.uml2.uml.ExtensionPoint point) {
        GenerationProperties genProp = GenerationProperties.getInstance();
        List<UseCaseDependency> objingUseCaseDepElts = objingElement
                .getExtended();
        for (UseCaseDependency objingUseCaseDepElt : objingUseCaseDepElts) {
            org.eclipse.uml2.uml.Element ecoreUseCaseDep = (org.eclipse.uml2.uml.Element) genProp
