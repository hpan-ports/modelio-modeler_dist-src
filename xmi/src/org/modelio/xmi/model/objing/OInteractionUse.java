...
public class OInteractionUse extends OInteractionFragment implements IOElement {
    ...
    private void setInteraction(org.eclipse.uml2.uml.InteractionUse ecoreElt) {
        ...
        if (objingInteractionRef != null) {
            ...
            if ((ecoreInteraction instanceof org.eclipse.uml2.uml.Interaction) && (ecoreInteraction != null))
    ...
    private void setActualGates(org.eclipse.uml2.uml.InteractionUse ecoreElt) {
        ...
        for (Gate objingGate : objiingGateListe) {
            ...
            if ((ecoreFormalGate instanceof org.eclipse.uml2.uml.Gate) && (ecoreFormalGate != null))
