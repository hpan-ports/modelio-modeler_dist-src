...
public class OOperation extends OFeature {
    ...
    public org.eclipse.uml2.uml.Element createEcoreElt() {
        ...
        }else if (((ModelElement) getObjingElement()).isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REDEFINABLETEMPLATESIGNATURE)){
            return UMLFactory.eINSTANCE.createRedefinableTemplateSignature();
        }else if (((ModelElement) getObjingElement()).isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2TEMPLATESIGNATURE)){
