...
public class OInformationFlow extends OModelElement implements IOElement {
    ...
    public void attach(org.eclipse.uml2.uml.Element ecoreElt) {
        NameSpace objingOwner = objingElement.getOwner();
    ...
    private void setInformationSource(org.eclipse.uml2.uml.InformationFlow flow) {
        for (ModelElement objingSource : objingElement.getInformationSource()) {
            org.eclipse.uml2.uml.Element ecoreSource = genProp.getMappedElement(objingSource);
    ...
    private void setInformationTarget(org.eclipse.uml2.uml.InformationFlow flow) {
        for (ModelElement objingTarget : objingElement.getInformationTarget()) {
            org.eclipse.uml2.uml.Element ecoreTarget = genProp.getMappedElement(objingTarget);
    ...
    private void setRealizingMessage(org.eclipse.uml2.uml.InformationFlow flow) {
        for (Message objingMsg : objingElement.getRealizingMessage()) {
            org.eclipse.uml2.uml.Element ecoreMsg = genProp.getMappedElement(objingMsg);
    ...
    private void setRealizingActivityEdge(org.eclipse.uml2.uml.InformationFlow flow) {
        for (ActivityEdge objingEdge : objingElement.getRealizingActivityEdge()) {
            org.eclipse.uml2.uml.Element ecoreEdge = genProp.getMappedElement(objingEdge);
    ...
    private void setConveyed(org.eclipse.uml2.uml.InformationFlow flow) {
        for (Classifier objingConveyed : objingElement.getConveyed()) {
            org.eclipse.uml2.uml.Element ecoreConveyed = genProp.getMappedElement(objingConveyed);
    ...
    private void setRealization(org.eclipse.uml2.uml.InformationFlow flow) {
        Association realizingAssoc = objingElement.getChannel().getAssociation();
        org.eclipse.uml2.uml.Element realization = genProp.getMappedElement(realizingAssoc);
