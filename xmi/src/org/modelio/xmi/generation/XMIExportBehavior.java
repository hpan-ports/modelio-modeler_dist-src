...
public class XMIExportBehavior implements IParseModelBehavior {
    ...
    public XMIExportBehavior(ProgressBarComposite progressBar) {
    ...
    @Override
    public void visitActor(Actor param) {
        OActor element = new OActor(param);
        this.exportModel.export(element);
    }

    @objid ("aa4d2453-e611-49f3-854d-8de0d3f830f6")
    public void visitArtifact(Artifact param) {
    ...
    @Override
    public void visitAssociation(Association param) {
    ...
    @Override
    public void visitAssociationEnd(AssociationEnd param) {
    ...
    @Override
    public void visitBpmnBaseElement(BpmnBaseElement param) {
    ...
    @Override
    public void visitEnumeration(Enumeration param) {
    ...
    @Override
    public void visitExceptionHandler(ExceptionHandler param) {
        OExceptionHandler element = new OExceptionHandler(param);
        this.exportModel.export(element);
    }

    @objid ("268fcb20-e625-4958-91e3-5d1beffb22c5")
    public void visitExecutionOccurenceSpecification(ExecutionOccurenceSpecification param) {
    ...
    public void visitExecutionSpecification(ExecutionSpecification param) {
        OExecutionSpecification element = new OExecutionSpecification(param);
        this.exportModel.export(element);
    }

    @objid ("c67f25a2-3105-4e29-bedc-872ae12a8372")
    public void visitExitPointPseudoState(ExitPointPseudoState param) {
    ...
    @Override
    public void visitExpansionNode(ExpansionNode param) {
    ...
    @Override
    public void visitOperation(Operation param) {
        OOperation element = new OOperation(param);
        this.exportModel.export(element);
    }

    @objid ("324486c6-2bef-4669-bedc-6ee0f352e909")
    public void visitOutputPin(OutputPin param) {
    ...
    @Override
    public void visitRaisedException(RaisedException param) {
