...
public class PartialCreationExportVisitor {
    ...
    private class CreationExportMapper extends DefaultModelVisitor {
        ...
        public Object visitArtifact(Artifact objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DEPLOYMENTSPECIFICATION)){
        ...
        public Object visitAssociation(Association objingElt) {
            if (ObjingModelNavigation.isIsClassAssociation(objingElt)) {
                ...
                if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2COMMUNICATIONPATH)){
                    PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createCommunicationPath();
                }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2EXTENSION)){
        ...
        public Object visitAssociationEnd(AssociationEnd objingElt) {
            ...
            if (! ObjingModelNavigation.isOwnedByActor(assoc)) {
                if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2EXTENSIONEND)){
        ...
        public Object visitBindableInstance(BindableInstance objingElt) {
            MObject root = ObjingModelNavigation.getBindableInstanceOwner(objingElt);
        ...
        public Object visitConnector(Connector objingElt) {
            MObject root = ObjingModelNavigation.getConnectorOwner(objingElt);
        ...
        public Object visitDecisionMergeNode(DecisionMergeNode objingElt) {
            ...
            if (ObjingModelNavigation.isMergeNode(objingElt))
                isMergeNode = true;
            else if (ObjingModelNavigation.isDecisionNode(objingElt))
                isDecisionNode = true;
        ...
        public Object visitDependency(Dependency objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2ASSOCIATIONREFERENCE) 
                ...
                PartialCreationExportVisitor.this.ecoreElt = null;
            }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2COMPONENTREALIZATION)){
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createComponentRealization();
            }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DEPLOYMENT)){
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createDeployment();
            }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2PROTOCOLCONFORMANCE)){
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createProtocolConformance();
            }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.SATISFY)
                    ||objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.VERIFY)
                    ||objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.DERIVE)
                    ||objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2ABSTRACTION)){
                PartialCreationExportVisitor.this.ecoreElt =  UMLFactory.eINSTANCE.createAbstraction();
            }else{
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createDependency();
            }
        ...
        public Object visitEvent(Event objingElt) {
            ...
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CREATIONEVENT)){
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createCreationEvent();
            }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DESTRUCTIONEVENT)){
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createDestructionEvent();
            }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2EXECUTIONEVENT)){
        ...
        public Object visitForkJoinNode(ForkJoinNode objingElt) {
            ...
            if (ObjingModelNavigation.isJoinNode(objingElt))
                isJoinNode = true;
            else if (ObjingModelNavigation.isForkNode(objingElt))
                isForkNode = true;
        ...
        public Object visitInputPin(InputPin objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2ACTIONINPUTPIN))
        ...
        public Object visitInstanceNode(InstanceNode objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2VARIABLE))
        ...
        public Object visitLifeline(Lifeline objingElt) {
            PartialCreationExportVisitor.this.ecoreElt = ecoreElt = UMLFactory.eINSTANCE.createLifeline();
            return null;
        }
        ...
        public Object visitLink(Link objingElt) {
            Element linkOwner = ObjingModelNavigation.getLinkOwner(objingElt);
            MObject connectorOwner = ObjingModelNavigation.getConnectorOwner(objingElt);
        ...
        public Object visitManifestation(Manifestation objingElt) {
            if (ObjingModelNavigation.isManifestationMappable(objingElt))
        ...
        public Object visitNode(Node objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DEVICE))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createDevice();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2EXECUTIONENVIRONMENT))
        ...
        public Object visitOpaqueAction(OpaqueAction objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2VALUESPECIFICATIONACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createValueSpecificationAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CREATEOBJECTACTION))
            ...
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READLINKACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReadLinkAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2DESTROYLINKACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createDestroyLinkAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CLEARASSOCIATIONACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createClearAssociationAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2ADDSTRUCTURALFEATUREVALUEACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createAddStructuralFeatureValueAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READSTRUCTURALFEATUREACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReadStructuralFeatureAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READEXTENTACTION))
            ...
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CLEARVARIABLEACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createClearVariableAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2RAISEEXCEPTIONACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createRaiseExceptionAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READISCLASSIFIEROBJECTACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReadIsClassifiedObjectAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READLINKOBJECTENDACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReadLinkObjectEndAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READLINKOBJECTENDQUALIFIERACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReadLinkObjectEndQualifierAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READSELFACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReadSelfAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2READVARIABLEACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReadVariableAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2RECLASSIFYOBJECTACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReclassifyObjectAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REDUCEACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReduceAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REMOVESTRUCTURALFEATUREACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createRemoveStructuralFeatureValueAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REMOVEVARIABLEVALUEACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createRemoveVariableValueAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REPLYACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReplyAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2SENDOBJECTACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createSendObjectAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2STARTCLASSIFIERBEHAVIORACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createStartClassifierBehaviorAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2TESTIDENTITYACTION))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createTestIdentityAction();
            else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2UNMARSHALLACTION))
        ...
        public Object visitOperation(Operation objingElt) {
            ...
            if (objingOwner instanceof Actor
                ...
                if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2RECEPTION)){
                    PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createReception();
                }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2REDEFINABLETEMPLATESIGNATURE)){
                    PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createRedefinableTemplateSignature();
                }else if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2TEMPLATESIGNATURE)){
        ...
        public Object visitParameter(Parameter objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CLASSIFIERTEMPLATEPARAMETER))
        ...
        public Object visitPort(Port objingElt) {
            MObject objOwner = ObjingModelNavigation.getBindableInstanceOwner(objingElt);
        ...
        public Object visitStructuredActivityNode(StructuredActivityNode objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2SEQUENCENODE))
        ...
        public Object visitTemplateParameter(TemplateParameter objingElt) {
            if (objingElt.isStereotyped("ModelerModule", IModelerModuleStereotypes.UML2CONNECTABLEELEMENTTEMPLATEPARAMETER)){
        ...
        public Object visitTransition(Transition objingElt) {
            if (!( objingElt instanceof InternalTransition)){
                if (ObjingModelNavigation.isProtocolTransition(objingElt))
        ...
        public Object visitUseCaseDependency(UseCaseDependency objingElt) {
            if (ObjingModelNavigation.isStereotyped(objingElt, Xmi.I18N
                    .getString("objing.java.stereotype.extend")))
                PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createExtend();
            else if (ObjingModelNavigation.isStereotyped(objingElt, Xmi.I18N
