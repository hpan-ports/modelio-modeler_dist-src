...
public class SwtWinOOoBean extends Composite {
            ...
            Thread aConnectorThread = new Thread() {
                ...
                public void run() {
                    com.sun.star.lang.XMultiComponentFactory aFactory = iConn.getComponentContext()
                                                                             .getServiceManager();
                    SwtWinOOoBean.this.xServiceFactory = UnoRuntime.queryInterface(com.sun.star.lang.XMultiServiceFactory.class,
                                                                             aFactory);
                }
            };
    ...
    private synchronized void clear() {
        ...
        try {
            ...
            if (xCloseable != null) {
                try {
                    UnoCaller.call(this.iConnection.getComponentContext(), new Callable<Boolean>() {
                        @Override
    ...
    public void storeToURL(final String aURL, final com.sun.star.beans.PropertyValue[] aArguments) throws NoDocumentException, NoConnectionException, IOException, IllegalArgumentException {
        ...
        try {
            ...
            final Callable<Object> r = new Callable<Object>() {
            ...
            // store the document
            UnoCaller.call(getComponentContext(), r);
        ...
        if (this.aFrame != null) {
            if (this.bIgnoreVisibility || bOldValue != bNewValue) {
                ...
                try {
                    ...
                    UnoCaller.call(getComponentContext(), new Callable<Object>() {
                        @Override
                        public Object call() throws Exception {
                            try {
    ...
    private com.sun.star.lang.XComponent callLoadComponentFromUrl(final String aURL, final com.sun.star.frame.XComponentLoader xLoader, final com.sun.star.beans.PropertyValue[] aArgs) throws IllegalArgumentException, java.io.IOException {
        try {
            return UnoCaller.call(getComponentContext(), new Callable<com.sun.star.lang.XComponent>() {
                @Override
                public XComponent call() throws Exception {
                    ...
                    try {
                        ...
                        if (e.getMessage().contains("URL seems to be an unsupported one." ) ||
                                e.getMessage().contains("Unsupported URL")) {
    ...
    private void initSWTOfficeWindow() throws NoConnectionException {
        ...
        getDisplay().syncExec(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    SwtWinOOoBean.this.swtFrameWindow = new SwtWinOfficeWindow(getOOoConnection(), SwtWinOOoBean.this) ;
                } catch (NoConnectionException e) {
