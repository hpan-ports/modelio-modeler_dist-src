...
public class LocalOfficeConnection implements OfficeConnection {
    ...
    @objid ("b0d37ef1-dee3-4c0c-8457-693fa3d05734")
    ...
    private List<XEventListener> mComponents = new Vector<XEventListener>();
    ...
    private class OfficeService implements NativeService {
        ...
        public void startupService() throws IOException {
            ...
            List<String> cmdArray = new ArrayList<String>(nSizeCmdArray);
