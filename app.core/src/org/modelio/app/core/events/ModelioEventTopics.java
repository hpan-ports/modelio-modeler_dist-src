...
/**
 * These constants define the available topics for listening to Modelio events. See the associated enumeration ModelioEvent for each
 * topic documentation and semantics.
 * 
 * @author phv
 */
