...
public class GmFinalState extends GmPortContainer {
    ...
    public GmFinalState(GmAbstractDiagram diagram, FinalState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmFinalState." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmFinalState." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f5286e50-55b6-11e2-877f-002564c97630")
    @Override
