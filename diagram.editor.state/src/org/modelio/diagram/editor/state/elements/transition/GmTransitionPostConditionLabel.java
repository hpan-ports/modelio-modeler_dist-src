...
public class GmTransitionPostConditionLabel extends GmElementLabel {
    ...
    public GmTransitionPostConditionLabel(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        return getStyle().getProperty(GmTransitionStyleKeys.POSTCONDITIONVISIBLE);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmTransitionPostConditionLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmTransitionPostConditionLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
