...
public class JoinPrimaryNodeEditPart extends GmNodeEditPart {
    ...
    protected void refreshFromStyle(IFigure aFigure, IStyle style) {
        if (aFigure instanceof RectangularFigure) {
            if (!switchRepresentationMode()) {
                ...
                final ForkJoinOrientation orientation = (ForkJoinOrientation) model.getStyle()
                                                                                   .getProperty(GmJoinStructuredStyleKeys.ORIENTATION);
                if (this.currentOrientation == null) {
                    this.currentOrientation = orientation;
                } else if (orientation != null && !this.currentOrientation.equals(orientation)) {
