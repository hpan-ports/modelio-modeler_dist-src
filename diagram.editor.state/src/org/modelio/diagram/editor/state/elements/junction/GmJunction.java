...
public class GmJunction extends GmPortContainer {
    ...
    public GmJunction(GmAbstractDiagram diagram, JunctionPseudoState el, MRef ref) {
        super(diagram,ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmJunction." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmJunction." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f55f5cd4-55b6-11e2-877f-002564c97630")
    @Override
