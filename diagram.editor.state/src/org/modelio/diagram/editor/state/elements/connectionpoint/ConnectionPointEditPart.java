...
import org.modelio.diagram.editor.state.elements.connectionpoint.ConnectionPointFigure.ReferencedConnectionPoint;
...
public class ConnectionPointEditPart extends GmNodeEditPart implements IPortEditPart {
    ...
    protected void refreshVisuals() {
        GmModel model = (GmModel) this.getModel();
