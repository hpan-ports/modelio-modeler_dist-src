...
public class GmChoice extends GmPortContainer {
    ...
    public GmChoice(GmAbstractDiagram diagram, ChoicePseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmChoice." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmChoice." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f4f3063a-55b6-11e2-877f-002564c97630")
    @Override
