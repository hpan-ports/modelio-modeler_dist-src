...
public class GmFinalStatePrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmFinalStatePrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmFinalState.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmFinalStatePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmFinalStatePrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
