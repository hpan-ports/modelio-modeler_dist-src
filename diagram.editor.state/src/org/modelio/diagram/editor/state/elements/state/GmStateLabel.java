...
public class GmStateLabel extends GmDefaultModelElementHeader {
    ...
    public GmStateLabel(final GmAbstractDiagram diagram, final MRef ref) {
        super(diagram, ref);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmStateLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmStateLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
