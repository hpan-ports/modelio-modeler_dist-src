...
public class GmDeepHistoryPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmDeepHistoryPrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmDeepHistory.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDeepHistoryPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDeepHistoryPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
