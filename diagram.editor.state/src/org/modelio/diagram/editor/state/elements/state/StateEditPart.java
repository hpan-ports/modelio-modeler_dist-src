...
public class StateEditPart extends GmNodeEditPart {
    ...
    public StateEditPart() {
        ...
        this.label.setIcon(compositeIcon);
...

{
        ...
        compositeIcon = AbstractUIPlugin.imageDescriptorFromPlugin(DiagramEditorState.PLUGIN_ID,
