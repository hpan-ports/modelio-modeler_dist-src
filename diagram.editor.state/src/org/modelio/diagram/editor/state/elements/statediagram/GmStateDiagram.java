...
public class GmStateDiagram extends GmAbstractDiagram {
    ...
    public GmStateDiagram(ModelManager manager, StateMachineDiagram theStateDiagram, MRef diagramRef) {
     ...
     */
    @objid ("f58d2392-55b6-11e2-877f-002564c97630")
    public GmStateDiagram() {
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmStateDiagram." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmStateDiagram." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
