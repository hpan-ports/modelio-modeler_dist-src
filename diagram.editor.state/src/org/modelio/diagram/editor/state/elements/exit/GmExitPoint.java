...
public class GmExitPoint extends GmPortContainer {
    ...
    public GmExitPoint(GmAbstractDiagram diagram, ExitPointPseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmExitPoint." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmExitPoint." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f51c3940-55b6-11e2-877f-002564c97630")
    @Override
