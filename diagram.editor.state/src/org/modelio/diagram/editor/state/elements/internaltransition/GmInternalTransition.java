...
public class GmInternalTransition extends GmModelElementLabel {
    ...
    public GmInternalTransition(GmAbstractDiagram diagram, InternalTransition theInternalTransition, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInternalTransition." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInternalTransition." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
