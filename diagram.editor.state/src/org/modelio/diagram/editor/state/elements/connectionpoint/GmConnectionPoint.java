...
public class GmConnectionPoint extends GmPortContainer {
    ...
    public GmConnectionPoint(GmAbstractDiagram diagram, ConnectionPointReference el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmConnectionPoint." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConnectionPoint." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f4fdb49e-55b6-11e2-877f-002564c97630")
    @Override
