...
public class GmDeepHistory extends GmPortContainer {
    ...
    public GmDeepHistory(GmAbstractDiagram diagram, DeepHistoryPseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmDeepHistory." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmDeepHistory." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f506dc70-55b6-11e2-877f-002564c97630")
    @Override
