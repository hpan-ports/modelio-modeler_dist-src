...
public class GmInitialState extends GmPortContainer {
    ...
    public GmInitialState(GmAbstractDiagram diagram, InitialPseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmInitialState." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmInitialState." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f5456c0a-55b6-11e2-877f-002564c97630")
    @Override
