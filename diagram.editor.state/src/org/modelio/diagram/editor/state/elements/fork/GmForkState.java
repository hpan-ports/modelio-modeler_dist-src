...
public class GmForkState extends GmPortContainer {
    ...
    public GmForkState(GmAbstractDiagram diagram, ForkPseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmForkState." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmForkState." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f5331c9b-55b6-11e2-877f-002564c97630")
    @Override
