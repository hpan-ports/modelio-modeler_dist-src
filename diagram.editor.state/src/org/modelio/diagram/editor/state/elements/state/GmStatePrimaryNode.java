...
public class GmStatePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmStatePrimaryNode(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmState.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmStatePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public List<GmNodeModel> getVisibleChildren() {
        ...
        default: {
            ...
            if (!getStyle().getBoolean(GmStateStructuredStyleKeys.SHOWINNER)) {
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmStatePrimaryNode." + MINOR_VERSION_PROPERTY,
