...
public class GmConnectionPointPrimaryNode extends GmNoStyleSimpleNode implements IImageableNode {
    ...
    public GmConnectionPointPrimaryNode(GmAbstractDiagram diagram, MRef ref) {
        super(diagram, ref);
    }
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmConnectionPoint.STRUCTURED_KEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmConnectionPointPrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmConnectionPointPrimaryNode." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
