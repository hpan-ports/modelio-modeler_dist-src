...
public class GmTransitionGuardLabel extends GmElementLabel {
    ...
    public GmTransitionGuardLabel(GmAbstractDiagram diagram, MRef relatedRef) {
    ...
    public boolean isVisible() {
        return getStyle().getProperty(GmTransitionStyleKeys.GUARDVISIBLE);
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmTransitionGuardLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmTransitionGuardLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
