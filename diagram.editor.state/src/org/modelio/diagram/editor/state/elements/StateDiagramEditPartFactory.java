...
public class StateDiagramEditPartFactory implements EditPartFactory {
    @objid ("f5933e20-55b6-11e2-877f-002564c97630")
    private static final StateDiagramEditPartFactory INSTANCE = new StateDiagramEditPartFactory();
     ...
     * @return the instance.
     */
    @objid ("f594c480-55b6-11e2-877f-002564c97630")
    public static EditPartFactory getInstance() {
        return INSTANCE;
    }

    @objid ("f594c485-55b6-11e2-877f-002564c97630")
    private StateDiagramEditPartFactory() {
    ...
    public class StructuredModeEditPartFactory implements EditPartFactory {
        ...
        public EditPart createEditPart(EditPart context, Object model) {
            ...
            if (model.getClass() == GmStateDiagramView.class) {
