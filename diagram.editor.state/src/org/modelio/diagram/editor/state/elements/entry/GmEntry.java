...
public class GmEntry extends GmPortContainer {
    ...
    public GmEntry(GmAbstractDiagram diagram, EntryPointPseudoState el, MRef ref) {
        super(diagram,ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmEntry." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmEntry." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f5118ab9-55b6-11e2-877f-002564c97630")
    @Override
