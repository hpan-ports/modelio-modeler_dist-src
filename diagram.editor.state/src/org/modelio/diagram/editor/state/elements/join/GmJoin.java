...
public class GmJoin extends GmPortContainer {
    ...
    public GmJoin(GmAbstractDiagram diagram, JoinPseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmJoin." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmJoin." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f554ae49-55b6-11e2-877f-002564c97630")
    @Override
