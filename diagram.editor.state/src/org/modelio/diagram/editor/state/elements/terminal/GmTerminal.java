...
public class GmTerminal extends GmPortContainer {
    ...
    public GmTerminal(GmAbstractDiagram diagram, TerminatePseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmTerminal." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmTerminal." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f5a0f98b-55b6-11e2-877f-002564c97630")
    @Override
