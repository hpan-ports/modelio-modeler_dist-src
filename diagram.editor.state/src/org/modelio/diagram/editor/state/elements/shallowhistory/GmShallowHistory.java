...
public class GmShallowHistory extends GmPortContainer {
    ...
    public GmShallowHistory(GmAbstractDiagram diagram, ShallowHistoryPseudoState el, MRef ref) {
        super(diagram, ref);
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmShallowHistory." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmShallowHistory." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
     ...
     */
    @objid ("f5702591-55b6-11e2-877f-002564c97630")
    @Override
