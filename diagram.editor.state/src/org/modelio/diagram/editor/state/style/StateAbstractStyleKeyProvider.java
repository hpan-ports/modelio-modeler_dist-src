...
package org.modelio.diagram.editor.state.style;
...
public abstract class StateAbstractStyleKeyProvider extends AbstractStyleKeyProvider {
    @objid ("f5b6563e-55b6-11e2-877f-002564c97630")
    private static final String CATEGORY_SUFFIX = ".category";

    @objid ("f5b65640-55b6-11e2-877f-002564c97630")
    private static final String LABEL_SUFFIX = ".label";

    @objid ("f5b65642-55b6-11e2-877f-002564c97630")
    private static final String TOOLTIP_SUFFIX = ".tooltip";

    @objid ("f5b65644-55b6-11e2-877f-002564c97630")
    ...
    public static StyleKey createStyleKey(String key, MetaKey metakey) {
        return new StyleKey(key,
                                                    ...
                                                    metakey.getLabel(),
                                                    metakey.getTooltip(),
                                                    DiagramEditorState.I18N.getMessage(STYLEKEY_PREFIX + key + CATEGORY_SUFFIX));
    }
    ...
    public static StyleKey createStyleKey(String key, Class<?> type) {
        return new StyleKey(key,
                                                    type,
                                                    DiagramEditorState.I18N.getMessage(STYLEKEY_PREFIX + key + LABEL_SUFFIX),
                                                    DiagramEditorState.I18N.getMessage(STYLEKEY_PREFIX + key + TOOLTIP_SUFFIX),
                                                    DiagramEditorState.I18N.getMessage(STYLEKEY_PREFIX + key + CATEGORY_SUFFIX));
    }
