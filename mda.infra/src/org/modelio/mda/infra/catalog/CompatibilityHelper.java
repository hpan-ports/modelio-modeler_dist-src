...
public class CompatibilityHelper {
    ...
    /**
     * Get the compatibility level of a module handle
     * @param modelioEnv the Modelio environment
    ...
    /**
     * Get the compatibility level of a module binary version
    ...
    public enum CompatibilityLevel {
        ...
        FULLYCOMPATIBLE,
        /**
         * Should be compatible but upgrade recommended.
         */
        COMPATIBLE,
        /**
         * Modelio is too old
