...
class BrokenModuleSession implements IModuleSession {
    @objid ("59471a99-02fb-42c6-aa44-91b29cbd6e20")
    private IRTModule brokenModule;

    @objid ("d7e4697e-c168-406b-add9-7da5723210a4")
    public BrokenModuleSession(IRTModule brokenModule) {
    ...
    private String getMessage() {
        return MdaInfra.I18N.getMessage("BrokenModuleSession.message", 
                        ...
                        this.brokenModule.getDownError().getLocalizedMessage());
    }
