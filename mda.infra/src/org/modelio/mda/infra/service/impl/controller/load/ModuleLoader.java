 ...
 * <p>
 * If the module cannot be loaded a {@link BrokenIModule} is returned.
...
public class ModuleLoader {
    ...
    private final IModelingSession apiSession;
     ...
     * @throws org.modelio.api.module.ModuleException on failure, if sanity checks fail
     */
    ...
    public IModule loadModule() throws ModuleException {
        ...
        if (FAKE_MODULE_CLASS_NAME.equals(mainClassName)) {
            ...
            // icons
            return new FakeIModule(this.apiSession, this.gModule,
                    this.rtModule.getConfiguration(), this.rtModule.getModuleApiConfiguration());
        } else if (! isCompatibleWithModelio(this.moduleHandle)) {
            String msg = MdaInfra.I18N.getMessage("ModuleLoader.IncompatibleModelioVersion",
                    this.rtModule.getName(),
                    this.rtModule.getVersion(),
                    Modelio.getInstance().getContext().getVersion(),
                    this.moduleHandle.getBinaryVersion());
            throw new ModuleException(msg);
        
        } else {
            // Setup the module class loader:
            URLClassLoader classLoader = ModuleClassLoaderFactory.setupClassLoader(this.rtModule);
        
            this.rtModule.setClassLoader(classLoader);
        
            // Instantiate the user defined module class
            IModule iModule = instantiateModuleMainClass(classLoader, mainClassName,
                    this.rtModule.getConfiguration(), this.rtModule.getModuleApiConfiguration());
    ...
    private void checkModule() throws ModuleException {
        ...
        if (modelFragment == null) {
            ...
            if (modelFragment.getDownError() != null) {
                ...
                throw new ModuleException("The module fragment is in '"+modelFragment.getState()+"' state.");
            }
            ...
            throw new ModuleException(String.format("The '%s' module has no RAMC model element with {%s} UUID.",
                    this.gModule.getName(), this.gModule.getModuleHandle().getUid()));
        }
    }
     ...
     * @throws org.modelio.api.module.ModuleException in case of error loading a fragment
     */
    ...
    public List<ISmMetamodelFragment> loadMetamodelFragments(ClassLoader classLoader) throws ModuleException {
        ...
        for (IMetamodelFragmentHandle mmfHandle : this.moduleHandle.getMetamodelFragments()) {
            ...
            try {
                ...
                ISmMetamodelFragment mmf = (ISmMetamodelFragment) cls.newInstance();
        
                // Load the fragment
                this.gProject.getSession().getMetamodelSupport().addMetamodelFragment(mmf);
    ...
    public IModule instantiateModuleMainClass(URLClassLoader classLoader, String mainClassName, IModuleUserConfiguration moduleUserConfiguration, IModuleAPIConfiguration moduleApiConfiguration) throws ModuleException {
        ...
        try {
            ...
            final ModuleException e2 = new ModuleException(String.format(
                    "The '%1$s' module main class has not been found: %2$s", this.moduleHandle.getName(), e.getMessage()), e);
            throw e2;
        } catch (NoClassDefFoundError e) {
            final ModuleException e2 = new ModuleException(String.format(
                    "Cannot load '%1$s' module main class: %2$s", this.moduleHandle.getName(), e.getMessage()), e);
            throw e2;
        }
        ...
        try {
            ...
            Object[] initParamArray = { this.apiSession, this.gModule.getModuleElement(), moduleUserConfiguration, moduleApiConfiguration };
            ...
            final ModuleException e2 = new ModuleException(String.format(
                    "Security violation while loading the '%1$s' module: %2$s ", this.moduleHandle.getName(), e.getMessage()));
            e2.initCause(e);
            throw e2;
        } catch (NoSuchMethodException e) {
            final ModuleException e2 = new ModuleException(String.format(
                    "The '%1$s' module class constructor has not been found: %2$s", this.moduleHandle.getName(), e.getMessage()));
            e2.initCause(e);
            throw e2;
        } catch (IllegalArgumentException e) {
            final ModuleException e2 = new ModuleException(String.format(
                    "Illegal argument error while initalizing the '%1$s' module: %2$s ", this.moduleHandle.getName(), e.getMessage()));
            e2.initCause(e);
            throw e2;
        } catch (InstantiationException e) {
            ...
            final ModuleException e2 = new ModuleException(String.format(
                    "Illegal access error occured while initalizing the '%1$s' module: %2$s ", this.moduleHandle.getName(),
                    e.getMessage()));
            e2.initCause(e);
            throw e2;
            ...
            final ModuleException e2 = new ModuleException(
                    String.format("Linkage error thrown while initalizing the '%1$s' module: %2$s ", this.moduleHandle.getName(),
                            cause.getMessage()));
            e2.initCause(cause);
            throw e2;
        }
    ...
    private static ModuleException toModuleException(Throwable cause) {
        if (cause == null) {
            ...
            return new ModuleException(FileUtils.getLocalizedMessage((IOException) cause), cause);
    ...
    public IModule createFakeModule() {
        return new FakeIModule(this.apiSession, this.gModule, this.rtModule.getConfiguration(), this.rtModule.getModuleApiConfiguration());
    }
    ...
    public void callStaticMethodInstall() throws ModuleException {
        ...
        try (URLClassLoader classLoader = ModuleClassLoaderFactory.setupClassLoader(this.rtModule)) {
            Class<?> mainClass = null;
            try {
                ...
                ModuleException e2 = new ModuleException(String.format(
                        "The '%1$s' module class has not been found.\n (%2$s)", this.moduleHandle
                        .getMainClassName(), e.getMessage()), e);
               throw e2;
            } catch (NoClassDefFoundError e) {
                ...
                ModuleException e2 = new ModuleException(String.format(
                        ...
                        this.moduleHandle.getMainClassName(), e.getMessage(), sUrls));
                e2.initCause(e);
                throw e2;
            }
            ...
            try {
                ...
                Object[] initParamArray = { this.gProject.getProjectPath(), this.moduleHandle.getResourcePath() };
                ...
                ModuleException e2 = new ModuleException(String.format(
                        "Exception thrown while initalizing the '%1$s' module: %2$s ", this.moduleHandle.getName(),
                        cause.getMessage()));
                e2.initCause(cause);
                throw e2;
            }
