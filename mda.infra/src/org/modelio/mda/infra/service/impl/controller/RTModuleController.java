...
public class RTModuleController implements IRTModuleController {
    ...
    private IRTModuleAccess rtModule;
    ...
    @Override
    public void updateTo(IModuleHandle rtModuleHandle, Path moduleFilePath) throws ModuleException {
        MdaInfra.LOG.indent();
        try {
            new ModuleUpdater(this.rtModule.getGModule().getProject())
            .moduleUpdateInstall(this.rtModule, rtModuleHandle, moduleFilePath);
        } finally {
            MdaInfra.LOG.dedent();
        }
    }
