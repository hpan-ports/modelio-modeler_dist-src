...
public class ModuleUpdater {
    ...
    public ModuleUpdater(GProject gProject) {
    ...
    public void moduleUpdateInstall(IRTModuleAccess rtModuleToUpdate, IModuleHandle rtModuleHandle, Path moduleFilePath) throws ModuleException {
        ...
        try {
            ...
            GModule updatedGModule = installInGProject(rtModuleHandle, moduleFilePath, monitor);
            ...
            try {
                ...
                rtModuleToUpdate.getIModule().getSession().upgrade(oldVersion, oldParameters);
    ...
    private GModule installInGProject(IModuleHandle rtModuleHandle, Path moduleFilePath, IModelioProgress monitor) throws ModuleException {
        try {
            return this.gProject.installModule(rtModuleHandle, moduleFilePath.toUri(), monitor);
        } catch (IOException e) {
    ...
    public void moduleUpdateFromGProject(IRTModuleAccess rtModule, Version oldVersion) throws ModuleException {
        ...
        try {
            ...
            rtModule.getIModule().getSession().upgrade(oldVersion, oldParameters);
