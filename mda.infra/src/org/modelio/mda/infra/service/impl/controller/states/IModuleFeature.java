...
public interface IModuleFeature {
     ...
     * @throws org.modelio.api.module.ModuleException on error
     */
    @objid ("5d10a286-c53f-49bd-bb7e-e67e397d822a")
    void enable() throws ModuleException;

    /**
     * @throws org.modelio.api.module.ModuleException error to report to the user without blocking state exit
     */
