...
public class PropertyPageReader {
    ...
    public void registerPropertyPanel(final Jxbv2PropertyPage property, final IRTModuleAccess module, Map<String, IModuleAction> commandCache) throws IOException {
        ...
        try {
            ...
            throw new IOException(MdaInfra.I18N.getMessage("L43_class_not_found", property.getClazz(), e.toString()), e);
        } catch (ClassCastException e) {
            throw new IOException(MdaInfra.I18N.getMessage("L45_class_cast_exception", property.getClazz()), e);
        } catch (InvocationTargetException | NoSuchMethodException | RuntimeException e) {
        ...
        for (Jxbv2CommandRef ref : property.getCommandRef()) {
            ...
            if (action != null) {
                ...
                MdaInfra.LOG.error("Unresolved property view command ref for %s module : '%s'.", module.getName(), ref.getRefid());
            }
        }
    }
