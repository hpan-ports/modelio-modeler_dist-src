...
class GenericDiagramCustomizer implements IDiagramCustomizer {
    ...
    public GenericDiagramCustomizer(final List<CommandRegistry> commands, final boolean keepPalette, final IModule module) {
    ...
    public void fillPalette(final PaletteRoot paletteRoot) {
        ...
        for(CommandRegistry command : this.commands){
    ...
    private ResourceBundle getManifestBundle(final IModule module) throws MissingResourceException {
        ...
        try (final URLClassLoader cl = new URLClassLoader(new URL[] { manifestDir.toUri().toURL() })) {
            ...
            MissingResourceException e2 = new MissingResourceException(e.getLocalizedMessage() + " in '" + manifestDir + "'", e.getClassName(), e.getKey());
            e2.initCause(e);
            throw e2;
        }
    }
    ...
    static class CommandRegistry {
        ...
        public CommandRegistry(String commandId, String group) {
