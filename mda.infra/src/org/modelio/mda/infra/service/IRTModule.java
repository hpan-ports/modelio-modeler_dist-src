...
public interface IRTModule {
    ...
    public class DiagramToolDescriptor {
        ...
        public Class<? extends MObject> getMetaclass() {
            MMetamodel mm = this.handler.getModule().getModel().getMClass().getMetamodel();
        ...
        public Stereotype getStereotype() {
            ...
            return (st != null && !st.isEmpty()) ? this.handler.getModule().getModelingSession().getMetamodelExtensions()
