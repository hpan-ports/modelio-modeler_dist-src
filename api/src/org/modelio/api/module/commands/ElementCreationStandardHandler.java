 ...
 * <p>
 * This handler supports the following parameters; <ul>
 * <li>name : the handler identifier
 * <li>metaclass : the metaclass name
 * <li>stereotype : the stereotype name.
 * May be a regular expression.
 * May be  "module#stereotype" where module and stereotype are plain text or regular expression.
 * "#" must not be used in the module or stereotype name.
...
public class ElementCreationStandardHandler extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(final List<MObject> selectedElements, final IModule module) {
        IModelingSession modelingSession = module.getModelingSession();
        ...
        try (ITransaction tr = modelingSession.createTransaction("Create <<" + getStereotype() + ">> " + getMetaclass())) {
            ...
            Element newElement = modelFactory.createElement(getMetaclass());
            ...
            if (newElement instanceof AbstractDiagram) {
                ...
                modelFactory.getDefaultNameService().setDefaultName((ModelElement) newElement, module.getLabel(getName()));
                ...
                if (dependency != null) {
                    ...
                    new ElementConfigurator().configure(newElement, new HashMap<String, Object>());
            ...
            Modelio.getInstance().getNavigationService().fireNavigate(newElement);
        }
    }
