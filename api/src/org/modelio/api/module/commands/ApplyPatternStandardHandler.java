...
public class ApplyPatternStandardHandler extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        IPatternService svc = Modelio.getInstance().getPatternService();
        
        String patternRelPath = getParameters().get(COMMANDPARAM_PATTERN_PATH);
        
        try (ITransaction tr= module.getModelingSession().createTransaction("Apply "+patternRelPath+" pattern")){
            Map<String, Object> pattParams = configure(selectedElements, module);
        
            Path patternPath = module.getConfiguration().getModuleResourcesPath().resolve(patternRelPath);
