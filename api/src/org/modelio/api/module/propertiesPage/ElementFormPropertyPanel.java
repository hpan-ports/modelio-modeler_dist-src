 ...
 * <p>
 * SubClasses should redefine {@link #isRelevantFor(Object)} and {@link #createFormFields(Composite, ModelElement)} only.
 * </p>
 * <p>
 * The IPanelProvider aspect is delegated to an {@link ElementFormPanel}.
 * </p>
 */
...
public abstract class ElementFormPropertyPanel implements IModulePropertyCustomPanel {
    ...
    @objid ("545052a5-06cd-439b-94a2-1b446f5b83ed")
    ...
    private ElementFormPanel formPanel;
     ...
     * @param image the property page's image. Currently unused.
     */
    ...
    public ElementFormPropertyPanel(IModule module, String name, String label, String image) {
        ...
        this.name = name;
        this.label = label;
        this.formPanel = new ElementFormPanel(initFactory());
    }
