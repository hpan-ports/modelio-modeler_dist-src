...
/**
 * Convenience class that provides an abstract implementation of {@link IDiagramWizardContributor} that only provides useful fields and
...
public abstract class AbstractDiagramWizardContributor extends AbstractWizardContributor implements IDiagramWizardContributor {
    ...
    /**
     * Called by {@link #accept(MObject)} to check whether the given object
     * has sufficient rights to create the wizard new element.
    ...
    protected boolean checkCanCreateIn(ModelElement owner) {
        return MTools.getAuthTool().canAdd(owner, AbstractDiagram.MNAME);
    }
