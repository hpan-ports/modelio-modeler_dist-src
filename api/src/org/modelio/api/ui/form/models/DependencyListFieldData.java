...
public class DependencyListFieldData implements IFormFieldData {
    ...
    public DependencyListFieldData(ModelElement e, Stereotype s, ICandidateProvider candidateProvider) {
        this.element = e;
        this.stereotype = s;
    ...
    public void setValue(Object value) {
        ...
        try (ITransaction t = session.createTransaction("Modify owner dependencies")) {
            ...
            for (MObject newTarget : values) {
                ...
                if (!found) {
                    // Create missing link
                    Modelio.getInstance().getModelingSession().getModel().createDependency(this.element, (ModelElement) newTarget, this.stereotype);
                }
            }
            t.commit();
