 ...
 * <li> a message, set with {@link #setMessage(String)}.</ul>
 ...
 * <li> An optional message area that display on top of the header area,
 * showing a warning or error small icon and a message.<br>
 * See {@link #setWarningMessage(String)} and {@link #setErrorMessage(String)}.</ul>
 */
...
public abstract class ModelioDialog extends TrayDialog implements IModelioDialog {
     ...
     * The title is different from the dialog tray title.
    ...
    private void setMessageAreaVisible(boolean visible) {
        ...
        if (!this.messageArea.isVisible() && this.messageArea.getBounds().y != bottom)
            this.messageArea
            .setBounds(this.messageImageLabel != null ? this.messageImageLabel.getBounds().x : msgLabelBounds.x, bottom,
                    this.messageImageLabel != null ? msgLabelBounds.width + this.messageImageLabel.getBounds().width
    ...
    protected Control createContents(Composite parent) {
        ...
        ImageDescriptor imageDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin("org.modelio.ui", "icons/headerleft.png");
