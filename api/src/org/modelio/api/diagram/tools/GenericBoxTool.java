                ...
                if (dependency != null) {
                    ...
                    if (newElement instanceof ModelElement) {
                        ...
                        if (relationParam != null) {
                            ((ModelElement) newElement).getExtension().add(session.getMetamodelExtensions().getStereotype(relationParam, newElement.getMClass()));
                        }
                    ...
                    Modelio.getInstance().getLogService().error(getModule(), "Metamodel relation on '" + getParameter("metaclass)") + "' not found.");
                    newElement.delete();
                }
