...
public class R2590 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(InitialPseudoState.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2590 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof InitialPseudoState) {
                ...
                Audit.LOG.warning("R2590: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
