...
/**
 * Rule implementation origin: ActivityModelChecker checkR61058 error
 * 
 * UML 2.3 Constraint on InputPin: Input pins may have outgoing edges only when they are on actions that are structured
 * nodes, and these edges must target a node contained by the structured node.
 */
@objid ("c3d5bf17-5dec-4e0d-a2ac-fc2621fcfb78")
public class R1360 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(InputPin.MNAME, this, AuditTrigger.CREATE |
                                                         AuditTrigger.MOVE |
                                                         AuditTrigger.UPDATE);
    ...
    public static class CheckR1360 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof InputPin) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1360: unsupported element type '%s'",
