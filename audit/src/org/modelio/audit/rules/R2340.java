...
public class R2340 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Operation.MNAME, this, AuditTrigger.UPDATE | AuditTrigger.MOVE);
    ...
    public static class CheckR2340 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Operation) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2340: unsupported element type '%s'",
        ...
        /**
         * This method recursively navigates the .Interface realizations until it find Classifiers and then call the
         * appropriate method that check Classifiers.
