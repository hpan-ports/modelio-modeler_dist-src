...
public class R2730 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(TemplateBinding.MNAME, this, AuditTrigger.CREATE |
                                                                AuditTrigger.UPDATE |
                                                                AuditTrigger.MOVE);
        plan.registerRule(TemplateParameter.MNAME, this, AuditTrigger.CREATE);
    ...
    public static class CheckR2730 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof TemplateParameter) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2730: unsupported element type '%s'",
