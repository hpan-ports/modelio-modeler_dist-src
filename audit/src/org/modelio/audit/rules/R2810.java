...
public class R2810 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Transition.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE | AuditTrigger.MOVE);
        plan.registerRule(DeepHistoryPseudoState.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(ShallowHistoryPseudoState.MNAME, this, AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2810 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition){
                ...
                Audit.LOG.warning("R2810: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
