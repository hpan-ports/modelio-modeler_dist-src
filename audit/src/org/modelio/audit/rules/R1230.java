...
public class R1230 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan
                .registerRule(InitialNode.MNAME, this,
                        AuditTrigger.UPDATE);
    ...
    public static class CheckR1230 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof InitialNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1230: unsupported element type '%s'",
