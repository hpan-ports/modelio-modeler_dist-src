...
public class R2930 extends AbstractRule {
    ...
    public void autoRegister(final IAuditPlan plan) {
        plan.registerRule(Message.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
        plan.registerRule(CommunicationMessage.MNAME, this, AuditTrigger.CREATE |
                                                                     AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2930 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(final IDiagnosticCollector diagnostic, final MObject element) {
            if (element instanceof Message)
                ...
                Audit.LOG.warning("R2930: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
