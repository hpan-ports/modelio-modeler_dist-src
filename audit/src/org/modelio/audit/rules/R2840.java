...
public class R2840 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Transition.MNAME, this, AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2840 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition)
                ...
                Audit.LOG.warning("R2840: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
