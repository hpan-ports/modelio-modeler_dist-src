...
public class R1610 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Class.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
        plan.registerRule(StateMachine.MNAME, this, AuditTrigger.CREATE |
                                                             AuditTrigger.MOVE |
                                                             AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1610 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Class)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1610: unsupported element type '%s'",
