...
public class R1690 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Event.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1690 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Event)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1690: unsupported element type '%s'",
