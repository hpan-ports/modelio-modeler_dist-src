...
public class R2680 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(TaggedValue.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
        plan.registerRule(TagParameter.MNAME, this, AuditTrigger.CREATE);
    }
    ...
    public static class CheckR2680 extends AbstractControl {
