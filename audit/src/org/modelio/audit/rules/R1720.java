...
public class R1720 extends AbstractRule {
    ...
    public static class CheckR1720 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Generalization) {
                ...
                //diagnostic.addEntry(checkR1720(((Generalization) element).getSuperType()));
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1720: unsupported element type '%s'",
