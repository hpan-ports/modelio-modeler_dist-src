...
public class R2540 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(ProvidedInterface.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(InterfaceRealization.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
