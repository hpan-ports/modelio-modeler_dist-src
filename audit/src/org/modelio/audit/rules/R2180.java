...
public class R2180 extends AbstractRule {
    ...
    public static class CheckR2180 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Generalization) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2180: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2180(final NameSpace nameSpace) {
            ...
            if (findCycle(nameSpace, cycle)) {
                ...
                ArrayList<Object> linkedObjects = new ArrayList<Object>(cycle);
