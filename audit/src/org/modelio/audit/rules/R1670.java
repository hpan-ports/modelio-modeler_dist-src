...
public class R1670 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(EnumerationLiteral.MNAME, this, AuditTrigger.UPDATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR1670 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Enumeration) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1670: unsupported element type '%s'",
