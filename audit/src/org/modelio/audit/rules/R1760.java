...
public class R1760 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Instance.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1760 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Instance)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1760: unsupported element type '%s'",
