...
public class R1280 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(ObjectFlow.class).getName(), this, AuditTrigger.CREATE
                | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR1280 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ObjectFlow)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1280: unsupported element type '%s'",
