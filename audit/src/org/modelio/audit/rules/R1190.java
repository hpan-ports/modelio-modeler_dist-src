...
public class R1190 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(DecisionMergeNode.MNAME, this, AuditTrigger.UPDATE);
    ...
    public static class CheckR1190 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof DecisionMergeNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1190: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
