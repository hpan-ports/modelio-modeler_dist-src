...
public class R2450 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Package.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
        plan.registerRule(Generalization.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2450 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof Package)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2450: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2450(final Package pkg) {
            ...
            if(pkg.getParent().size() > 0 || pkg.getSpecialization().size() > 0){
