...
public class R2620 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(State.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(EntryPointPseudoState.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(ExitPointPseudoState.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2620 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof State)
                ...
                Audit.LOG.warning("R2620: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
        ...
        private IAuditEntry checkR2620(State state) {
            ...
            if (entries.size() > 0 || exits.size() > 0) {
