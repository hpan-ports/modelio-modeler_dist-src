...
public class R1740 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(InformationFlow.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1740 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof InformationFlow) 
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1740: unsupported element type '%s'",
        ...
        private IAuditEntry checkR1740(final InformationFlow infoFlow) {
            ...
            if(infoFlow.getConveyed().size() == 0){
