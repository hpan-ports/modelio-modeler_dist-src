...
public class R2190 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(NameSpace.MNAME, this, AuditTrigger.UPDATE);
    ...
    public static class CheckR2190 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            ...
            if(element instanceof Generalization)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2190: unsupported element type '%s'",
