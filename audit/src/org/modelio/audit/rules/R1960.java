...
public class R1960 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Message.MNAME, this, AuditTrigger.UPDATE);
    ...
    public static class CheckR1960 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Message)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1960: unsupported element type '%s'",
