...
public class R2400 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Parameter.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE
                | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2400 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Operation)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R2400: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
