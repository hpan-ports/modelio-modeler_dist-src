...
public class R2230 extends AbstractRule {
    ...
    public static class CheckR2230 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Generalization) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2230: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2230(final NameSpace nameSpace) {
            ...
            if (nameSpace.isIsRoot() && nameSpace.getParent().size() > 0) {
