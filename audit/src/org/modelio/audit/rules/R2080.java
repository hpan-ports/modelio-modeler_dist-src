...
public class R2080 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(PropertyTable.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(PropertyDefinition.MNAME, this, AuditTrigger.CREATE |
                                                         AuditTrigger.MOVE |
                                                         AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2080 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof PropertyTableDefinition)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2080: unsupported element type '%s'",
