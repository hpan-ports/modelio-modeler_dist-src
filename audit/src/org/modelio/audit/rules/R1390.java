...
public class R1390 extends AbstractRule {
    ...
    public static class CheckR1390 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof InputPin)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1390: unsupported element type '%s'",
        ...
        /**
         * If an Attribute is updated and this Attribute is represented in an
         * InputPin, we need to check the rule on this InputPin.
         * @param attribute The updated Attribute.
         * @return A list of audit entry for each InputPin representing the
         * Attribute.
         */
