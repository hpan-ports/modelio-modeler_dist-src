...
public class R2470 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(PackageImport.MNAME, this, AuditTrigger.CREATE |
                                                              AuditTrigger.MOVE |
                                                              AuditTrigger.UPDATE);
    ...
    public static class CheckR2470 extends AbstractControl {
