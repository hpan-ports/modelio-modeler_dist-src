...
public class R1810 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(InteractionUse.MNAME, this, AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1810 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Gate)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1810: unsupported element type '%s'",
