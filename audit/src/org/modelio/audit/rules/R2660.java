...
public class R2660 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(State.MNAME, this, AuditTrigger.UPDATE | AuditTrigger.MOVE);
        plan.registerRule(InternalTransition.MNAME, this, AuditTrigger.CREATE);
    }
    ...
    public static class CheckR2660 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof StateMachine)
                ...
                Audit.LOG.warning("R2660: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
