...
public class R2750 extends AbstractRule {
    ...
    public static class CheckR2750 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition)
                ...
                Audit.LOG.warning("R2750: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
