...
public class R1780 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Instance.MNAME, this, AuditTrigger.UPDATE | AuditTrigger.MOVE | AuditTrigger.CREATE);
    }
    ...
    public static class CheckR1780 extends AbstractControl {
