...
public class R1400 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(ActivityParameterNode.MNAME, this,
    ...
    public static class CheckR1400 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ActivityParameterNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1400: unsupported element type '%s'",
