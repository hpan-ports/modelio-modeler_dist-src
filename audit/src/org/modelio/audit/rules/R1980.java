...
public class R1980 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Attribute.MNAME, this, AuditTrigger.MOVE | AuditTrigger.UPDATE);
        plan.registerRule(AssociationEnd.MNAME, this, AuditTrigger.MOVE | AuditTrigger.UPDATE);
    }
    ...
    static class CheckR1980 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Classifier)
                ...
                MObject owner =  end.getSource() != null ? end.getSource() : end.getOpposite().getTarget();
                if (owner instanceof Classifier)
                    diagnostic.addEntry(checkR1980((Classifier) owner));
            } else
