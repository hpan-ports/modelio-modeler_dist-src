...
public class R1520 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(BindableInstance.MNAME, this, AuditTrigger.CREATE |
                                                                 AuditTrigger.UPDATE |
                                                                 AuditTrigger.MOVE);
    ...
    public static class CheckR1520 extends AbstractControl {
