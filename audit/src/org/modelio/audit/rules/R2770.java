...
public class R2770 extends AbstractRule {
    ...
    public static class CheckR2770 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition)
                ...
                Audit.LOG.warning("R2770: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
