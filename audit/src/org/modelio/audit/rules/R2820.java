...
public class R2820 extends AbstractRule {
    ...
    public static class CheckR2820 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition)
                ...
                Audit.LOG.warning("R2820: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
