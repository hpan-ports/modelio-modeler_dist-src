...
/**
 * Checks that an ActivityParameterNode with outgoing edges represents a
 * BehaviourParameter that has either 'in' or 'inout' as passing mode.
 * 
 * @author fpoyer
 */
@objid ("5a8469eb-cecf-4531-aa40-b0383b3e65aa")
public class R1060 extends AbstractRule {
    ...
    /**
     * Actual checker for R1060: Checks that an ActivityParameterNode with
     * outgoing edges represents a BehaviourParameter that has either 'in' or
     * 'inout' as passing mode.
     */
    @objid ("4a9a6ac4-80e0-496f-bd9b-2edd427f9301")
    public static class CheckR1060 extends AbstractControl {
        /**
         * C'tor.
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ActivityParameterNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1060: unsupported element type '%s'",
