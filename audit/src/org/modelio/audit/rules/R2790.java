...
public class R2790 extends AbstractRule {
    ...
    public static class CheckR2790 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition)
                ...
                Audit.LOG.warning("R2790: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
