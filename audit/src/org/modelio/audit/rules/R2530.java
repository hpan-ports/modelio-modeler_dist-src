...
public class R2530 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Link.MNAME, this, AuditTrigger.CREATE |
                                                     AuditTrigger.MOVE |
                                                     AuditTrigger.UPDATE);
    }
    ...
    static class CheckR2530 extends AbstractControl {
