...
/**
 * Rule implementation origin: OperationChecker
 * checkClassifierInheritedOperations warning
 */
@objid ("9f15be9f-ad24-4daa-9f7f-5218d23c53f7")
public class R2250 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Operation.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE
                | AuditTrigger.MOVE);
        plan.registerRule(TemplateParameter.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE
                | AuditTrigger.MOVE);
        plan.registerRule(Parameter.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE
                | AuditTrigger.MOVE);
        plan.registerRule(Generalization.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE
                | AuditTrigger.MOVE);
        plan.registerRule(InterfaceRealization.MNAME, this, AuditTrigger.CREATE
        ...
        plan.registerRule(Class.MNAME, this, AuditTrigger.UPDATE);
    ...
    public static class CheckR2250 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof TemplateParameter) {
                ...
                if (owner != null)
                    ...
                    Audit.LOG.warning(Audit.PLUGIN_ID, "R2250: %s(...) {%s} operation has no owner%s.", op.getName(), op.getUuid()
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R2250: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
        ...
        /**
         * This methods checks if the given classifier is an .Interface, in
         * which case the appropriate method is called.
        ...
        /**
         * This method recursively navigates the .Interface realizations until
         * it find Classifiers and then call the appropriate method that check
         * Classifiers.
        ...
        /**
         * This method recursively checks the given Classifier as well as all
         * Classifier that inherits from it.
