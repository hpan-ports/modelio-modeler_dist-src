...
public class R1320 extends AbstractRule {
    ...
    public static class CheckR1320 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ObjectFlow)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1320: unsupported element type '%s'",
