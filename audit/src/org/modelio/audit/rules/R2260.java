...
public class R2260 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Operation.MNAME, this, AuditTrigger.CREATE |
                                                          AuditTrigger.UPDATE |
                                                          AuditTrigger.MOVE);
        plan.registerRule(TemplateParameter.MNAME, this, AuditTrigger.CREATE |
                                                                  AuditTrigger.UPDATE |
                                                                  AuditTrigger.MOVE);
        plan.registerRule(Parameter.MNAME, this, AuditTrigger.CREATE |
                                                          AuditTrigger.UPDATE |
                                                          AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2260 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            // Beware of the ordering of the following if/else
            // For example TemplateParameter is a Classifier so if(Classifier) must appear AFTER if (TemplateParameter)
            if (element instanceof TemplateParameter) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2260: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2260(Classifier classifier) {
            ...
            if (failed) {
                ...
                linkedObjects.set(2, new Integer(nDuplicates));
