...
public class R1830 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(PartDecomposition.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(Message.MNAME, this, AuditTrigger.CREATE |
                                                        AuditTrigger.MOVE |
                                                        AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1830 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Message) {
                ...
                if (sort.equals(MessageSort.CREATEMESSAGE) ||
                    ...
                    PartDecomposition partDecomposition = message.getReceiveEvent()
                                                                  .getCovered()
                                                                  .get(0)
                                                                  .getDecomposedAs();
        ...
        private IAuditEntry checkR1830(final PartDecomposition partDecomposition) {
            ...
            for (MessageEnd messageEnd : partDecomposition.getDecomposed()                                                           
                ...
                MessageSort sort = messageEnd.getReceivedMessage().getSortOfMessage();
                if (sort.equals(MessageSort.CREATEMESSAGE) ||
                    sort.equals(MessageSort.DESTROYMESSAGE)) {
                    ...
                    linkedObjects.add(partDecomposition);
