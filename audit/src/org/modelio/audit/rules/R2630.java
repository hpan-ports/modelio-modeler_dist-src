...
public class R2630 extends AbstractRule {
    ...
    public static class CheckR2630 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Region)
                ...
                Audit.LOG.warning("R2630: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
