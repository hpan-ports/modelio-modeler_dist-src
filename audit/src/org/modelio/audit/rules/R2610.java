...
public class R2610 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(ConnectionPointReference.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2610 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof State)
                ...
                Audit.LOG.warning("R2610: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
