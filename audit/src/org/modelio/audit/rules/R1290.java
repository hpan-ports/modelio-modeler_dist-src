...
public class R1290 extends AbstractRule {
    ...
    public static class CheckR1290 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof InstanceNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1290: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
        ...
        private IAuditEntry checkR1290(ObjectFlow objectFlow) {
            ...
            try {
                ...
                // All Types are NULL, the rule does not apply.
        ...
        private List<GeneralClass> findSuperTypesIntersection(List<GeneralClass> sourceClasses) {
            ...
            for (GeneralClass genClass : sourceClasses) {
                ...
                // Else we build a temporary list containing a copy of our
                // previous found classes and for each check if any super
                // classes of the current Class intersects with it. If not, we
                // remove the Class from our found Classes.
                else {
        ...
        /**
         * Finds all the object nodes that are connected to the given object node, except for object nodes that are
         * controls.
