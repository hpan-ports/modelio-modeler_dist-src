...
public class R1490 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Instance.MNAME, this, AuditTrigger.UPDATE);
        ...
        plan.registerRule(Generalization.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1490 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof Instance)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1490: unsupported element type '%s'",
