...
public class R1640 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(ElementImport.MNAME, this, AuditTrigger.CREATE |
                                                              AuditTrigger.MOVE |
                                                              AuditTrigger.UPDATE);        
    ...
    public static class CheckR1640 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ElementImport)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1640: unsupported element type '%s'",
        ...
        private IAuditEntry checkR1640(final Operation operation) {
            ...
            for (ElementImport ei : operation.getOwnedImport()) {
                ...
                if (foundNS.contains(ns)) {
                    ...
                    linkedObjects.add(Operation.MNAME);
        ...
        private IAuditEntry checkR1640(final NameSpace nameSpace) {
            ...
            for (ElementImport ei : nameSpace.getOwnedImport()) {
                ...
                if (foundNS.contains(ns)) {
                    ...
                    linkedObjects.add(NameSpace.MNAME);
                    linkedObjects.add(ns);
                    auditEntry.setLinkedInfos(linkedObjects);
