...
public class R2950 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Transition.MNAME, this, AuditTrigger.CREATE |
                                                           AuditTrigger.MOVE |
                                                           AuditTrigger.UPDATE);
        plan.registerRule(State.MNAME, this, AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2950 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2950: unsupported element type '%s'",
                            element.getMClass().getName());
            return diagnostic;
        }

        /**
         * This rules check that all targeted state of a ForkPseudoState are all contained in the same State and are in
         * different regions.
         ...
         * @param sourceStates
         * The states from which to get the ancestors.
