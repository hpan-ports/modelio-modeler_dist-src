...
public class R2670 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(DeepHistoryPseudoState.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(ShallowHistoryPseudoState.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2670 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof StateMachine)
                ...
                Audit.LOG.warning("R2670: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
        ...
        private IAuditEntry checkR2670(StateMachine stateMachine) {
            ...
            if (stateMachine.getKind().equals(KindOfStateMachine.PROTOCOL)) {
                ...
                if (deepsHistories.size() > 0 || shallowHistories.size() > 0) {
