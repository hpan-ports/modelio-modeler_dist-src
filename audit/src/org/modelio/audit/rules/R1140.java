...
public class R1140 extends AbstractRule {
    ...
    public static class CheckR1140 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof CallOperationAction)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1140: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }

        /**
         * Checks if all the pins of a CallOperationAction are matched to all the BehaviorParameters of the called
         * Operation.
         * @param callBehaviorAction
         * The CallOperationAction to check.
        ...
        private IAuditEntry checkR1140(CallOperationAction callOperationAction) {
            ...
            if (returnParameter != null) {
                for (OutputPin outputPin : callOperationAction.getOutput()) {
                    if (outputPin.getMatched().equals(returnParameter)) {
        ...
        /**
         * A Pin was either created, moved or updated, we need to check if this Pin belong to a CallOperationAction and
         * check it if it does.
        ...
        /**
         * An Operation was updated, we need to check if it has registered callers and check the rule on these
         * CallOperationAction.
         * @param behavior
