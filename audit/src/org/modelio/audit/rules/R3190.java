...
public class R3190 extends AbstractRule {
    ...
    public void autoRegister(final IAuditPlan plan) {
        plan.registerRule(BpmnDataAssociation.MNAME, this, AuditTrigger.CREATE |
                                                                    AuditTrigger.MOVE |
                                                                    AuditTrigger.UPDATE);
        //        plan.registerRule(BpmnDataInput.MNAME, this, AuditTrigger.UPDATE);
        //        plan.registerRule(BpmnDataOutput.MNAME, this, AuditTrigger.UPDATE);
    }
