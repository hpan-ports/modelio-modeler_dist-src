...
public class R2940 extends AbstractRule {
    ...
    public static class CheckR2940 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2940: unsupported element type '%s'",
                            element.getMClass().getName());
            return diagnostic;
        }

        /**
         * This rules check that all origin state of a JoinPseudoState are all contained in the same State and are in
         * different regions.
