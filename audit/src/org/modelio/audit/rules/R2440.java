...
public class R2440 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Operation.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE | AuditTrigger.MOVE);
    ...
    public static class CheckR2440 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof Enumeration)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2440: unsupported element type '%s'",
