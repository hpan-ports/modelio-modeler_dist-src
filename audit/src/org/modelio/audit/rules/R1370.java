...
/**
 * Rule implementation origin: ActivityModelChecker checkR61059 error
 * 
 * UML 2.3 Constraint on OutputPin: Output pins may have incoming edges only when they are on actions that are
 * structured nodes, and these edges may not target a node contained by the structured node.
 */
@objid ("c5eddc2d-077b-40e1-ac89-d9ea532a536f")
public class R1370 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(OutputPin.MNAME, this, AuditTrigger.CREATE |
                                                          AuditTrigger.MOVE |
                                                          AuditTrigger.UPDATE);
        
        // ActivityEdge
        plan.registerRule(ObjectFlow.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(ControlFlow.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(MessageFlow.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR1370 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof OutputPin) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1370: unsupported element type '%s'",
