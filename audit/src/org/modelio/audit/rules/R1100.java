...
public class R1100 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(BindableInstance.MNAME, this, AuditTrigger.UPDATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR1100 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ActivityPartition)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1100: unsupported element type '%s'",
