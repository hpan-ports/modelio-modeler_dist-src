...
public class R2900 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(UseCaseDependency.MNAME + UseCaseDependencyExtendKind, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2900 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof UseCaseDependency)
                ...
                Audit.LOG.warning("R2900: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
        ...
        private IAuditEntry checkR2900(UseCaseDependency dependency) {
            ...
            if(dependency.isStereotyped("ModelerModule", UseCaseDependencyExtendKind) && dependency.getExtensionLocation().size() == 0){
                // Rule failed
                failed = true;
            }
