...
public class R1350 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(InstanceNode.MNAME, this,
                AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1350 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof InstanceNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1350: unsupported element type '%s'",
