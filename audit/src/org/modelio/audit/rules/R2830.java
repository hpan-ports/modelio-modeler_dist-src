...
public class R2830 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(FinalState.MNAME, this, AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2830 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition)
                ...
                Audit.LOG.warning("R2830: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
