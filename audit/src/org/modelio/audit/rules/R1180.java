...
public class R1180 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        //ObjectNode
        plan.registerRule(ExpansionNode.MNAME, this, AuditTrigger.UPDATE);
        ...
        plan.registerRule(ActivityParameterNode.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(CentralBufferNode.MNAME, this, AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1180 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ControlFlow)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1180: unsupported element type '%s'",
