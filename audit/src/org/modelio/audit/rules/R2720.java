...
public class R2720 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(TemplateBinding.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2720 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof TemplateBinding)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2720: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2720(final TemplateBinding tBinding) {
            ...
            if(nsOrigin != null && nsTarget != null && ( nsOrigin.getClass().equals(nsTarget.getClass()) ||
                    nsOrigin.getClass().equals(DataType.class) && nsTarget.equals(Class.class)
                    || nsOrigin.getClass().equals(Class.class) && nsTarget.equals(DataType.class) ))
                return auditEntry;
