...
public class R1800 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(CombinedFragment.MNAME, this, AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1800 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof CombinedFragment)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1800: unsupported element type '%s'",
