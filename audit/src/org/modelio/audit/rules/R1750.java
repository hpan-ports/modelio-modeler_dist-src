...
public class R1750 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(AttributeLink.MNAME, this, AuditTrigger.UPDATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR1750 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof Instance)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1750: unsupported element type '%s'",
        ...
        private IAuditEntry checkR1750(final Instance instance) {
            ...
            for(AttributeLink attLink : instance.getSlot()){
                ...
                else attLinkNames.add(attLinkName);
            }
            return auditEntry;
        }
