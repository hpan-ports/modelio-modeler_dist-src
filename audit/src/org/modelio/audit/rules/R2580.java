...
public class R2580 extends AbstractRule {
    ...
    public static class CheckR2580 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Region)
                ...
                Audit.LOG.warning("R2580: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
