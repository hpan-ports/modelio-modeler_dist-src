...
public class R3060 extends AbstractRule {
    ...
    public void autoRegister(final IAuditPlan plan) {
        plan.registerRule(Dependency.MNAME + DependencySatisfyKind, this, AuditTrigger.CREATE |
                                                                                  AuditTrigger.MOVE |
                                                                                  AuditTrigger.UPDATE);
        plan.registerRule(Dependency.MNAME + DependencyVerifyKind, this, AuditTrigger.CREATE |
                          AuditTrigger.MOVE |
                          AuditTrigger.UPDATE);
    }
