...
public class R1110 extends AbstractRule {
    ...
    public static class CheckR1110 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof CallBehaviorAction)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1110: unsupported element type '%s'",
        ...
        /**
         * A Pin was either created, moved or updated, we need to check if this
         * Pin belong to a CallBehaviorAction and check it if it does.
        ...
        /**
         * A BehaviorParameter was either created, moved, or updated, wee need
         * to check the Behavior it belongs to.
        ...
        /**
         * A Behavior was updated, we need to check if it has registered callers
         * and check the rule on these CallBehaviorAction.
