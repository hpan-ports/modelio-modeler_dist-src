...
public class R2600 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Region.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(State.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR2600 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof StateMachine){
                ...
                Audit.LOG.warning("R2600: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
        ...
        private IAuditEntry checkR2600(State state) {
            ...
            if (duplicateNamedStates.size() > 0) {
