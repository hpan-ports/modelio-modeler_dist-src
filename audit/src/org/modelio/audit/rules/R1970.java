...
public class R1970 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(TemplateParameterSubstitution.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1970 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof TemplateParameterSubstitution)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1970: unsupported element type '%s'",
