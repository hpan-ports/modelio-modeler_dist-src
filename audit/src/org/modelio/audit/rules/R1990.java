...
public class R1990 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Attribute.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
        plan.registerRule(AssociationEnd.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
        
        plan.registerRule(Generalization.MNAME, this, AuditTrigger.CREATE |
                                                               AuditTrigger.MOVE |
                                                               AuditTrigger.UPDATE);
    }
    ...
    static class CheckR1990 extends AbstractControl {
        ...
        private List<IAuditEntry> checkDown(final Generalization generalization, final List<Generalization> generalizations) {
            ...
            if(generalizations.contains(generalization))
                return auditEntries;
            else generalizations.add(generalization);
        ...
        private void fetchNames(final Classifier classifier, final List<String> foundNames, final List<Classifier> classifiers) {
            if(classifiers.contains(classifier))
                return;
            else classifiers.add(classifier);
