...
/**
 * Rule implementation origin: UseCaseDependencyChecker
 * checkIncludeHasNoExtensionPoint
 */
@objid ("529a90c0-5b45-480f-b29a-12496d73f343")
public class R2920 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(UseCaseDependency.MNAME + UseCaseDependencyExtendKind, this,
                AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2920 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof UseCaseDependency)
                ...
                Audit.LOG.warning("R2920: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
