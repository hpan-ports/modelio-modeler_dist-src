...
public class R2350 extends AbstractRule {
    ...
    public static class CheckR2350 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Operation) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2350: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2350(final Operation operation) {
            ...
            if (operation.getVisibility().equals(VisibilityMode.PRIVATE) &&
                operation.getRedefinition().size() > 0) {
