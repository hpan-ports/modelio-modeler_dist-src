...
public class R2740 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(TemplateBinding.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(TemplateParameterSubstitution.MNAME, this, AuditTrigger.CREATE |
                                                                              AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR2740 extends AbstractControl {
