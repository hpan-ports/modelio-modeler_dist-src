...
public class R1170 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(CallOperationAction.MNAME, this,
                AuditTrigger.UPDATE);
        plan.registerRule(InputPin.MNAME, this, AuditTrigger.UPDATE
                | AuditTrigger.MOVE);
        plan.registerRule(Operation.MNAME, this, AuditTrigger.MOVE);
    }
    ...
    public static class CheckR1170 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof CallOperationAction)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1170: unsupported element type '%s'",
        ...
        /**
         * If an InputPin is updated and is on a CallOperationAction, its self
         * attribute potentially change so we need to check the rule on this
         * CallOperationAction.
        ...
        /**
         * If an operation is moved, its owner's classifier potentially changes
         * so we need to check the rule on every CallOperationAction that calls
         * this operation.
