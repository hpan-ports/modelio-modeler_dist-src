...
public class R1150 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(CallOperationAction.MNAME, this,
                AuditTrigger.UPDATE);
        plan.registerRule(SendSignalAction.MNAME, this,
                AuditTrigger.UPDATE);
    ...
    public static class CheckR1150 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof CallOperationAction
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1150: unsupported element type '%s'",
         ...
         * @return An audit entry if the pin belongs to a CallOperationAction or
         * a SendSignalAction, null otherwise
         */
