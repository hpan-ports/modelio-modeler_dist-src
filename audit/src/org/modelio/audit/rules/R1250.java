...
public class R1250 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(ForkJoinNode.MNAME, this,
                AuditTrigger.UPDATE);
    ...
    public static class CheckR1250 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ForkJoinNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1210: unsupported element type '%s'",
