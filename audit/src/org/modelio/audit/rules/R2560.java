...
public class R2560 extends AbstractRule {
    ...
    public static class CheckR2560 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof Port)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2560: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2560(final Port port) {
            ...
            if(port.isIsBehavior()){
                ...
                for(ProvidedInterface pi : port.getProvided())
                    if(pi.getProvidedElement().size() > 0)
                        return auditEntry;
