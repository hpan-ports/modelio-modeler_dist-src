...
public class R2760 extends AbstractRule {
    ...
    public static class CheckR2760 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Transition)
                ...
                Audit.LOG.warning("R2760: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
