...
public class R1160 extends AbstractRule {
    ...
    public static class CheckR1160 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof InputPin) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1160: unsupported element type '%s'",
                        element.getMClass().getName());
            return diagnostic;
        }

        /**
         * If an InputPin is updated its self attribute potentially change so we
         * need to check if it belongs to an CallOperationAction or a
         * SendSignalAction.
