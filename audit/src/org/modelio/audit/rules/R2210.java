...
public class R2210 extends AbstractRule {
    ...
    public static class CheckR2210 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof Generalization) {
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2210: unsupported element type '%s'",
        ...
        private IAuditEntry checkR2210(final NameSpace nameSpace) {
            ...
            if (nameSpace.isIsLeaf() && nameSpace.getSpecialization().size() > 0) {
