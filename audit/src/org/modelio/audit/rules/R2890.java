...
public class R2890 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        //plan actor && usecase
        plan.registerRule(AssociationEnd.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE | AuditTrigger.MOVE);
    }
    ...
    static class CheckR2890 extends AbstractControl {
