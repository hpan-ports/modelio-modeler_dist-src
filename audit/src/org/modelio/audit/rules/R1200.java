...
public class R1200 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(DecisionMergeNode.MNAME, this,
                AuditTrigger.UPDATE);
        ...
        plan.registerRule(ControlFlow.MNAME, this, AuditTrigger.CREATE
                | AuditTrigger.MOVE);
        plan.registerRule(MessageFlow.MNAME, this, AuditTrigger.CREATE
                | AuditTrigger.MOVE);
    }
    ...
    public static class CheckR1200 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof DecisionMergeNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1200: unsupported element type '%s'",
        ...
        private IAuditEntry checkR1200(DecisionMergeNode decisionMergeNode) {
            ...
            if (decisionMergeNode.getIncoming().size() == 0
                    && decisionMergeNode.getOutgoing().size() == 0)
                return auditEntry;
