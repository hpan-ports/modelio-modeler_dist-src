...
public class R1050 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(ActivityParameterNode.MNAME, this, AuditTrigger.CREATE |
                                                                      AuditTrigger.UPDATE);
        
        plan.registerRule(ControlFlow.MNAME, this, AuditTrigger.CREATE |
                                                            AuditTrigger.MOVE |
                                                            AuditTrigger.UPDATE |
                                                            AuditTrigger.DELETE);
        plan.registerRule(ObjectFlow.MNAME, this, AuditTrigger.CREATE |
                                                           AuditTrigger.MOVE |
                                                           AuditTrigger.UPDATE |
                                                           AuditTrigger.DELETE);
    }
    ...
    /**
     * Actual checker for R1050: Checks that an ActivityParameterNode doesn't have both incoming and outgoing edges at
     * the same time.
     */
    @objid ("a94c98e4-ca15-44e6-9a33-e0ec4ba7646c")
    public static class CheckR1050 extends AbstractControl {
        /**
         * C'tor.
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ActivityParameterNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1050: unsupported element type '%s'",
    ...
    public static class CheckFlowDeleteR1050 extends CheckR1050 {
