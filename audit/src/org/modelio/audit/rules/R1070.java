...
/**
 * Checks that an ActivityParameterNode with incoming edges represents a
 * BehaviourParameter that has either 'out' or 'inout' as passing mode or is a
 * return parameter.
 * 
 * @author fpoyer
 */
@objid ("9972e128-9bfa-40d0-a692-5d11e71d1adb")
public class R1070 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(ActivityParameterNode.MNAME, this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
        // Needed for:
        // - the behaviour parameter's passing mode changes (ParameterPassing attribute or Returned dependency)
        plan.registerRule(BehaviorParameter.MNAME, this, AuditTrigger.UPDATE);
         
        plan.registerRule(ControlFlow.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
    ...
    /**
     * Actual Checker for R1070: Checks that an ActivityParameterNode with
     * incoming edges represents a BehaviourParameter that has either 'out' or
     * 'inout' as passing mode or is a return parameter.
     */
    @objid ("e3933a56-a421-4e43-8e66-1049bdbc0aed")
    public static class CheckR1070 extends AbstractControl {
        /**
         * C'tor.
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ActivityParameterNode)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1070: unsupported element type '%s'",
