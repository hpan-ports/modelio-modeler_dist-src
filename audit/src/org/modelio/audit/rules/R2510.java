...
public class R2510 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Link.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
    ...
    static class CheckR2510 extends AbstractControl {
