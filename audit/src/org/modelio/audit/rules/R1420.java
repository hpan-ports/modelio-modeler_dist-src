...
public class R1420 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(NaryAssociationEnd.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1420 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if(element instanceof NaryAssociationEnd)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R1420: unsupported element type '%s'",
