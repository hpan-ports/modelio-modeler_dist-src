...
public class R2700 extends AbstractRule {
    ...
    public static class CheckR2700 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof TemplateBinding)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID,
                            "R2700: unsupported element type '%s'",
