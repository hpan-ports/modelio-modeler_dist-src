...
public class R2910 extends AbstractRule {
    ...
    public static class CheckR2910 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof UseCaseDependency)
                ...
                Audit.LOG.warning("R2910: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
