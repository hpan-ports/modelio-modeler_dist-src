...
public class R1010 extends AbstractRule {
    ...
    public static class CheckR1010 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof ActivityPartition)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1010: unsupported element type '%s'",
