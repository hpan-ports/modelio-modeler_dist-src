...
public class R1860 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Operation.MNAME, this, AuditTrigger.MOVE | AuditTrigger.UPDATE);
    ...
    static class CheckR1860 extends AbstractControl {
