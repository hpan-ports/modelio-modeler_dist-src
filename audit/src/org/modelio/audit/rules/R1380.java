...
public class R1380 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(SendSignalAction.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(Signal.MNAME, this, AuditTrigger.UPDATE);
        plan.registerRule(Attribute.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(InputPin.MNAME, this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
    }
    ...
    public static class CheckR1380 extends AbstractControl {
        ...
        public IDiagnosticCollector doRun(IDiagnosticCollector diagnostic, MObject element) {
            if (element instanceof SendSignalAction)
                ...
                Audit.LOG.warning(Audit.PLUGIN_ID, "R1380: unsupported element type '%s'", element.getMClass().getName());
            return diagnostic;
        }
        ...
        /**
         * If an InputPin was created or moved, and if it now belongs to a SendSignalAction, we need to check the rule
         * on the SendSignalAction. If an InputPin was updated and belongs to a SendSignalAction, it's represented
         * attribute potentially changed and we need to check the rule on the SendSignalAction.
        ...
        /**
         * If a Signal is modified, Attributes were potentially added or removed, and we need to check the rule on any
         * SendSignalAction which is a sender of the Signal.
