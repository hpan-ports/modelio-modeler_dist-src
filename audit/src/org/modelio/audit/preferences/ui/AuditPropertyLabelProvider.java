...
public class AuditPropertyLabelProvider extends ColumnLabelProvider {
    ...
    public AuditPropertyLabelProvider() {
        this.providers = new ColumnLabelProvider[] {new FirstLabelProvider(), new SeverityLabelProvider(), new StatusLabelProvider(), new SummaryLabelProvider()};
    }
