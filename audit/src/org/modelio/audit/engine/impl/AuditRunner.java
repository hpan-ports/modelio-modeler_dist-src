...
public class AuditRunner implements Runnable {
    ...
    @objid ("7c94a331-e99f-47f4-b282-abef956f18bd")
    ...
    @objid ("354462c6-674f-473d-8d12-e03a0c06af4e")
    public List<IControl> currentBatch = new ArrayList<>();
                ...
                case RUN:
                    ...
                    if (batch != null) {
                        ...
                        if (additionnalDiagnosticToPost) {
                            ...
                            fireStatus(); // force a fire status to update the controls counter
