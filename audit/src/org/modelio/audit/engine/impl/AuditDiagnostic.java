...
public class AuditDiagnostic implements IAuditDiagnostic {
    ...
    public synchronized List<IAuditEntry> getEntries(String jobId) {
        ...
        List<IAuditEntry> jobEntrys = new ArrayList<>();
    ...
    public synchronized void auditPlanChanged(Map<String, IRule> configuredRules, ICoreSession session) {
        boolean notifyListeners = false;
    ...
    public synchronized void clear(ICoreSession session) {
        // Reset counters
        this.nErrors = 0;
        this.nWarnings = 0;
        this.nTips = 0;
