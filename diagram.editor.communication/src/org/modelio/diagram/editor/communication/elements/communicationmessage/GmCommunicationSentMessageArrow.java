...
public final class GmCommunicationSentMessageArrow extends GmNoStyleSimpleNode {
    ...
    public GmCommunicationSentMessageArrow(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationSentMessageArrow." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationSentMessageArrow." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
