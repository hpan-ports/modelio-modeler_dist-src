...
public class GmCommunicationMessageLabel extends GmDefaultModelElementLabel {
    ...
    public GmCommunicationMessageLabel(final GmAbstractDiagram diagram, final CommunicationMessage el, final MRef ref) {
        super(diagram, ref);
        this.element = el;
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationMessageLabel." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationMessageLabel." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
