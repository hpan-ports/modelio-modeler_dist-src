...
public final class CommunicationDiagramEditPartFactory implements EditPartFactory {
    /**
    ...
    @objid ("7a2fb7ce-55b6-11e2-877f-002564c97630")
    private static final CommunicationDiagramEditPartFactory INSTANCE = new CommunicationDiagramEditPartFactory();

    @objid ("7a2fb7d0-55b6-11e2-877f-002564c97630")
    private CommunicationDiagramEditPartFactory() {
     ...
     * @return the instance.
     */
    @objid ("7a2fb7d2-55b6-11e2-877f-002564c97630")
    ...
    public class StructuredModeEditPartFactory implements EditPartFactory {
        ...
        public EditPart createEditPart(EditPart context, Object model) {
            ...
            if (model.getClass() == GmCommunicationDiagramView.class) {
