...
public class GmCommunicationNodePrimaryNode extends GmNoStyleCompositeNode implements IImageableNode {
    ...
    public GmCommunicationNodePrimaryNode(GmAbstractDiagram diagram, MRef ref) {
        super(diagram, ref);
    ...
    public RepresentationMode getRepresentationMode() {
        return (RepresentationMode) getStyle().getProperty(GmCommunicationNode.SIMPLEKEYS.getStyleKey(MetaKey.REPMODE));
    }
    ...
    public void read(IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationNodePrimaryNode." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationNodePrimaryNode." + MINOR_VERSION_PROPERTY,
