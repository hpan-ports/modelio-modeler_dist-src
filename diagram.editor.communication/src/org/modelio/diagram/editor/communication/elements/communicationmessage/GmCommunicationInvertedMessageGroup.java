...
public final class GmCommunicationInvertedMessageGroup extends GmGroup {
    ...
    public GmCommunicationInvertedMessageGroup(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationInvertedMessageGroup." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationInvertedMessageGroup." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
