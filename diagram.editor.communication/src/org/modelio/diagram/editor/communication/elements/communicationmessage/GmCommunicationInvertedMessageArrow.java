...
public final class GmCommunicationInvertedMessageArrow extends GmNoStyleSimpleNode {
    ...
    public GmCommunicationInvertedMessageArrow(final GmAbstractDiagram diagram, final MRef relatedRef) {
    ...
    public void read(final IDiagramReader in) {
        ...
        Object versionProperty = in.readProperty("GmCommunicationInvertedMessageArrow." + MINOR_VERSION_PROPERTY);
    ...
    public void write(IDiagramWriter out) {
        ...
        if (this.minorVersion != 0) {
            out.writeProperty("GmCommunicationInvertedMessageArrow." + MINOR_VERSION_PROPERTY, Integer.valueOf(this.minorVersion));
        }
    }
