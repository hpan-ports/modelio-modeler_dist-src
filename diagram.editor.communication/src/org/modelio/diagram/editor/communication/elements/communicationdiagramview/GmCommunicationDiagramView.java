...
public class GmCommunicationDiagramView extends GmAbstractDiagramView {
    ...
    @objid ("90b85b38-e293-40f7-921c-eebcb2162f8e")
    private static final CommunicationDiagramViewUserImageStyleKeys USERIMAGE_KEYS = new CommunicationDiagramViewUserImageStyleKeys();
